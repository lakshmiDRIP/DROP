...
/**
 * <i>SimplexTableau</i> holds the Canonical Simplex Tableau. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
{
	private java.util.List<double[]> _constraintRowList = null;
	private java.util.Set<java.lang.String> _variableSet = null;
	 ...
	 * 
	 * @return The Constraint Row List
	 */

	public java.util.List<double[]> constraintRowList()
	{
		return _constraintRowList;
	}
	 ...
	 * 
	 * @param constraintRow The Constraint Row
	 * 
	 * @return TRUE - The Constraint Row successfully added
	 */

	public boolean addConstraintRow (
		final double[] constraintRow)
	{
		if (null == constraintRow)
		{
			return false;
		}

		int variableCount = _variableSet.size();

		if (variableCount != constraintRow.length ||
		...
		if (null == _constraintRowList)
		{
			_constraintRowList = new java.util.ArrayList<double[]>();
		}

		_constraintRowList.add (
			constraintRow
		);
