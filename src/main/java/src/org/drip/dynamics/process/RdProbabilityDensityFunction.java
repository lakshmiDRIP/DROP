...
/**
 * <i>RdProbabilityDensityFunction</i> exposes the R<sup>d</sup> Probability Density Function Evaluation
...
public interface RdProbabilityDensityFunction
{

	/**
	 * Calculates the PDF Density Value
	 * 
	 * @param timeRdVertex The R<sup>d</sup> Property Variate/Time Coordinate Vertex
	 * 
