...
public class LimitHoldingsTermIssuerLong
	extends org.drip.portfolioconstruction.constraint.LimitHoldingsTermIssuer
{
	...
	public LimitHoldingsTermIssuerLong (
				...
				throws java.lang.Exception
			{
					...
					finalHoldingsArray.length != assetCount)
				{
					throw new java.lang.Exception
						("LimitHoldingsTermIssuerLong::rdToR1::evaluate => Invalid Variate Dimension");
				}
				...
				return limitHoldingsIssuerLong;
			}
		};
	}
}
