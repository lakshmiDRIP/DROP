...
/**
 * <i>CreditQualifyingBucketCurvatureMarginFlow24</i> illustrates the Steps in the Computation of the SIMM
 * 	2.4 Curvature Qualifying Delta Margin for a single CR Bucket's Exposure Sensitivities. The References
 * 	are:
 * 
 * <br><br>
 *  <ul>
...
public class CreditQualifyingBucketCurvatureMarginFlow24
{
		...
		throws Exception
	{
		...
		BucketSensitivitySettingsCR bucketSensitivitySettingsCR =
			BucketCurvatureSettingsCR.ISDA_CRQ_24 (bucketIndex);
