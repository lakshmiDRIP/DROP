...
/**
 * <i>CreditQualifyingBucketCurvatureMarginFlow21</i> illustrates the Steps in the Computation of the SIMM
 * 	2.1 Curvature Qualifying Delta Margin for a single CR Bucket's Exposure Sensitivities. The References
 * 	are:
 * 
 * <br><br>
 *  <ul>
...
public class CreditQualifyingBucketCurvatureMarginFlow21
{
		...
		throws Exception
	{
		...
		BucketSensitivitySettingsCR bucketSensitivitySettingsCR =
			BucketCurvatureSettingsCR.ISDA_CRQ_21 (bucketIndex);
