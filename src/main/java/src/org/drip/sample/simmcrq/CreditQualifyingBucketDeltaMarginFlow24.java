...
/**
 * <i>CreditQualifyingBucketDeltaMarginFlow24</i> illustrates the Steps in the Computation of the SIMM 2.4
...
public class CreditQualifyingBucketDeltaMarginFlow24
{
		...
		throws Exception
	{
		...
		BucketSensitivitySettingsCR bucketSensitivitySettingsCR =
			BucketSensitivitySettingsCR.ISDA_CRQ_DELTA_24 (bucketIndex);
