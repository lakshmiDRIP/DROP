...
/**
 * <i>ModifiedSecondOneThirdOrder</i> implements the Integral Estimator for the 1. / 3. Order Modified Bessel
...
public class ModifiedSecondOneThirdOrder
{
		...
		throws Exception
	{
		...
		System.out.println ("\t|      ONE-THIRD ORDER MODIFIED BESSEL SECOND KIND INTEGRAL ESTIMATE       ||");
		...
		throws Exception
	{
		...
		{
			BesselK (
				ModifiedSecondIntegralEstimator.OneThirdOrder (quadratureCount),
				quadratureCount,
				zArray
			);
		}
