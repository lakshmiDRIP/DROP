...
/**
 * <i>CreditDefaultSwapClient</i> demonstrates the Invocation and Examination of the JSON-based CDS Service
 * 	Client.
 * 
 * <br><br>
 *  <ul>
...
public class CreditDefaultSwapClient {
		...
		throws Exception
	{
		...
		jsonParameters.put ("CDSMaturity", "05Y");

		jsonParameters.put ("CDSCoupon", 0.0100);

		JSONObject jsonRequest = new JSONObject();

		jsonRequest.put ("API", "CREDITDEFAULTSWAP::CURVEMETRICS");
