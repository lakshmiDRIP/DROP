...
/**
 * <i>CreditNonQualifyingBucketDeltaMarginFlow24</i> illustrates the Steps in the Computation of the SIMM 2.4
...
public class CreditNonQualifyingBucketDeltaMarginFlow24
{
		...
		throws Exception
	{
		...
		BucketSensitivitySettingsCR bucketSensitivitySettingsCR =
			BucketSensitivitySettingsCR.ISDA_CRNQ_DELTA_24 (bucketIndex);
