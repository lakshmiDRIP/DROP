...
/**
 * <i>CreditNonQualifyingBucketDeltaMarginFlow21</i> illustrates the Steps in the Computation of the SIMM 2.1
...
public class CreditNonQualifyingBucketDeltaMarginFlow21
{
		...
		throws Exception
	{
		...
		BucketSensitivitySettingsCR bucketSensitivitySettingsCR =
			BucketSensitivitySettingsCR.ISDA_CRNQ_DELTA_21 (bucketIndex);
