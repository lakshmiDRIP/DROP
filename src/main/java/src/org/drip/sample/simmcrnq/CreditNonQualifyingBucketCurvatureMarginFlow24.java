...
/**
 * <i>CreditNonQualifyingBucketCurvatureMarginFlow24</i> illustrates the Steps in the Computation of the SIMM
 * 	2.4 Curvature Non-Qualifying Delta Margin for a single CR Bucket's Exposure Sensitivities. The References
 *  are:
 * 
 * <br><br>
 *  <ul>
...
public class CreditNonQualifyingBucketCurvatureMarginFlow24
{
		...
		throws Exception
	{
		...
		BucketSensitivitySettingsCR bucketSensitivitySettingsCR =
			BucketCurvatureSettingsCR.ISDA_CRNQ_24 (bucketIndex);
