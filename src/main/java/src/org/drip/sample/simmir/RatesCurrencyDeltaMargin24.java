...
/**
 * <i>RatesCurrencyDeltaMargin24</i> illustrates the Computation of the SIMM 2.4 IR Delta Margin for a
...
public class RatesCurrencyDeltaMargin24
{
		...
		throws Exception
	{
		...
		RiskMeasureSensitivitySettingsIR riskMeasureSensitivitySettingsIR =
			RiskMeasureSensitivitySettingsIR.ISDA_DELTA_24 (currencyList);
