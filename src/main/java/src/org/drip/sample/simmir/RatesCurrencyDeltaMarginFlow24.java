...
/**
 * <i>RatesCurrencyDeltaMarginFlow24</i> illustrates the Steps in the Computation of the SIMM 2.4 IR Delta
...
public class RatesCurrencyDeltaMarginFlow24
{
		...
		throws Exception
	{
		...
		SensitivityAggregateIR irDeltaAggregate = bucketAggregateIR.riskFactorAggregate().linearMargin
