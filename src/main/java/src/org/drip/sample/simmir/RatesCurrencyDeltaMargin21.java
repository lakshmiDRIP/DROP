...
/**
 * <i>RatesCurrencyDeltaMargin21</i> illustrates the Computation of the SIMM 2.1 IR Delta Margin for a
...
public class RatesCurrencyDeltaMargin21
{
		...
		throws Exception
	{
		...
		RiskMeasureSensitivitySettingsIR riskMeasureSensitivitySettingsIR =
			RiskMeasureSensitivitySettingsIR.ISDA_DELTA_21 (currencyList);
