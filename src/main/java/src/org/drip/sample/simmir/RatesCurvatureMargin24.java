...
/**
 * <i>RatesCurvatureMargin24</i> illustrates the Computation of the SIMM 2.4 IR Curvature Margin for a Bucket
 * 	of Currency's IR Exposure Sensitivities. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
public class RatesCurvatureMargin24
{
		...
		throws Exception
	{
		...
		RiskMeasureSensitivitySettingsIR riskMeasureSensitivitySettingsIR =
			RiskMeasureSensitivitySettingsIR.ISDA_CURVATURE_24 (currencyList);
