...
/**
 * <i>RatesCurrencyCurvatureMarginFlow24</i> illustrates the Steps in the Computation of the SIMM 2.4 IR
...
public class RatesCurrencyCurvatureMarginFlow24
{
		...
		throws Exception
	{
		...
		BucketCurvatureSettingsIR bucketCurvatureSettingsIR = BucketCurvatureSettingsIR.ISDA_24 (currency);
