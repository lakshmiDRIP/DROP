...
/**
 * <i>CollateralizedFundingNeutralStochastic</i> examines the Basel BCBS 2012 OTC Accounting Impact to a
...
public class CollateralizedFundingNeutralStochastic {
		...
		throws Exception
	{
		...
		double dblOvernightNumeraireDrift = 0.0004;
