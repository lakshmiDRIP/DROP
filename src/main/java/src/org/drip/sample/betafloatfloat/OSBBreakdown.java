...
/**
 * <i>OSBBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment using
 * 	the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - OS and B
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
