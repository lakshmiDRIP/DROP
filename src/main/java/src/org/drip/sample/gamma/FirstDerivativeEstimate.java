...
import org.drip.specialfunction.gamma.FirstDerivative;
...
public class FirstDerivativeEstimate
{
		...
		throws Exception
	{
		...
		FirstDerivative firstDerivative = new FirstDerivative (null);

		System.out.println ("\t|---------------||");

		System.out.println ("\t|   1st DERIV   ||");
		...
		for (int m : mArray)
		{
			System.out.println (
				"\t|" + 
				FormatUtil.FormatDouble (m, 1, 0, 1.) + " => " +
				FormatUtil.FormatDouble (firstDerivative.evaluate (m), 4, 2, 1.) + " ||"
			);
		}
