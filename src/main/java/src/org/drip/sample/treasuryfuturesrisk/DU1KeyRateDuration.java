...
/**
 * <i>DU1KeyRateDuration</i> demonstrates the Computation of the Key Rate Duration for the DU1 Treasury
 * 	Futures.
 *
 *	<br><br>
 *  <ul>
...
public class DU1KeyRateDuration {
		...
		throws Exception
	{
		...
		String strTreasuryMarkLocation = "C:\\DROP\\Daemons\\Transforms\\TreasuryYieldMarks\\" +
			TreasurySettingContainer.CurrencyBenchmarkCode (ts.currency()) +
