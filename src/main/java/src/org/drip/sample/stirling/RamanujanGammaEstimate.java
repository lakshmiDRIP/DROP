...
/**
 * <i>RamanujanGammaEstimate</i> illustrates the Ramanujan Approximation of the Gamma Function. The
 * 	References are:
 * 
 * <br><br>
 * 	<ul>
...
public class RamanujanGammaEstimate
{
		...
		throws Exception
	{
		...
		System.out.println ("\t|                RAMANUJAN GAMMA APPROXIMATION               ||");
		...
		for (int factorialIndex = 1; factorialIndex <= factorialCount; ++factorialIndex)
		{
			System.out.println (
				...
				FormatUtil.FormatDouble (ramanujanGamma.evaluate (factorialIndex - 1), 1, 0, 1.) + " ||"
			);
		}
