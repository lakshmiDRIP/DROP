...
/**
 * <i>EquityCurvatureMargin21</i> illustrates the Computation of the SIMM 2.1 Curvature Margin for a Group of
...
public class EquityCurvatureMargin21
{
		...
		throws Exception
	{
		...
		RiskMeasureSensitivitySettings riskMeasureSensitivitySettings =
			RiskMeasureSensitivitySettings.ISDA_EQ_CURVATURE_21 (vegaDurationDays);
