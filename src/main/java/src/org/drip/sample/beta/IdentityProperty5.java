...
/**
 * <i>IdentityProperty5</i> illustrates the Beta Function Identity Property Verification. The References are:
 * 
 * <br><br>
 * 	<ul>
 * 		<li>
...
public class IdentityProperty5
{
	...
	private static final void Verifier (
		...
		throws Exception
	{
		R1PropertyVerification verification = BetaEqualityLemma.Identity5().verify (x);
