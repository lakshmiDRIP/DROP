...
import org.drip.graph.subarray.ThreeSumQuadraticHash;
import org.drip.graph.subarray.ThreeSumQuadraticComparator;
...
/**
 * <i>QuadraticThreeSum</i> implements the Check that indicates if the Set of Numbers contains 3 that Sum to
 *  Zero using Quadratic Time Schemes. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
public class QuadraticThreeSum
{
		...
		throws Exception
	{
		...
		System.out.println (
			"\t| QUADRATIC Hash-Table: Zero 3 SUM exists in Array [" + array + "] => " +
			new ThreeSumQuadraticHash (
				numberArray
			).zeroSumExists()
		);

		System.out.println (
			"\t| QUADRATIC Comparator: Zero 3 SUM exists in Array [" + array + "] => " +
			new ThreeSumQuadraticComparator (
				numberArray
			).zeroSumExists()
		);
