...
/**
 * <i>GILTReconstitutor</i> demonstrates the Cleansing and Re-constitution of the GILT Yield Marks obtained
...
public class GILTReconstitutor {
		...
		final String[] astrArgs)
	{
		...
		String strTreasuryType = "GILT";
		String strMarksLocation =
			"C:\\DROP\\Daemons\\Feeds\\TreasuryYieldMarks\\" + strTreasuryType + "BenchmarksFormatted.csv";
