...
/**
 * <i>FXVolatilityGroup</i> contains the SIMM 2.4 FX Volatility Group. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
public class FXVolatilityGroup
{
	...
	public FXVolatilityGroup (
		final String name,
		final String[] componentCurrencyArray)
		throws Exception
	{
		if (
	 ...
	 * 
	 * @return The FX Volatility Group Name
	 */
	 ...
	 * 
	 * @return The FX Volatility Group Constituent Currency Array
	 */

	public String[] componentCurrencyArray()
	{
		return _componentCurrencyArray;
	}
	 ...
	 * 
	 * @return TRUE - The Specified Currency if available in the Component Currency Array
	 */
