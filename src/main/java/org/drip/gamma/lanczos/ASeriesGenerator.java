...
package org.drip.gamma.lanczos;
...
{
	private org.drip.gamma.lanczos.PSeriesGenerator _pSeriesGenerator = null;
	...
	public static final ASeriesGenerator Standard (
		...
		final int termCount)
	{
		org.drip.gamma.lanczos.PSeriesGenerator pSeriesGenerator =
			org.drip.gamma.lanczos.PSeriesGenerator.Standard (
				g,
				termCount
			);
		...
		try
		{
			return new ASeriesGenerator (
				new org.drip.gamma.lanczos.ASeriesTerm(),
				pSeriesGenerator
			);
		}
	...
	public ASeriesGenerator (
		final org.drip.gamma.lanczos.ASeriesTerm aSeriesTerm,
		final org.drip.gamma.lanczos.PSeriesGenerator pSeriesGenerator)
	...
	public org.drip.gamma.lanczos.PSeriesGenerator pSeriesGenerator()
	{
