...
public class PSeriesGenerator extends org.drip.numerical.estimation.R0ToR1Series
{
	...
	public static final PSeriesGenerator Standard (
		...
		final int termCount)
	{
		double[][] chebyshevCoefficientMatrix = org.drip.gamma.lanczos.ChebyshevCoefficientMatrix.Rollout
			(2 * termCount);
		...
		try
		{
			return new PSeriesGenerator (
				new org.drip.gamma.lanczos.PSeriesTerm (g),
	...
	public PSeriesGenerator (
		final org.drip.gamma.lanczos.PSeriesTerm pSeriesTerm,
