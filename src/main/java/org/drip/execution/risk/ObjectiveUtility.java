...
public interface ObjectiveUtility {
	 ...
	 * 	Sensitivity
	 * 
	 * @param tcngExpectation The Control Node Trajectory Expectation Sensitivity
	 * @param tcngVariance The Control Node Trajectory Variance Sensitivity
	 * 
	 * @return The Control Node Trajectory Objective Function Sensitivity Sensitivity
	 */

	public abstract org.drip.execution.sensitivity.ControlNodesGreek sensitivity (
