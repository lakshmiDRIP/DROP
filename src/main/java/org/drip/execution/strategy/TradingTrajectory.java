...
/**
 * <i>TradingTrajectory</i> holds the Continuous/Discrete Trajectory of a Trading Block that is to be
...
public interface TradingTrajectory {
	...
	abstract public double tradeSize();
	...
	abstract public double executionTime();
