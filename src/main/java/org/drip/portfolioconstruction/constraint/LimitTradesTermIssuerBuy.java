...
public class LimitTradesTermIssuerBuy extends org.drip.portfolioconstruction.constraint.LimitTradesTermIssuer
{
	...
	public LimitTradesTermIssuerBuy (
		...
		throws java.lang.Exception
	{
		super (
			strName,
			"CT_LIMIT_NUMBER_OF_BUY_TRADES",
			"Constrains the Total Count of Buy Trades",
			scope,
			unit,
			dblMinimum,
			dblMaximum,
				...
				throws java.lang.Exception
			{
				...
				if (null == adblFinalHoldings || !org.drip.quant.common.NumberUtil.IsValid
					...
					throw new java.lang.Exception
						("LimitTradesTermIssuerBuy::rdToR1::evaluate => Invalid Variate Dimension");
