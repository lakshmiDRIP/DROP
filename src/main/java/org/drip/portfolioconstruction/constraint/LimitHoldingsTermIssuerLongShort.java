...
public class LimitHoldingsTermIssuerLongShort
	extends org.drip.portfolioconstruction.constraint.LimitHoldingsTermIssuer
{
	...
	public LimitHoldingsTermIssuerLongShort (
		...
		throws java.lang.Exception
	{
		super (
			name,
			"CT_ISSUER_LIMIT_LONG_SHORT_HOLDINGS_RATIO",
			"Limit Issuer Long/Short Holdings Ratio Constraint Term",
			scope,
			unit,
			minimum,
			maximum,
	...
	@Override public org.drip.function.definition.RdToR1 rdtoR1()
	{
		return new org.drip.function.definition.RdToR1 (null)
		{
				...
				throws java.lang.Exception
			{
				...
				double limitHoldingsIssuerShort = 0.;
				double limitHoldingsIssuerLong = 0.;
				...
				for (int assetIndex = 0; assetIndex < assetCount; ++assetIndex)
				{
					...
					{
						limitHoldingsIssuerLong += issuerSelectionArray[assetIndex] *
							finalHoldingsArray[assetIndex];
					}
					else
					{
						limitHoldingsIssuerShort += issuerSelectionArray[assetIndex] *
							finalHoldingsArray[assetIndex];
					}
				}

				return limitHoldingsIssuerLong / limitHoldingsIssuerShort;
			}
		};
	}
}
