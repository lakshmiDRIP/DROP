...
public class LimitHoldingsTermIssuerShort
	extends org.drip.portfolioconstruction.constraint.LimitHoldingsTermIssuer
{
	...
	public LimitHoldingsTermIssuerShort (
		...
		throws java.lang.Exception
	{
		super (
			name,
			"CT_ISSUER_LIMIT_SHORT_HOLDINGS",
				...
				throws java.lang.Exception
			{
					...
					finalHoldingsArray.length != assetCount)
				{
					throw new java.lang.Exception
						("LimitHoldingsTermIssuerShort::rdToR1::evaluate => Invalid Variate Dimension");
				}
				...
				return limitHoldingsIssuerShort;
			}
		};
	}
}
