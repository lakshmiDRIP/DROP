	...
	extends org.drip.portfolioconstruction.constraint.LimitTaxTerm
{
	 ...
	 * 
	 * @param name Name of the LimitTaxTermNetGains Constraint
	 * @param scope Scope of the LimitTaxTermNetGains Constraint
	 * @param unit Unit of the LimitTaxTermNetGains Constraint
	 * @param minimum Minimum Value of the LimitTaxTermNetGains Constraint
	 * @param maximum Maximum Value of the LimitTaxTermNetGains Constraint
