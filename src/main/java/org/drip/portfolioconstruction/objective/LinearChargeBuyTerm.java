...
public class LinearChargeBuyTerm extends org.drip.portfolioconstruction.objective.TransactionChargeTerm
{
	 ...
	 * @param aTCL Array of Linear Transaction Cost Instances
	 * 
	...
	@Override public org.drip.function.definition.RdToR1 rdtoR1()
	{
		return new org.drip.function.definition.RdToR1 (null)
		{
				...
				throws java.lang.Exception
			{
				...
				double dblLinearChargeBuyTerm = 0.;
				...
				for (int i = 0; i < iNumAsset; ++i) {
					if (adblVariate[i] > adblInitialHoldings[i])
						dblLinearChargeBuyTerm += aTCL[i].estimate (
							adblInitialHoldings[i],
							adblVariate[i]
					);
				}

				return dblLinearChargeBuyTerm;
			}
		};
	}
}
