	...
	extends org.drip.portfolioconstruction.objective.TransactionChargeTerm
{
	 ...
	 * @param fixedTransactionChargeArray Array of Asset Transaction Charge Instances
	 * 
		...
		return new org.drip.function.definition.RdToR1 (null)
		{
				...
				throws java.lang.Exception
			{
				...
				for (int assetIndex = 0; assetIndex < assetCount; ++assetIndex)
				{
					...
					{
						fixedChargeSellTerm += fixedTransactionChargeArray[assetIndex].estimate (
							initialSize,
