...
/**
 * <i>ProfitabilityFactor</i> is the Implementation of the Profitability Factor. The References are:
 *
 *	<br><br>
 * <ul>
 * 	<li>
...
public class ProfitabilityFactor extends Factor
{
		...
		throws Exception
	{
		super (
			code,
			"Profitability Factor using suitable Metric",
			metricType,
			portfolio,
			portfolioRanker
		);
