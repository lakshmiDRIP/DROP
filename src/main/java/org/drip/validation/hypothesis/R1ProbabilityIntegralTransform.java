...
/**
 * <i>R1ProbabilityIntegralTransform</i> holds the PIT Distribution CDF of the R<sup>1</sup> Test-Statistic
 * 	Response over the Outcome Instances.
 *
 *  <br><br>
 *  <ul>
 *  	<li>
...
public class R1ProbabilityIntegralTransform
{
	...
	public R1ProbabilityIntegralTransform (
		...
		throws Exception
	{
		...
		{
			throw new Exception ("R1ProbabilityIntegralTransform Constructor => Invalid Inputs");
		}
		...
		throws Exception
	{
		if (!NumberUtil.IsValid (testStatistic)) {
			throw new Exception ("R1ProbabilityIntegralTransform::pValue => Invalid Inputs");
		}
		...
		throws Exception
	{
		if (!NumberUtil.IsValid (pValue)) {
			throw new Exception ("R1ProbabilityIntegralTransform::testStatistic => Invalid Inputs");
		}
