...
/**
 * <i>QQVertex</i> holds the Elements in a single R<sup>1</sup>QQ Vertex - the Plotting Position and the
...
public class R1QQVertex
{
		...
		throws Exception
	{
		...
		{
			throw new Exception ("R1QQVertex Constructor => Invalid Inputs");
		}
	}
