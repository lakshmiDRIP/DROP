...
/**
 * <i>PlottingPositionGenerator</i> exposes all Plotting Position Generation Schemes - both Expectation Based
 * and Median Based.
 *
 *  <br><br>
 *  <ul>
...
{
	private int _orderStatisticCount = -1;
	 ...
	 * 
	 * @return The Count of Order Statistics
	 */

	public int orderStatisticCount()
	{
		return _orderStatisticCount;
	}
