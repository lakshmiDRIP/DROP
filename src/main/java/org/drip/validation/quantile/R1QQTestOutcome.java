...
/**
 * <i>R1QQTestOutcome</i> holds the Elements of the R<sup>1</sup> QQ Vertexes that come from a QQ Plot Run.
 *
 *  <br><br>
 *  <ul>
 *  	<li>
...
{
	private R1QQVertex[] _r1QQVertexArray = null;

	/**
	 * <i>R1QQTestOutcome</i> Constructor
	 * 
	 * @param r1QQVertexArray Array of Q-Q Vertexes
	 * 
	 * @throws Exception Thrown if the Inputs are Invalid
	 */

	public R1QQTestOutcome (
		final R1QQVertex[] r1QQVertexArray)
		throws Exception
	{
		if (null == (_r1QQVertexArray = r1QQVertexArray)) {
			throw new Exception ("R1QQTestOutcome Constructor => Invalid Inputs");
		}

		int qqVertexCount = _r1QQVertexArray.length;
		...
		for (int qqVertexIndex = 0; qqVertexIndex < qqVertexCount; ++qqVertexIndex) {
			if (null == _r1QQVertexArray[qqVertexIndex]) {
				throw new Exception ("R1QQTestOutcome Constructor => Invalid Inputs");
			}
		}
	}
	...
	public double probabilityPlotCorrelationCoefficient()
		throws Exception
	{
		int vertexCount = _r1QQVertexArray.length;
		double[][] orderStatisticsSequence = new double[2][vertexCount];

		for (int vertexIndex = 0; vertexIndex < vertexCount; ++vertexIndex) {
			orderStatisticsSequence[0][vertexIndex] = _r1QQVertexArray[vertexIndex].orderStatisticX();

			orderStatisticsSequence[1][vertexIndex] = _r1QQVertexArray[vertexIndex].orderStatisticY();
		}
