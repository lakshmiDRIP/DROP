...
/**
 * <i>LinearExpression</i> implements the R<sup>d</sup> to R<sup>1</sup> Linear Expression. It provides the
 * 	following Functions:
 * 	<ul>
 * 		<li><i>LinearExpression</i> Constructor</li>
 * 		<li>Retrieve the Array of Coefficients</li>
 * 		<li>Retrieve the Dimension of the Expression</li>
 * 		<li>Evaluate the Expression for the given Input Variates</li>
 * 		<li>Negate the Coefficients of the Expression</li>
 * 		<li>Convert the Linear Expression into a String</li>
 * 	</ul>
 * 
 * The References are:
 * <br>
