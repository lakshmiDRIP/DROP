...
/**
 * <i>ProgramVariableSpec</i> implements the R<sup>1</sup> Program Variable Specification in an LP. It
 * 	provides the following Functions:
 * 	<ul>
 * 		<li><i>ProgramVariableSpec</i> Constructor</li>
 * 		<li>Retrieve the Program Variable Name</li>
 * 		<li>Retrieve the Program Variable Coefficient</li>
 * 		<li>Convert Program Variable to a Display Version</li>
 * 	</ul>
 * 
 * The References are:
 * <br>
