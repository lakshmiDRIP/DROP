 ...
 *
 *  <ul>
 * 		<li><i>SecondOrder1DNumericalEvolver</i> Constructor</li>
 * 		<li>Retrieve the Second Order R<sup>1</sup> State Space Evolution PDE</li>
 * 		<li>Retrieve the Factor Increment</li>
 * 		<li>Compute the State Increment using the Euler Forward Difference State Evolver Scheme</li>
 * 		<li>Compute the State Increment using the Euler Backward Difference State Evolver Scheme</li>
 * 		<li>Compute the State Increment using the Crank-Nicolson State Evolver Scheme</li>
 *  </ul>
 * 
 *	<br>
...
public class SecondOrder1DNumericalEvolver
{
	...
	/**
	 * Retrieve the Factor Increment
	 * 
	 * @return Factor Increment
	 */

	public double factorIncrement()
	{
