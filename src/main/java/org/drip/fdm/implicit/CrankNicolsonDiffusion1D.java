...
/**
 * <i>CrankNicolsonDiffusion1D</i> implements the 1D Crank-Nicolson Discretized Diffusion State-Space
 * 	Evolution Scheme. The References are:
 * 
 * <br><br>
 * 	<ul>
 * 		<li>
 ...
 * 		<li><i>CrankNicolsonDiffusion1D</i> Constructor</li>
 *  </ul>
 * 
 *	<br>
...
public class CrankNicolsonDiffusion1D
	extends DiscretizedDiffusionEvolver1D
{
		...
		final double vonNeumannStabilityNumber)
	{
		if (0 != factorIndex && factorPredictorArray.length - 1 != factorIndex) {
			stateResponseTransitionMatrix[factorIndex][factorIndex - 1] = -1. * vonNeumannStabilityNumber;
			stateResponseTransitionMatrix[factorIndex][factorIndex] = 1. + 2. * vonNeumannStabilityNumber;
			stateResponseTransitionMatrix[factorIndex][factorIndex + 1] = -1. * vonNeumannStabilityNumber;
			rhsArray[factorIndex] = vonNeumannStabilityNumber * stateResponseArray[factorIndex - 1] +
				(1. - 2. * vonNeumannStabilityNumber) * stateResponseArray[factorIndex] +
					vonNeumannStabilityNumber * stateResponseArray[factorIndex + 1];
	...
	/**
	 * <i>CrankNicolsonDiffusion1D</i> Constructor
	 * 
	...
	public CrankNicolsonDiffusion1D (
