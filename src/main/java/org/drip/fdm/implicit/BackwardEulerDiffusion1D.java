...
/**
 * <i>BackwardEulerDiffusion1D</i> implements the 1D Backward-Euler Discretized State-Space Diffusion
 ...
 * 		<li><i>BackwardEulerDiffusion1D</i> Constructor</li>
 *  </ul>
 * 
 *	<br>
...
public class BackwardEulerDiffusion1D
	extends DiscretizedDiffusionEvolver1D
{
		...
		final double vonNeumannStabilityNumber)
	{
		if (0 != factorIndex && factorPredictorArray.length - 1 != factorIndex) {
			...
			stateResponseTransitionMatrix[factorIndex][factorIndex] = 1. + 4. * vonNeumannStabilityNumber;
			stateResponseTransitionMatrix[factorIndex][factorIndex + 1] = -2. * vonNeumannStabilityNumber;
			rhsArray[factorIndex] = 1.;
	...
	/**
	 * <i>BackwardEulerDiffusion1D</i> Constructor
	 * 
	...
	public BackwardEulerDiffusion1D (
