 ...
 *
 *  <ul>
 * 		<li><i>NemesAnalytic</i> Constructor</li>
 *  </ul>
 *
 *  <br>
 *  <style>table, td, th {
...
public class NemesAnalytic extends R1ToR1Estimator
{

	/**
	 * <i>NemesAnalytic</i> Constructor
	 * 
		...
		throws Exception
	{
		if (!NumberUtil.IsValid (x) || 0. > x) {
			throw new Exception ("NemesAnalytic::evaluate => Invalid Inputs");
		}

		return Math.sqrt (2. * Math.PI / x) * Math.pow ((x + (1. / (12. * x - (0.1 / x)))) / Math.E, x);
	}
}
