 ...
 * 		<li>Construct the R<sup>1</sup> To R<sup>1</sup> NIST (2019) Recursive Limit Series</li>
 * 		<li>Construct the R<sup>1</sup> To R<sup>1</sup> Weisstein Limit Series</li>
 *  </ul>
 *
 *  <br>
 *  <style>table, td, th {
...
public class UpperSFixedSeries
{
	...
	public static final R1ToR1Series NIST2019 (
		final int termCount)
	{
		try {
			...
			return new R1ToR1Series (UpperSFixedSeriesTerm.NIST2019(), false, termWeightMap);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static final R1ToR1Series NIST2019Recursive (
		final int n)
	{
		try {
			TreeMap<Integer, Double> termWeightMap = new TreeMap<Integer, Double>();
			...
			return new R1ToR1Series (UpperSFixedSeriesTerm.NIST2019 (n), false, termWeightMap);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public static final R1ToR1Series Weisstein (
		final int s)
	{
		try {
			TreeMap<Integer, Double> termWeightMap = new TreeMap<Integer, Double>();
			...
			return new R1ToR1Series (UpperSFixedSeriesTerm.Weisstein (s), false, termWeightMap);
		} catch (Exception e) {
			e.printStackTrace();
		}
