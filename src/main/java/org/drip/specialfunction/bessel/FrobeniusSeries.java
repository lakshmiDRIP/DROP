...
/**
 * <i>FrobeniusSeries</i> implements the Frobenius Series for the Cylindrical Bessel Function of the First
...
public class FrobeniusSeries
{

	/**
	 * Construct the R<sup>2</sup> To R<sup>1</sup> Bessel First Kind Frobenius Summation Series
	 * 
	...
	public static final org.drip.numerical.estimation.R2ToR1Series FirstKind (
		...
		final int termCount)
	{
		try
		{
			...
			return new org.drip.numerical.estimation.R2ToR1Series (
				new org.drip.specialfunction.bessel.FrobeniusSeriesTerm (gammaEstimator),
				false,
				termWeightMap
			);
		}
