...
/**
 * <i>FrobeniusSeriesTerm</i> implements the Series Term for the Cylindrical Bessel Function of the First
...
public class FrobeniusSeriesTerm extends org.drip.numerical.estimation.R2ToR1SeriesTerm
{
	private org.drip.function.definition.R1ToR1 _gammaEstimator = null;

	/**
	 * FrobeniusSeriesTerm Constructor
	 * 
	...
	public FrobeniusSeriesTerm (
		final org.drip.function.definition.R1ToR1 gammaEstimator)
		throws java.lang.Exception
	{
		if (null == (_gammaEstimator = gammaEstimator))
		{
			throw new java.lang.Exception ("FrobeniusSeriesTerm Constructor => Invalid Input");
		}
	}
		...
		throws java.lang.Exception
	{
		...
		{
			throw new java.lang.Exception ("FrobeniusSeriesTerm::value => Invalid Inputs");
		}

		return (0 == order % 2 ? 1. : -1.) *
			java.lang.Math.pow (
				0.5 * z,
				2. * order + alpha
			) /
