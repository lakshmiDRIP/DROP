...
/**
 * <i>SchlafliIntegralEstimator</i> implements the Integral Estimator for the Cylindrical Bessel Function of
...
public abstract class SchlafliIntegralEstimator extends
	org.drip.specialfunction.definition.BesselFirstKindEstimator
{
	...
	public static final SchlafliIntegralEstimator IntegerForm (
		final int quadratureCount)
	{
		try
		{
			return new SchlafliIntegralEstimator (quadratureCount)
			{
					...
					throws java.lang.Exception
				{
						...
						!org.drip.numerical.common.NumberUtil.IsValid (z))
					{
						throw new java.lang.Exception
							("SchlafliIntegralEstimator::IntegerForm::evaluate => Invalid Inputs");
					}
	...
	public static final SchlafliIntegralEstimator NonIntegerForm (
		final int quadratureCount)
	{
		try
		{
			return new SchlafliIntegralEstimator (quadratureCount)
			{
					...
					throws java.lang.Exception
				{
					...
					{
						throw new java.lang.Exception
							("SchlafliIntegralEstimator::NonIntegerForm::evaluate => Invalid Inputs");
					}
	...
	protected SchlafliIntegralEstimator (
		final int quadratureCount)
		throws java.lang.Exception
	{
		if (0 >= (_quadratureCount = quadratureCount))
		{
			throw new java.lang.Exception ("SchlafliIntegralEstimator Constructor => Invalid Inputs");
		} 
	}
