...
/**
 * <i>FrobeniusSeriesEstimator</i> implements the Frobenius Series Estimator for the Cylindrical Bessel
...
public class FrobeniusSeriesEstimator extends org.drip.specialfunction.definition.BesselFirstKindEstimator
{
	private org.drip.numerical.estimation.R2ToR1Series _frobeniusSeries = null;

	/**
	 * Construct a Standard Instance of Bessel FrobeniusSeriesEstimator
	 * 
	 * @param gammaEstimator The Gamma Estimator
	 * @param termCount Count of the Number of Terms
	 * 
	 * @return The Standard Instance of Bessel FrobeniusSeriesEstimator
	 */

	public static final FrobeniusSeriesEstimator Standard (
		final org.drip.function.definition.R1ToR1 gammaEstimator,
		final int termCount)
	{
		try
		{
			return new FrobeniusSeriesEstimator (
				org.drip.specialfunction.bessel.FrobeniusSeries.FirstKind (
					gammaEstimator,
					termCount
				)
			);
	...
	protected FrobeniusSeriesEstimator (
		final org.drip.numerical.estimation.R2ToR1Series frobeniusSeries)
		throws java.lang.Exception
	{
		if (null == (_frobeniusSeries = frobeniusSeries))
		{
			throw new java.lang.Exception ("FrobeniusSeriesEstimator Constructor => Invalid Inputs");
		}
	}
