...
/**
 * <i>HankelAsymptoteSeries</i> implements the Large z Asymptotic Series used for Estimating the Modified
 * Bessel Functions. The References are:
 * 
 * <br><br>
 * 	<ul>
 * 		<li>
 ...
 *
 *  <ul>
 * 		<li>Construct the R<sup>2</sup> To R<sup>1</sup> Modified Bessel Hankel Asymptote Summation Series</li>
 *  </ul>
 *
 *  <br>
 *  <style>table, td, th {
...
public class HankelAsymptoteSeries
{

	/**
	 * Construct the R<sup>2</sup> To R<sup>1</sup> Modified Bessel Hankel Asymptote Summation Series
	 * 
	 * @param flip TRUE - Apply the Odd/Even Term Sign Flip
	 * @param termCount Count of the Number of Terms
	 * 
	 * @return The R<sup>2</sup> To R<sup>1</sup> Modified Bessel Hankel Asymptote Summation Series
	 */
		...
		final int termCount)
	{
		try {
			...
			return new R2ToR1Series (new HankelAsymptoteSeriesTerm (flip), false, termWeightMap);
		} catch (Exception e) {
			e.printStackTrace();
		}
