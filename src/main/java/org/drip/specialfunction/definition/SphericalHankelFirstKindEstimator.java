...
public abstract class SphericalHankelFirstKindEstimator implements org.drip.function.definition.R2ToZ1
{
	...
	public abstract org.drip.function.definition.CartesianComplexNumber smallH1 (
		final double alpha,
		final double z);
