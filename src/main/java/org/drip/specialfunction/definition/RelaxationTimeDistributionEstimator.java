 ...
 *
 *  <ul>
 * 		<li>Construct the Relaxation Time Density</li>
 * 		<li>Construct the G Function Version</li>
 * 		<li>Construct the G Function for beta = 0.5</li>
 *  </ul>
 *
 *  <br>
 *  <style>table, td, th {
...
public abstract class RelaxationTimeDistributionEstimator extends R1ToR1
{
	...
	public static final R1ToR1 GFunctionHalfBeta()
	{
		return new R1ToR1 (null) {
			@Override public double evaluate (
				final double t)
				throws Exception
			{
				return 0.5 * Math.sqrt (t / Math.PI) * Math.exp (-0.25 * t);
			}
		};
	}
}
