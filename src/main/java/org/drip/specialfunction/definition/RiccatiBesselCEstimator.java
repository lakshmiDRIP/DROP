...
/**
 * <i>RiccatiBesselCEstimator</i> exposes the Estimator for the Riccati-Bessel C Function. The References
 *  are:
 * 
 * <br><br>
 * 	<ul>
 ...
 *
 *  <ul>
 * 		<li>Evaluate Riccati-Bessel C Function given Alpha and z</li>
 *  </ul>
 *
 *  <br>
 *  <style>table, td, th {
...
public abstract class RiccatiBesselCEstimator implements org.drip.function.definition.R2ToR1
{
	 ...
	 * @param z Z
	 *  
	 * @return Riccati-Bessel C Function J Value
	 * 
	 * @throws Exception Thrown if the Inputs are Invalid
	 */

	public abstract double bigC (
		final double alpha,
		final double z)
		throws Exception;
