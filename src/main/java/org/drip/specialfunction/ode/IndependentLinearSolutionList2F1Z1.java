...
/**
 * <i>IndependentLinearSolutionList2F1Z1</i> holds the Array of Linearly Independent Solutions at the Regular
 * 	Singularity z = 1 for the 2F1 Hyper-geometric Function. The References are:
 * 
 * <br><br>
 * 	<ul>
 * 		<li>
 ...
 *
 *  <ul>
 *  	<li>Generate the 2F1 Instance of IndependentLinearSolutionList at z = 1</li>
 *  </ul>
 *
 *  <br>
 *  <style>table, td, th {
...
public class IndependentLinearSolutionList2F1Z1
{
	 ...
	 * 
	 * @return The 2F1 Instance of IndependentLinearSolutionList at z = 1
	 */
		...
		final RegularHypergeometricEstimator regularHypergeometricEstimator)
	{
		...
		IndependentLinearSolutionList independentLinearSolutionList2F1Z1 =
			new IndependentLinearSolutionList();

		try {
			if (!independentLinearSolutionList2F1Z1.add (regularHypergeometricEstimator.albinate (
			...
			if (!independentLinearSolutionList2F1Z1.add (regularHypergeometricEstimator.albinate (
				new HypergeometricParameters (c - a, c - b, 1. + c - a),
				new R1ToR1 (null) {
					@Override public double evaluate (
						final double z)
						throws Exception
		...
		return independentLinearSolutionList2F1Z1;
	}
}
