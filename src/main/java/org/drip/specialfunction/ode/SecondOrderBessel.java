 ...
 *
 *  <ul>
 * 		<li>Construct the Standard Second Order Bessel ODE</li>
...
public class SecondOrderBessel extends SecondOrder
{
		...
		throws Exception
	{
		...
		if (!NumberUtil.IsValid (_alpha = alpha)) {
			throw new Exception ("SecondOrderBessel Constructor => Invalid Inputs");
		}
	}
