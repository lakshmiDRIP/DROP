...
public abstract class ErrorFunction extends org.drip.function.numerical.R1ToR1Estimator
{
	...
	/**
	 * Construct the EulerMacLaurin Instance of the ErrorFunction
	 * 
	 * @param termCount The Count of Approximation Terms
	 * 
	 * @return The EulerMacLaurin Instance of the ErrorFunction
	 */

	public static final ErrorFunction EulerMacLaurin (
		final int termCount)
	{
					...
					throws java.lang.Exception
				{
					if (!org.drip.quant.common.NumberUtil.IsValid (z) || 0. >= z)
					{
						throw new java.lang.Exception
							("ErrorFunction::EulerMacLaurin::evaluate => Invalid Inputs");
					}

					return 2. / java.lang.Math.sqrt (java.lang.Math.PI) *
		...
		throws java.lang.Exception
	{
		...
		if (null == (_r1ToR1SeriesGenerator = r1ToR1SeriesGenerator))
		{
			throw new java.lang.Exception ("ErrorFunction Constructor => Series Generator");
		}
	}
		...
		throws java.lang.Exception
	{
		...
		{
			throw new java.lang.Exception ("ErrorFunction::q => Invalid Inputs");
		}
		...
		throws java.lang.Exception
	{
		if (!org.drip.quant.common.NumberUtil.IsValid (x))
		{
			throw new java.lang.Exception ("ErrorFunction::cdf => Invalid Inputs");
		}
