...
/**
 * <i>FourierSeries</i> implements the Expansion in the Fourier Series for the Log Gamma Estimation. The
 * References are:
 * 
 * <br><br>
 * 	<ul>
...
public class FourierSeries
{
	...
	public static final org.drip.numerical.estimation.R1ToR1Series MalmstenBlagouchine (
		final int termCount)
	{
		try
		{
			...
			return new org.drip.numerical.estimation.R1ToR1Series (
				org.drip.function.gamma.FourierSeriesTerm.MalmstenBlagouchine(),
				false,
				termWeightMap
			);
		}
