...
/**
 * <i>R1Ball</i> extends the Continuous R<sup>1</sup> Space by enforcing the Closed Bounded Metric. The
 ...
 *
 *  <ul>
 * 		<li>Construct a <i>R1Ball</i> Instance of Unit Radius</li>
 * 		<li><i>R1Ball</i> Constructor</li>
...
public class R1Ball extends R1Field
{
	...
	/**
	 * Construct a <i>R1Ball</i> Instance of Unit Radius
	 * 
	 ...
	 * 
	 * @return <i>R1Ball</i> Instance of Unit Radius
	 */

	public static final R1Ball ClosedUnit (
	...
	{
		try {
			return new R1Ball (dblLeftEdge, dblRightEdge, distR1, iPNorm, 1.);
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		throws Exception
	{
		...
		if (!NumberUtil.IsValid (_normRadius = normRadius) || 0. >= _normRadius) {
			throw new Exception ("R1Ball Constructor: Invalid Inputs");
		}
	}
