...
/**
 * <i>R1Field</i> implements the Normed, Bounded/Unbounded Continuous l<sub>p</sub> R<sup>1</sup> Fields. The
 ...
 * 		<li><i>R1Field</i> Space Constructor</li>
 *  </ul>
 *
 *  <br>
 *  <style>table, td, th {
...
public class R1Field extends R1ContinuousVector implements R1Normed
{
	...
	public static final R1Field Standard (
	...
	{
		try {
			return new R1Field (dblLeftEdge, dblRightEdge, distR1, iPNorm);
	...
	public static final R1Field Supremum (
		final double dblLeftEdge,
		final double dblRightEdge,
		final org.drip.measure.distribution.R1Continuous distR1)
	{
		try {
			return new R1Field (dblLeftEdge, dblRightEdge, distR1, java.lang.Integer.MAX_VALUE);
		} catch (java.lang.Exception e) {
			e.printStackTrace();
		}
		...
		throws Exception
	{
		...
		if (0 > (_pNorm = pNorm)) {
			throw new Exception ("R1Field Constructor: Invalid p-norm");
		}
		...
		throws Exception
	{
		if (!validateInstance (x)) {
			throw new Exception ("R1Field::sampleMetricNorm => Invalid Inputs");
		}
		...
		throws Exception
	{
		if (null == _r1Univariate) {
			throw new Exception ("R1Field::populationMode => Invalid Inputs");
		}
		...
		if (null == modeVariateOutputPair) {
			throw new Exception ("R1Field::populationMode => Cannot compute VOP Mode");
		}
	...
	{
		if (null == _r1Univariate) {
			throw new Exception ("R1Field::populationMetricNorm => Invalid Inputs");
		}
		...
		throws Exception
	{
		if (null == r1ToR1Function || null == _r1Univariate) {
			throw new Exception ("R1Field::borelMeasureSpaceExpectation => Invalid Inputs");
		}
