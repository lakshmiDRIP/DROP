...
/**
 * <i>RdHilbert</i> implements the Bounded/Unbounded, Continuous l<sub>2</sub> R<sup>d</sup> Spaces. The
 ...
 * 		<li><i>RdHilbert</i> Space Constructor</li>
 *  </ul>
 *
 *  <br>
 *  <style>table, td, th {
...
public class RdHilbert extends RdBanach
{
	...
	public static final RdHilbert StandardHilbert (
		final int iDimension,
		final org.drip.measure.distribution.RdContinuous distRd)
	{
		try {
			return 0 >= iDimension ? null : new RdHilbert (new
	...
	/**
	 * <i>RdHilbert</i> Space Constructor
	 * 
		...
		throws Exception
	{
		if (!validateInstance (xArray)) {
			throw new Exception ("RdHilbert::sampleMetricNorm => Invalid Inputs");
		}
