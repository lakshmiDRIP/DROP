...
/**
 * <i>RdBall</i> extends the Continuous R<sup>d</sup> Space by enforcing the Closed Bounded Metric. The
 ...
 *
 *  <ul>
 * 		<li>Construct a Unit Radius <i>RdBall</i> Instance</li>
 * 		<li><i>RdBall</i> Space Constructor</li>
 *  </ul>
 *
 *  <br>
 *  <style>table, td, th {
...
public class RdBall extends RdBanach
{
	...
	/**
	 * Construct a Unit Radius <i>RdBall</i> Instance
	 * 
	 ...
	 * 
	 * @return Unit Radius <i>RdBall</i> Instance
	 */

	public static final RdBall ClosedUnit (
		final org.drip.spaces.tensor.R1ContinuousVector[] aR1CV,
		final org.drip.measure.distribution.RdContinuous distRd,
		final int iPNorm)
	{
		try {
			return new RdBall (aR1CV, distRd, iPNorm, 1.);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	public RdBall (
		...
		final RdContinuous rdBorelSigmaMeasure,
		final int pNorm,
		...
		throws Exception
	{
		...
		if (!NumberUtil.IsValid (_normRadius = normRadius) || 0. >= _normRadius) {
			throw new Exception ("RdBall Constructor: Invalid Inputs");
		}
	}
