...
/**
 * PositionGroupVertexExposureComponent holds the Credit, the Debt, and the Funding Exposures, as well as the
 *  Collateral Balances at each Re-hypothecation Position Group.  The References are:
 *  
...
public interface PositionGroupVertexExposureComponent
{
