...
/**
 * EventSequence holds the BCBS/IOSCO prescribed Events Time-line occurring Margin Period. The References
 *  are:
 *  
...
public class EventSequence
{
	...
	private org.drip.xva.csatimeline.EventDate _ed = null;
	private org.drip.xva.csatimeline.EventDate _etd = null;
	private org.drip.xva.csatimeline.EventDate _ped = null;
	private org.drip.xva.csatimeline.EventDate _honored = null;
	private org.drip.xva.csatimeline.EventDate _valuation = null;
	private org.drip.xva.csatimeline.EventDate _nonHonored = null;
	private org.drip.xva.csatimeline.EventDate _etdDesignation = null;
	private org.drip.xva.csatimeline.EventDate _edCommunication = null;
	private org.drip.xva.csatimeline.EventDate _pedCommunication = null;
	private org.drip.xva.csatimeline.EventDate _collateralTransferInitiation = null;
		...
		final java.lang.String calendarSet)
	{
		...
		org.drip.xva.csatimeline.EventDate valuation = org.drip.xva.csatimeline.EventDateBuilder.Valuation
			(valuationDate);
		...
		org.drip.xva.csatimeline.EventDate honored = org.drip.xva.csatimeline.EventDateBuilder.Honored (
			valuation,
			calendarSet
		);
		...
		org.drip.xva.csatimeline.EventDate nonHonored =
			org.drip.xva.csatimeline.EventDateBuilder.NonHonored (
				org.drip.xva.csatimeline.EventDateBuilder.Valuation (
					valuation.date().addBusDays (
						org.drip.xva.csatimeline.EventDateBuilder.MARGIN_FREQUENCY_DAILY,
						calendarSet
					)
				),
				calendarSet
		...
		org.drip.xva.csatimeline.EventDate ped = org.drip.xva.csatimeline.EventDateBuilder.PED (
			nonHonored.date().addBusDays (
				org.drip.xva.csatimeline.EventDateBuilder.PED_CALL_OUT_DELAY_AGGRESSIVE,
				calendarSet
			)
		);
		...
		org.drip.xva.csatimeline.EventDate ed = org.drip.xva.csatimeline.EventDateBuilder.IMA2002ED (
			ped,
			calendarSet
		);
		...
		org.drip.xva.csatimeline.EventDate etdDesignation =
			org.drip.xva.csatimeline.EventDateBuilder.ETDDesignation (
				ped.date().addBusDays (
					org.drip.xva.csatimeline.EventDateBuilder.ETD_DESIGNATION_DELAY_AGGRESSIVE,
					calendarSet
				)
			);
		...
		try
		{
			return new EventSequence (
				valuation,
				honored,
				org.drip.xva.csatimeline.EventDateBuilder.RegularCollateralTransferInitiation (
					honored,
					calendarSet
				),
				nonHonored,
				ped,
				org.drip.xva.csatimeline.EventDateBuilder.PEDCommunication (
					ped.date().addBusDays (
						org.drip.xva.csatimeline.EventDateBuilder.PED_COMMUNICATION_DELAY_AGGRESSIVE,
						calendarSet
					)
				),
				ed,
				org.drip.xva.csatimeline.EventDateBuilder.EDCommunication (
					ed.date().addBusDays (
						org.drip.xva.csatimeline.EventDateBuilder.ED_COMMUNICATION_DELAY_AGGRESSIVE,
						calendarSet
					)
				),
				etdDesignation,
				org.drip.xva.csatimeline.EventDateBuilder.ETD (
					etdDesignation.date().addBusDays (
						org.drip.xva.csatimeline.EventDateBuilder.ETD_CALL_OUT_DELAY_AGGRESSIVE,
						calendarSet
					)
				),
				org.drip.xva.csatimeline.EventDateBuilder.MARGIN_FREQUENCY_DAILY,
				org.drip.xva.csatimeline.EventDateBuilder.CURE_PERIOD_IMA_2002,
				calendarSet
			);
		}
		...
		final java.lang.String calendarSet)
	{
		...
		org.drip.xva.csatimeline.EventDate ped = org.drip.xva.csatimeline.EventDateBuilder.PED (
			nonHonored.date().addBusDays (
				org.drip.xva.csatimeline.EventDateBuilder.PED_CALL_OUT_DELAY_CONSERVATIVE,
				calendarSet
			)
		);
		...
		org.drip.xva.csatimeline.EventDate etdDesignation =
			org.drip.xva.csatimeline.EventDateBuilder.ETDDesignation (
				ped.date().addBusDays (
					org.drip.xva.csatimeline.EventDateBuilder.ETD_DESIGNATION_DELAY_CONSERVATIVE,
					calendarSet
				)
			);
		...
		try
		{
			return new EventSequence (
				...
				org.drip.xva.csatimeline.EventDateBuilder.PEDCommunication (
					ped.date().addBusDays (
						org.drip.xva.csatimeline.EventDateBuilder.PED_COMMUNICATION_DELAY_CONSERVATIVE,
						calendarSet
					)
				),
				ed,
				org.drip.xva.csatimeline.EventDateBuilder.EDCommunication (
					ed.date().addBusDays (
						org.drip.xva.csatimeline.EventDateBuilder.ED_COMMUNICATION_DELAY_CONSERVATIVE,
						calendarSet
					)
				),
				etdDesignation,
				org.drip.xva.csatimeline.EventDateBuilder.ETD (
					etdDesignation.date().addBusDays (
						org.drip.xva.csatimeline.EventDateBuilder.ETD_CALL_OUT_DELAY_CONSERVATIVE,
						calendarSet
					)
				),
				org.drip.xva.csatimeline.EventDateBuilder.MARGIN_FREQUENCY_DAILY,
	...
	public EventSequence (
		...
		final org.drip.xva.csatimeline.EventDate collateralTransferInitiation,
		final org.drip.xva.csatimeline.EventDate nonHonored,
		final org.drip.xva.csatimeline.EventDate ped,
		final org.drip.xva.csatimeline.EventDate pedCommunication,
		final org.drip.xva.csatimeline.EventDate ed,
		final org.drip.xva.csatimeline.EventDate edCommunication,
		final org.drip.xva.csatimeline.EventDate etdDesignation,
		final org.drip.xva.csatimeline.EventDate etd,
	...
	public org.drip.xva.csatimeline.EventDate valuation()
	{
		return _valuation;
	}
	...
	public org.drip.xva.csatimeline.EventDate honored()
	{
		return _honored;
	}
	...
	public org.drip.xva.csatimeline.EventDate collateralTransferInitiation()
	{
	...
	public org.drip.xva.csatimeline.EventDate nonHonored()
	{
		return _nonHonored;
	}
	...
	public org.drip.xva.csatimeline.EventDate ped()
	{
		return _ped;
	}
	...
	public org.drip.xva.csatimeline.EventDate pedCommunication()
	{
	...
	public org.drip.xva.csatimeline.EventDate ed()
	{
		return _ed;
	}
	...
	public org.drip.xva.csatimeline.EventDate edCommunication()
	{
	...
	public org.drip.xva.csatimeline.EventDate etdDesignation()
	{
	...
	public org.drip.xva.csatimeline.EventDate etd()
	{
		return _etd;
	}
