...
/**
 * CreditQualifyingBucket holds the ISDA SIMM 2.0 Credit Quality, Sector List, and Risk Weights for a given
 * 	Credit Qualifying Issuer Exposure Bucket. The References are:
 *  
...
public class CreditQualifyingBucket
{
	...
	/**
	 * CreditQualifyingBucket Constructor
	 * 
	...
	{
		if (0 >= (_number = number) ||
			null == (_quality = quality) || _quality.isEmpty() ||
			null == (_sectorArray = sectorArray) || 0 == _sectorArray.length ||
			!org.drip.quant.common.NumberUtil.IsValid (_riskWeight = riskWeight))
		{
			throw new java.lang.Exception ("CreditQualifyingBucket Constructor => Invalid Inputs");
		}
	}
