...
/**
 * BucketAggregate holds the Augmented Risk Factor Sensitivities and the Weighted Aggregate Sensitivity for a
...
public class BucketAggregate
{
	...
	/**
	 * Retrieve the Bucket's Weighted Sensitivity Variance
	 * 
	 * @return The Bucket's Weighted Sensitivity Variance
	 */

	public double weightedSensitivityVariance()
	{
		return _weightedSensitivityVariance;
	}
