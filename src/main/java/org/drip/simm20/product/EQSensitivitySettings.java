...
public class EQSensitivitySettings
{
	...
	private java.util.Map<java.lang.Integer, java.lang.Double> _bucketRiskWeight = new
		java.util.HashMap<java.lang.Integer, java.lang.Double>();

	private java.util.Map<java.lang.Integer, java.lang.Double> _bucketDeltaThreshold = new
		java.util.HashMap<java.lang.Integer, java.lang.Double>();
	...
	{
		java.util.Map<java.lang.Integer, java.lang.Double> bucketRiskWeightMap = new
			java.util.HashMap<java.lang.Integer, java.lang.Double>();
		...
		java.util.Map<java.lang.Integer, java.lang.Double> bucketDeltaThresholdMap = new
			java.util.HashMap<java.lang.Integer, java.lang.Double>();
	 ...
	 * 
	 * @param bucketRiskWeight The Bucket Risk Weight
	 * @param bucketDeltaThreshold The Bucket Delta Threshold
	...
	public EQSensitivitySettings (
		final java.util.Map<java.lang.Integer, java.lang.Double> bucketRiskWeight,
		final java.util.Map<java.lang.Integer, java.lang.Double> bucketDeltaThreshold,
		final org.drip.measure.stochastic.LabelCorrelation bucketCorrelation)
		throws java.lang.Exception
	{
		if (null == (_bucketDeltaThreshold = bucketDeltaThreshold) || 0 == _bucketDeltaThreshold.size() ||
			null == (_bucketRiskWeight = bucketRiskWeight) || 0 == _bucketRiskWeight.size() ||
	...
	public java.util.Map<java.lang.Integer, java.lang.Double> bucketRiskWeight()
	{
		return _bucketRiskWeight;
	}

	/**
	 * Retrieve the Bucket Delta Threshold
	 * 
	 * @return The Bucket Delta Threshold
	 */

	public java.util.Map<java.lang.Integer, java.lang.Double> bucketDeltaThreshold()
	{
		return _bucketDeltaThreshold;
	}
