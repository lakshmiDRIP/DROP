...
/**
 * IRFactorSensitivity holds the ISDA SIMM 2.0 Risk Factor Tenor Bucket Sensitivities across IR Factor Sub
...
public class IRFactorSensitivity
{
	...
	/**
	 * IRFactorSensitivity Constructor
	 * 
		...
		throws java.lang.Exception
	{
		...
		{
			throw new java.lang.Exception ("IRFactorSensitivity Constructor => Invalid Inputs");
		}
	}
	...
	{
		return _oisSensitivity.cumulative() +
			_libor1MSensitivity.cumulative() +
			_libor3MSensitivity.cumulative() +
			_libor6MSensitivity.cumulative() +
			_libor12MSensitivity.cumulative();
	}
		...
		throws java.lang.Exception
	{
		...
		{
			throw new java.lang.Exception ("IRFactorSensitivity::concentrationRiskFactor => Invalid Inputs");
		}
