...
{
	private java.util.Map<java.lang.Integer, org.drip.simm20.product.EQBucketNetSensitivity> _bucketMap = new
		java.util.HashMap<java.lang.Integer, org.drip.simm20.product.EQBucketNetSensitivity>();
	...
	public EQNetSensitivity (
		final java.util.Map<java.lang.Integer, org.drip.simm20.product.EQBucketNetSensitivity> bucketMap)
	...
	public java.util.Map<java.lang.Integer, org.drip.simm20.product.EQBucketNetSensitivity> bucketMap()
	{
		return _bucketMap;
	}
	...
	public double deltaMargin (
		final org.drip.simm20.product.EQSensitivitySettings eqSensitivitySettings)
		throws java.lang.Exception
	{
		...
		{
			double netSensitivityI = _bucketMap.get (bucketIndexI).weighted();

			for (int bucketIndexJ = 1; bucketIndexJ <= 12; ++bucketIndexJ)
			{
				deltaMargin = deltaMargin + netSensitivityI * _bucketMap.get (bucketIndexJ).weighted() *
					bucketCorrelation.entry (
						"" + bucketIndexI,
						"" + bucketIndexJ
					);
			}
