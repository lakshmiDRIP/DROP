...
/**
 * EQSettingsContainer holds the ISDA SIMM 2.0 Equity Buckets and their Correlations. The References are:
 *  
...
public class EQSettingsContainer
{
	private static org.drip.measure.stochastic.LabelCorrelation s_CrossBucketCorrelation = null;

	private static final java.util.Map<java.lang.Integer, org.drip.simm20.equity.EQBucket> s_BucketMap =
		new java.util.TreeMap<java.lang.Integer, org.drip.simm20.equity.EQBucket>();
	...
	public static final boolean Init()
	{
		try
		{
			s_BucketMap.put (
				-1,
				new org.drip.simm20.equity.EQBucket (
					-1,
					org.drip.simm20.equity.MarketCapitalizationSystemics.ALL,
					org.drip.simm20.equity.RegionSystemics.ALL,
					org.drip.simm20.credit.SectorSystemics.ALL,
					32.,
					0.00,
					0.64
				)
			...
			s_BucketMap.put (
				...
				new org.drip.simm20.equity.EQBucket (
					1,
					org.drip.simm20.equity.MarketCapitalizationSystemics.LARGE,
					org.drip.simm20.equity.RegionSystemics.EMERGING_MARKETS,
					org.drip.simm20.credit.SectorSystemics.CONSUMER_SERVICES,
					25.,
					0.14,
					0.28
				)
			...
			s_BucketMap.put (
				...
				new org.drip.simm20.equity.EQBucket (
					...
					org.drip.simm20.equity.MarketCapitalizationSystemics.LARGE,
					org.drip.simm20.equity.RegionSystemics.EMERGING_MARKETS,
					org.drip.simm20.credit.SectorSystemics.TELECOMMUNICATIONS_INDUSTRIALS,
					32.,
					0.20,
					0.28
				)
			...
			s_BucketMap.put (
				...
				new org.drip.simm20.equity.EQBucket (
					...
					org.drip.simm20.equity.MarketCapitalizationSystemics.LARGE,
					org.drip.simm20.equity.RegionSystemics.EMERGING_MARKETS,
					org.drip.simm20.credit.SectorSystemics.HEAVY_INDUSTRIALS,
					29.,
					0.19,
					0.28
				)
			...
			s_BucketMap.put (
				...
				new org.drip.simm20.equity.EQBucket (
					...
					org.drip.simm20.equity.MarketCapitalizationSystemics.LARGE,
					org.drip.simm20.equity.RegionSystemics.EMERGING_MARKETS,
					org.drip.simm20.credit.SectorSystemics.INVESTMENT,
					27.,
					0.21,
					0.28
				)
			...
			s_BucketMap.put (
				...
				new org.drip.simm20.equity.EQBucket (
					5,
					org.drip.simm20.equity.MarketCapitalizationSystemics.LARGE,
					org.drip.simm20.equity.RegionSystemics.DEVELOPED_MARKETS,
					org.drip.simm20.credit.SectorSystemics.CONSUMER_SERVICES,
					18.,
					0.24,
					0.28
			...
			s_BucketMap.put (
				...
				new org.drip.simm20.equity.EQBucket (
					9,
					org.drip.simm20.equity.MarketCapitalizationSystemics.SMALL,
					org.drip.simm20.equity.RegionSystemics.EMERGING_MARKETS,
					org.drip.simm20.credit.SectorSystemics.ALL,
					27.,
					0.20,
			...
			s_BucketMap.put (
				...
				new org.drip.simm20.equity.EQBucket (
					...
					org.drip.simm20.equity.MarketCapitalizationSystemics.ALL,
					org.drip.simm20.equity.RegionSystemics.ALL,
					org.drip.simm20.credit.SectorSystemics.INDEX_FUND_ETF,
					16.,
					0.62,
					0.28
				)
			...
			s_BucketMap.put (
				...
				new org.drip.simm20.equity.EQBucket (
					...
					org.drip.simm20.equity.MarketCapitalizationSystemics.ALL,
					org.drip.simm20.equity.RegionSystemics.ALL,
					org.drip.simm20.credit.SectorSystemics.VOLATILITY_INDEX,
					16.,
					0.62,
					0.28
				)
	...
	public static final org.drip.simm20.equity.EQBucket Bucket (
		final int bucketNumber)
	{
	...
	public static final java.util.Map<java.lang.Integer, org.drip.simm20.equity.EQBucket> BucketMap()
	{
		return s_BucketMap;
	}
}
