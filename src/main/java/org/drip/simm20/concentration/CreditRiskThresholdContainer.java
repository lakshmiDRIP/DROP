...
/**
 * CreditRiskThresholdContainer holds the ISDA SIMM 2.0 Credit Risk Thresholds - the Credit Risk Buckets and
...
public class CreditRiskThresholdContainer
{
	private static final java.util.Map<java.lang.Integer, org.drip.simm20.concentration.DeltaVegaThreshold>
		s_CreditRiskQualifyingThresholdMap = new java.util.TreeMap<java.lang.Integer,
			org.drip.simm20.concentration.DeltaVegaThreshold>();

	private static final java.util.Map<java.lang.Integer, org.drip.simm20.concentration.DeltaVegaThreshold>
		s_CreditRiskNonQualifyingThresholdMap = new java.util.TreeMap<java.lang.Integer,
			org.drip.simm20.concentration.DeltaVegaThreshold>();
	...
	public static final boolean Init()
	{
		try
		{
			s_CreditRiskQualifyingThresholdMap.put (
				-1,
			...
			s_CreditRiskNonQualifyingThresholdMap.put (
				-1,
				new org.drip.simm20.concentration.DeltaVegaThreshold (
					0.5,
					65.
	...
	{
		return s_CreditRiskQualifyingThresholdMap.keySet();
	}
	...
	{
		return s_CreditRiskNonQualifyingThresholdMap.keySet();
	}
	...
	{
		return s_CreditRiskQualifyingThresholdMap.containsKey (bucketNumber);
	}
	...
	public static final boolean ContainsNonQualifyingBucket (
		final int bucketNumber)
	{
		return s_CreditRiskNonQualifyingThresholdMap.containsKey (bucketNumber);
	}
	...
	public static final org.drip.simm20.concentration.DeltaVegaThreshold QualifyingThreshold (
		final int bucketNumber)
	{
		return ContainsQualifyingBucket (bucketNumber) ? s_CreditRiskQualifyingThresholdMap.get
			(bucketNumber) : null;
	}
	...
	public static final org.drip.simm20.concentration.DeltaVegaThreshold NonQualifyingThreshold (
		final int bucketNumber)
	{
		return ContainsNonQualifyingBucket (bucketNumber) ? s_CreditRiskNonQualifyingThresholdMap.get
			(bucketNumber) : null;
	}
	...
	{
		return s_CreditRiskQualifyingThresholdMap;
	}
	...
	{
		return s_CreditRiskNonQualifyingThresholdMap;
	}
}
