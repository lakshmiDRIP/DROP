...
/**
 * FXRiskThresholdContainer holds the ISDA SIMM 2.0 FX Risk Thresholds - the FX Categories and the Delta/Vega
 *  Limits defined for the Concentration Thresholds. The References are:
 *  
...
public class FXRiskThresholdContainer
{
	private static final java.util.Map<java.lang.Integer, org.drip.simm20.concentration.FXRiskGroup>
		s_FXRiskGroupMap = new java.util.TreeMap<java.lang.Integer,
			org.drip.simm20.concentration.FXRiskGroup>();
	...
	public static final boolean Init()
	{
		try
		{
			s_FXRiskGroupMap.put (
				1,
				new org.drip.simm20.concentration.FXRiskGroup (
					1,
	...
	public static final org.drip.simm20.concentration.FXRiskGroup FXRiskGroup (
		final int categoryNumber)
	{
	...
	public static final java.util.Map<java.lang.Integer, org.drip.simm20.concentration.FXRiskGroup>
		FXRiskGroupMap()
	{
