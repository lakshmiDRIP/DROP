...
/**
 * CRQSettingsContainer holds the ISDA SIMM 2.0 Credit Qualifying Buckets. The References are:
 *  
...
public class CRQSettingsContainer
{
		...
		try
		{
			...
			s_BucketMap.put (
				...
				new org.drip.simm20.credit.CRBucket (
					...
					org.drip.simm20.credit.SectorSystemics.SOVEREIGNS,
					85.
				)
			);
			...
			s_BucketMap.put (
				...
				new org.drip.simm20.credit.CRBucket (
					2,
					org.drip.simm20.credit.CRSystemics.CREDIT_QUALITY_INVESTMENT_GRADE,
					org.drip.simm20.credit.SectorSystemics.FINANCIALS,
					85.
				)
			);
			...
			s_BucketMap.put (
				...
				new org.drip.simm20.credit.CRBucket (
					3,
					org.drip.simm20.credit.CRSystemics.CREDIT_QUALITY_INVESTMENT_GRADE,
					org.drip.simm20.credit.SectorSystemics.BASIC_MATERIALS,
					73.
				)
			);
			...
			s_BucketMap.put (
				...
				new org.drip.simm20.credit.CRBucket (
					4,
					org.drip.simm20.credit.CRSystemics.CREDIT_QUALITY_INVESTMENT_GRADE,
					org.drip.simm20.credit.SectorSystemics.CONSUMER,
					49.
				)
			);
			...
			s_BucketMap.put (
				...
				new org.drip.simm20.credit.CRBucket (
					5,
					org.drip.simm20.credit.CRSystemics.CREDIT_QUALITY_INVESTMENT_GRADE,
					org.drip.simm20.credit.SectorSystemics.TMT,
					48.
				)
			);
			...
			s_BucketMap.put (
				...
				new org.drip.simm20.credit.CRBucket (
					6,
					org.drip.simm20.credit.CRSystemics.CREDIT_QUALITY_INVESTMENT_GRADE,
					org.drip.simm20.credit.SectorSystemics.LOCAL_SERVICES,
					43.
				)
			);
