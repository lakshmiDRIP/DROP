...
/**
 * DiffusionEvaluatorLinearFader implements the Linear Drift and Terminal-Fading Volatility Evaluators for
 *  R^1 Random Diffusion Process.
 *
 * @author Lakshmi Krishnamurthy
 */

public class DiffusionEvaluatorLinearFader extends org.drip.measure.dynamics.DiffusionEvaluator
{
	private double _dblDrift = java.lang.Double.NaN;
	private double _dblVolatility = java.lang.Double.NaN;
	private double _dblTerminationTime = java.lang.Double.NaN;

	/**
	 * Generate a Standard Instance of DiffusionEvaluatorLinearFader
	 * 
	 * @param dblDrift The Drift
	 * @param dblVolatility The Volatility
	 * @param dblTerminationTime The Termination Time
	 * 
	 * @return The Standard Instance of DiffusionEvaluatorLinearFader
	 */

	public static final DiffusionEvaluatorLinearFader Standard (
		final double dblDrift,
		final double dblVolatility,
		final double dblTerminationTime)
	{
		...
		try
		{
			return new DiffusionEvaluatorLinearFader (
				dblDrift,
				dblVolatility,
				dblTerminationTime,
				leDrift,
	...
	private DiffusionEvaluatorLinearFader (
		final double dblDrift,
		final double dblVolatility,
		final double dblTerminationTime,
		...
		throws java.lang.Exception
	{
		...
		if (!org.drip.quant.common.NumberUtil.IsValid (_dblTerminationTime = dblTerminationTime) ||
			!org.drip.quant.common.NumberUtil.IsValid (_dblDrift = dblDrift) ||
			!org.drip.quant.common.NumberUtil.IsValid (_dblVolatility = dblVolatility))
			throw new java.lang.Exception ("DiffusionEvaluatorLinearFader Constructor => Invalid Inputs");
	}
