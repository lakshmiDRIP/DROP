...
/**
 * <i>R1ContinuousPareto</i> implements the R<sup>1</sup> Continuous Pareto Distribution. The References are:
 * 
 * <br><br>
 * 	<ul>
 * 		<li>
 ...
 *
 *  <ul>
 * 		<li><i>R1ContinuousPareto</i> Constructor</li>
 * 		<li>Retrieve k</li>
 ...
 *		<tr><td><b>Package</b></td> <td><a href = "https://github.com/lakshmiDRIP/DROP/tree/master/src/main/java/org/drip/measure/distibution/README.md">R<sup>1</sup> and R<sup>d</sup> Continuous Random Measure</a></td></tr>
 *  </table>
 *	<br>
 *
...
public class R1ContinuousPareto
	extends R1Continuous
{
	...
	/**
	 * <i>R1ContinuousPareto</i> Constructor
	 * 
		...
		throws Exception
	{
		...
		{
			throw new Exception ("R1ContinuousPareto Constructor => Invalid Inputs");
		}
	}
	...
	{
		if (!supported (t)) {
			throw new Exception ("R1ContinuousPareto::density => Variate not in Range");
		}
	...
	{
		if (!supported (t)) {
			throw new Exception ("R1ContinuousPareto::cumulative => Variate not in Range");
		}
		...
		throws Exception
	{
		if (!NumberUtil.IsValid (p) || 0. > p || 1. < p) {
			throw new Exception ("R1ContinuousPareto::quantile => p is Invalid");
		}
	...
	{
		if (1. >= _lambda) {
			throw new Exception ("R1ContinuousPareto::mean => Does not converge for lambda <= 1.");
		}
	...
	{
		if (2. >= _lambda) {
			throw new Exception ("R1ContinuousPareto::variance => Does not converge for lambda <= 2.");
		}
