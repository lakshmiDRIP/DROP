...
/**
 * <i>R1Discrete</i> implements the Discrete Distribution over the Combinatorial R<sup>1</sup> Outcomes. It
 * 	provides the following Functionality:
 *
 *  <ul>
 * 		<li>Generate an Standard Instance of Discrete <i>R1Discrete</i></li>
...
public class R1Discrete
{
	...
	/**
	 * Generate an Standard Instance of Discrete <i>R1Discrete</i>
	 * 
	 * @param instanceArray Instance Array
	 * @param probabilityArray Probability Array
	 * 
	 * @return Standard Instance of Discrete <i>R1Discrete</i>
	 */

	public static R1Discrete Standard (
		...
		final double[] probabilityArray)
	{
		...
		try {
			return new R1Discrete (probabilityMap);
		} catch (Exception e) {
			e.printStackTrace();
		}
		...
		throws Exception
	{
		if (!NumberUtil.IsValid (x) || !_probabilityMap.containsKey (x)) {
			throw new Exception ("R1Discrete::probability => Input Instance is Invalid");
		}
