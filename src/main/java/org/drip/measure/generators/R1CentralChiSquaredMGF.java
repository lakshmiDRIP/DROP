...
/**
 * <i>R1CentralChiSquaredMGF</i> implements the Central Chi-squared <i>R1ToR1</i> Moment Generating Function.
 * 	The References are:
 * 
 * <br><br>
 * 	<ul>
	...
	extends R1MomentGeneratingFunction
{
	...
	/**
	 * <i>R1CentralChiSquaredMGF</i> Constructor
	 * 
	 * @param r1CentralChiSquaredDistribution Underlying R<sup>1</sup> Central Chi-squared Distribution
	 * 
	 * @throws Exception Thrown if the Inputs are Invalid
	 */

	public R1CentralChiSquaredMGF (
		final R1Central r1CentralChiSquaredDistribution)
		throws Exception
	{
		super (r1CentralChiSquaredDistribution);
	}
		...
		throws Exception
	{
		if (!NumberUtil.IsValid (t) || 0.5 < t) {
			throw new Exception ("R1CentralChiSquaredMGF::evaluate => t is Invalid");
		}
		...
		return Math.pow (1. - 2. * t, -0.5 * ((R1Central) distribution()).degreesOfFreedom());
	}
}
