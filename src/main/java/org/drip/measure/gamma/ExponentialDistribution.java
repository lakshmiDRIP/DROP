...
/**
 * <i>ExponentialDistribution</i> implements the Exponential Distribution in Terms of the R<sup>1</sup> Gamma
	...
	extends org.drip.measure.gamma.R1ShapeScaleDistribution
{
	...
	public org.drip.measure.gamma.R1ShapeScaleDistribution iidDistribution (
		final int n)
	{
		try
		{
