...
/**
 * <i>VertexRdSequence</i> holds the R<sup>d</sup> Realizations at the Individual Vertexes. It provides the
 *  following Functionality:
 *
 *  <ul>
 * 		<li>Construct a VertexRd Instance from the R<sup>d</sup> Sequence</li>
 * 		<li>Empty <i>VertexRdSequence</i> Constructor</li>
...
public class VertexRdSequence
{
	private List<double[]> _nodeList = new ArrayList<double[]>();

	/**
	 * Construct a <i>VertexRdSequence</i> Instance from the R<sup>d</sup> Sequence
	 * 
	 * @param sequenceArray The R<sup>d</sup> Sequence Array
	 * 
	 * @return The <i>VertexRdSequence</i> Instance
	 */

	public static final VertexRdSequence FromFlatForm (
		final double[][] sequenceArray)
	{
		...
		VertexRdSequence vertexRd = new VertexRdSequence();
	...
	/**
	 * Empty <i>VertexRdSequence</i> Constructor
	 */

	public VertexRdSequence()
	{
	}
