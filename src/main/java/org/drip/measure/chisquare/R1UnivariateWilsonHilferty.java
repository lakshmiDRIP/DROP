...
public class R1UnivariateWilsonHilferty extends org.drip.measure.continuous.R1Univariate
{
	private int _degreesOfFreedom = -1;
	private org.drip.measure.gaussian.R1UnivariateNormal _r1UnivariateNormal = null;

	/**
	 * R1UnivariateWilsonHilferty Constructor
	 * 
	...
	public R1UnivariateWilsonHilferty (
		final int degreesOfFreedom)
		throws java.lang.Exception
	{
		if (0 >= (_degreesOfFreedom = degreesOfFreedom))
		{
			throw new java.lang.Exception ("R1UnivariateWilsonHilferty Constructor => Invalid Inputs");
		}

		double twoOver_9degreesOfFreedom_ = 2. / (9. * _degreesOfFreedom);
		...
		throws java.lang.Exception
	{
		...
		return java.lang.Math.pow (
			sumOfStandardNormalSquares / _degreesOfFreedom,
			1. / 3.
		);
	}
}
