 ...
 * Transformation for the Chi-Square Distribution. The References are:
 * 
 * <br><br>
 * 	<ul>
 * 		<li>
...
public class R1UnivariateFisherProxy extends org.drip.measure.continuous.R1Univariate
{
	private int _degreesOfFreedom = -1;
	private org.drip.measure.gaussian.R1UnivariateNormal _r1UnivariateNormal = null;

	/**
	 * R1UnivariateFisherProxy Constructor
	 * 
	...
	public R1UnivariateFisherProxy (
		final int degreesOfFreedom)
		throws java.lang.Exception
	{
		if (0 >= (_degreesOfFreedom = degreesOfFreedom))
		{
			throw new java.lang.Exception ("R1UnivariateFisherProxy Constructor => Invalid Inputs");
		}
