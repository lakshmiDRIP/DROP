...
/**
 * <i>ConjugateParameterPrior</i> implements the Determinants of the Parameter of the Conjugate Prior. The
 * 	References are:
 * 
 * <br><br>
 * 	<ul>
...
public class ConjugateParameterPrior
{
	 ...
	 * 
	 * @return Count of the Observation Suite
	 */
	...
	public double parameterEstimate()
	{
		return _parameterEstimate;
	}
		...
		final org.drip.validation.evidence.R1Sample sample)
	{
		...
		_observationCount = _observationCount + sample.realizationArray().length;
