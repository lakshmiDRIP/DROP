...
public class ModelMTMDistribution11a
{
	...
	private static final void ProbabilityPlot (
		final R1ProbabilityIntegralTransform pitTooHighVolatility,
		final R1ProbabilityIntegralTransform pitCorrectVolatility,
		final R1ProbabilityIntegralTransform pitTooLowVolatility,
		final double xLeft,
		final double xRight,
		final double xWidth)
		throws Exception
		...
		throws Exception
	{
		...
		R1Sample sampleVolatilityTooHigh = GenerateSample (
			mean,
			volatilityTooHigh,
			drawCount
		);

		R1Sample sampleVolatilityCorrect = GenerateSample (
			mean,
			volatilityCorrect,
			drawCount
		);

		R1Sample sampleVolatilityTooLow = GenerateSample (
			mean,
			volatilityTooLow,
			drawCount
		);
