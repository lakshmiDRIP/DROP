...
/**
 * <i>CRNQFoundationMarginComparison</i> illustrates the Comparison of the Credit (Non-Qualifying) Margin
 * 	Estimates using different Schemes for Calculating the Position-Bucket Curvature Margin. The References
 * 	are:
 * 
 * <br><br>
 *  <ul>
...
public class CRNQFoundationMarginComparison
{
