...
/**
 * <i>FXClassMargin24</i> illustrates the Computation of the ISDA 2.4 Aggregate Margin for across a Group of
 * 	FX Bucket Exposure Sensitivities. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
public class FXClassMargin24
{
		...
		throws Exception
	{
		...
		{
			int categoryIndex = FXRiskThresholdContainer24.CurrencyCategory (currency);
