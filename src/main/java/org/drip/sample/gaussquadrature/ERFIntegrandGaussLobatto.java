...
import org.drip.numerical.r1integration.GaussLobattoQuadratureGenerator;
...
/**
 * <i>ERFIntegrandGaussLobatto</i> computes the R<sup>1</sup> Numerical Estimate of the erf Integrand using
...
public class ERFIntegrandGaussLobatto
{
		...
		throws Exception
	{
		...
		System.out.println ("\t|                                    Gauss Lobatto erf Estimate                                    ||");
		...
		for (Map.Entry<Double, BuiltInEntry> builtInTableEntry : builtInTable.entrySet())
		{
			...
			double erfEstimate7P = GaussLobattoQuadratureGenerator.SevenPoint (
				0.,
				x
			).integrate (erfIntegrand);

			double erfEstimate6P = GaussLobattoQuadratureGenerator.SixPoint (
				0.,
				x
			).integrate (erfIntegrand);

			double erfEstimate5P = GaussLobattoQuadratureGenerator.FivePoint (
				0.,
				x
			).integrate (erfIntegrand);

			double erfEstimate4P = GaussLobattoQuadratureGenerator.FourPoint (
				0.,
				x
			).integrate (erfIntegrand);

			double erfEstimate3P = GaussLobattoQuadratureGenerator.ThreePoint (
				0.,
				x
			).integrate (erfIntegrand);
			...
			System.out.println (
				...
				FormatUtil.FormatDouble (erfEstimate7P, 1, 9, 1.) + " | " +
				FormatUtil.FormatDouble (erfEstimate6P, 1, 9, 1.) + " | " +
