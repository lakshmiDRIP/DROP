...
/**
 * <i>JB1Attribution</i> demonstrates the Invocation of the Historical PnL Horizon PnL Attribution analysis
 * 	for the JB1 Series.
 *
 *	<br><br>
 *  <ul>
...
public class JB1Attribution {
		...
		throws Exception
	{
		...
		String strPrintLocation =
			"C:\\DROP\\Daemons\\Transforms\\TreasuryFuturesCloses\\JB1ClosesReconstitutor.csv";
