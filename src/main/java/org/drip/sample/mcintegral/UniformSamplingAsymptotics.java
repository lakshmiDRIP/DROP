...
/**
 * <i>UniformSamplingAsymptotics</i> illustrates Asymptotics for Uniformly Sampled Monte-Carlo Integration of
...
public class UniformSamplingAsymptotics
{
		...
		throws Exception
	{
		...
		System.out.println ("\t| UNIFORM SAMPLING ASYMPTOTE ||");
		...
		for (int samplingPointCount : samplingPointCountArray) {
			...
			System.out.println (
				"\t|" + FormatUtil.FormatDouble (samplingPointCount, 7, 0, 1.) + " =>" +
					FormatUtil.FormatDouble (monteCarloRun.quadratureValue(), 1, 4, 1.) + " |" +
