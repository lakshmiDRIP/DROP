...
/**
 * <i>IncompleteIdentityProperty6</i> illustrates the Incomplete Beta Function Identity Property
...
public class IncompleteIdentityProperty6
{
	...
	private static final void Verifier (
		...
		throws Exception
	{
		R1PropertyVerification verification = IncompleteBetaEqualityLemma.Identity6().verify (
			x,
			a,
			b
		);
