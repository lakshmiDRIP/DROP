...
/**
 * <i>CreditQualifyingParameters24</i> demonstrates the Extraction and Display of ISDA SIMM 2.4 Single/Cross
...
public class CreditQualifyingParameters24
{

	private static final void RiskWeights()
	{
		Set<Integer> bucketIndexSet = CRQSettingsContainer24.BucketSet();

		System.out.println
			("\t||-------------------------------------------------------------------------------------------------------------||");

		System.out.println
			("\t||                               2.4 CREDIT QUALIFYING BUCKETS RISK WEIGHT                                     ||");
		...
		{
			CRBucket creditQualifyingBucket = CRQSettingsContainer24.Bucket (bucketIndex);
	...
	private static final void Systemics()
	{
		...
		System.out.println (
			...
			FormatUtil.FormatDouble (
				CRQSystemics24.RESIDUAL_BUCKET_RISK_WEIGHT, 3, 2, 1.
			) + " ||"
		);
		...
		System.out.println (
			"\t|| Vega Risk Wight                                     => " +
			FormatUtil.FormatDouble (
				CRQSystemics24.VEGA_RISK_WEIGHT, 3, 2, 1.
			) + " ||"
		);
		...
		System.out.println (
			...
			FormatUtil.FormatDouble (
				CRQSystemics24.BASE_CORRELATION_RISK_WEIGHT, 3, 2, 1.
			) + " ||"
		);
		...
		System.out.println (
			...
			FormatUtil.FormatDouble (
				CRQSystemics24.BASE_CORRELATION_CORRELATION, 3, 2, 1.
			) + " ||"
		);
		...
		System.out.println (
			...
			FormatUtil.FormatDouble (
				CRQBucketCorrelation24.SAME_ISSUER_SENIORITY_NON_RESIDUAL, 3, 2, 1.
			) + " ||"
		);
		...
		System.out.println (
			...
			FormatUtil.FormatDouble (
				CRQBucketCorrelation24.DIFFERENT_ISSUER_SENIORITY_NON_RESIDUAL, 3, 2, 1.
			) + " ||"
		);
		...
		System.out.println (
			...
			FormatUtil.FormatDouble (
				CRQBucketCorrelation24.SAME_ISSUER_SENIORITY_RESIDUAL, 3, 2, 1.
			) + " ||"
		);
		...
		System.out.println (
			...
			FormatUtil.FormatDouble (
				CRQBucketCorrelation24.DIFFERENT_ISSUER_SENIORITY_RESIDUAL, 3, 2, 1.
			) + " ||"
		);
	...
	private static final void CrossBucketCorrelation()
		throws Exception
	{
		LabelledVertexCorrelation crossBucketCorrelation = CRQSettingsContainer24.CrossBucketCorrelation();
