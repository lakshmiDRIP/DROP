...
/**
 * <i>CommodityParameters24</i> demonstrates the Extraction and Display of ISDA SIMM 2.4 Single/Cross
...
public class CommodityParameters24
{

	private static final void RiskWeights()
	{
		Set<Integer> bucketIndexSet = CTSettingsContainer24.BucketSet();

		System.out.println
			("\t||-------------------------------------------------------------------------------------------------------------||");

		System.out.println
			("\t||                                    2.4 COMMODITY BUCKETS RISK WEIGHT                                        ||");
		...
		{
			CTBucket commodityBucket = CTSettingsContainer24.Bucket (bucketIndex);
	...
	private static final void Systemics()
	{
		...
		System.out.println (
			...
			FormatUtil.FormatDouble (
				CTSystemics24.HISTORICAL_VOLATILITY_RATIO, 3, 2, 1.
			) + " ||"
		);
		...
		System.out.println (
			"\t|| Vega Risk Weight                                    => " +
			FormatUtil.FormatDouble (
				CTSystemics24.VEGA_RISK_WEIGHT, 3, 2, 1.
			) + " ||"
		);
	...
	private static final void CrossBucketCorrelation()
		throws Exception
	{
		LabelledVertexCorrelation crossBucketCorrelation = CTSettingsContainer24.CrossBucketCorrelation();
