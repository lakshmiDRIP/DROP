...
public class CorrelatedNumeraireXVAExplain
{
	...
	private static final EvolutionTrajectoryVertex RunStep (
		...
		throws Exception
	{
		PositionGreekVertex agvStart = evolutionTrajectoryVertexStart.positionGreekVertex();

		ReplicationPortfolioVertex rpvStart = evolutionTrajectoryVertexStart.replicationPortfolioVertex();

		double dblDerivativeXVAValueStart = agvStart.derivativeXVAValue();

		double dblTimeWidth = (marketVertexFinish.anchorDate().julian() - marketVertexStart.anchorDate().julian()) / 365.;

		double dblTimeStart = evolutionTrajectoryVertexStart.time();

		double dblTime = dblTimeStart + dblTimeWidth;

		PrimarySecurityDynamicsContainer tc = trajectoryEvolutionScheme.tradeablesContainer();

		double dblCollateralSchemeNumeraire = marketVertexStart.csaReplicator();

		BurgardKjaerEdgeRun bker = burgardKjaerOperator.edgeRun (
			new MarketEdge (
				marketVertexStart,
				marketVertexFinish
			),
		...
		org.drip.xva.derivative.CashAccountEdge cae = trajectoryEvolutionScheme.rebalanceCash (
			evolutionTrajectoryVertexStart,
			new MarketEdge (
				marketVertexStart,
				marketVertexFinish
		...
		double dblAssetNumeraireFinish = marketVertexFinish.latentStateValue (equityLabel);

		double dblBankSeniorFundingNumeraireFinish = marketVertexFinish.dealer().seniorFundingReplicator();

		double dblCounterPartyFundingNumeraireFinish = marketVertexFinish.client().seniorFundingReplicator();
		...
		throws Exception
	{
		...
		System.out.println ("\t||            - Asset Price Numeraire                                                                                                                                    ||");

		System.out.println ("\t||            - Bank Senior Funding Numeraire                                                                                                                            ||");

		System.out.println ("\t||            - Counter Party Senior Funding Numeraire                                                                                                                   ||");
		...
		System.out.println ("\t||            - Derivative XVA Cash Account                                                                                                                              ||");

		System.out.println ("\t||            - Derivative XVA Cash Account Accumulation                                                                                                                 ||");

		System.out.println ("\t||            - Derivative XVA Asset Cash Accumulation                                                                                                                   ||");

		System.out.println ("\t||            - Derivative XVA Bank Cash Accumulation                                                                                                                    ||");

		System.out.println ("\t||            - Derivative XVA Counter Party Cash Accumulation                                                                                                           ||");
