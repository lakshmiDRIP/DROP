...
/**
 * <i>Tengzhou</i> demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 * for Tengzhou.
 *  
 * <br><br>
 *  <ul>
...
public class Tengzhou {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2007,  5,  3);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2023,  7,  1);
		double dblCoupon = 0.05;
		double dblCleanPrice = 1.038;
		int iFreq = 2;
		String strCUSIP = "74526QLS9";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2017,  7,  1).julian(),
