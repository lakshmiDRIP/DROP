...
/**
 * <i>R1SignificantStatistics</i> illustrates the Generation of Significant Statistics for the R<sup>1</sup>
		...
		for (int i = 0; i < lambdaArray.length; ++i)
		{
			...
			System.out.println (
				"\t|| " + FormatUtil.FormatDouble (
					...
					exponentialDistribution.median(), 3, 3, 1.
				) + " |" + FormatUtil.FormatDouble (
					exponentialDistribution.mode(), 1, 1, 1.
				) + " |" + FormatUtil.FormatDouble (
