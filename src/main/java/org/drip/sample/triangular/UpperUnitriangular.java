...
/**
 * <i>UpperUnitriangular</i> shows the Construction, the Usage, and the Analysis of a Upper Uni-triangular
...
public class UpperUnitriangular
{
		...
		throws Exception
	{
		...
		for (int i = 0; i < upperUnitriangularR2Array.length; ++i) {
			System.out.println (
				"\t| Transpose " + elementCount + " x " + elementCount + "                    => [" +
					NumberUtil.ArrayRow (
						upperUnitriangularR2ArrayTranspose[i],
						2,
						1,
						false
					) + " ]||"
		...
		double[][] baseTransposeProduct =
			upperUnitriangular.multiply (upperUnitriangular.transpose()).r1Grid();
		...
		double[][] transposeBaseProduct =
			upperUnitriangular.transpose().multiply (upperUnitriangular).r1Grid();
		...
		System.out.println (
			"\t| Is Upper Triangular             => " + StringUtil.ToString (upperUnitriangular.isUpper())
		);

		System.out.println (
			"\t| Is Lower Triangular             => " + StringUtil.ToString (upperUnitriangular.isLower())
		);

		System.out.println (
			"\t| Is Diagonal                     => " + StringUtil.ToString (upperUnitriangular.isDiagonal())
		);

		System.out.println (
			"\t| Is Triangularizable             => " +
				StringUtil.ToString (upperUnitriangular.isTriangularizable())
		);

		System.out.println (
			"\t| Is Unitriangular                => " +
				StringUtil.ToString (upperUnitriangular.isUnitriangular())
		);

		System.out.println (
			"\t| Is Unit Triangular              => " + StringUtil.ToString (upperUnitriangular.isUnit())
		);

		System.out.println (
			"\t| Is Normed Triangular            => " + StringUtil.ToString (upperUnitriangular.isNormed())
		);

		System.out.println (
			"\t| Is Upper Unitriangular          => " +
				StringUtil.ToString (upperUnitriangular.isUpperUnitriangular())
		);

		System.out.println (
			"\t| Is Lower Unitriangular          => " +
				StringUtil.ToString (upperUnitriangular.isLowerUnitriangular())
		);

		System.out.println (
			"\t| Is Strictly Upper Triangular    => " +
				StringUtil.ToString (upperUnitriangular.isStrictlyUpper())
		);

		System.out.println (
			"\t| Is Strictly Lower Triangular    => " +
				StringUtil.ToString (upperUnitriangular.isStrictlyLower())
		);

		System.out.println (
			"\t| Is Atomic Upper Unitriangular   => " +
				StringUtil.ToString (upperUnitriangular.isAtomicUpper())
		);

		System.out.println (
			"\t| Is Atomic Lower Unitriangular   => " +
				StringUtil.ToString (upperUnitriangular.isAtomicLower())
		);

		System.out.println (
			"\t| Is Atomic                       => " + StringUtil.ToString (upperUnitriangular.isAtomic())
		);

		System.out.println (
			"\t| Is Frobenius                    => " +
				StringUtil.ToString (upperUnitriangular.isFrobenius())
		);

		System.out.println (
			"\t| Is Gauss                        => " + StringUtil.ToString (upperUnitriangular.isGauss())
		);

		System.out.println (
			"\t| Is Gauss Transformation         => " +
				StringUtil.ToString (upperUnitriangular.isGaussTransformation())
		);

		System.out.println (
			"\t| Determinant                     => " +
				FormatUtil.FormatDouble (upperUnitriangular.determinant(), 8, 0, 1., false)
		);

		System.out.println (
			"\t| Permanent                       => " +
				FormatUtil.FormatDouble (upperUnitriangular.permanent(), 8, 0, 1., false)
		);

		System.out.println (
			"\t| Eigenvalue Multiplicity Map     => " + upperUnitriangular.eigenValueMultiplicityMap()
		);

		System.out.println (
			"\t| Is Normal                       => " + StringUtil.ToString (upperUnitriangular.isNormal())
		);
