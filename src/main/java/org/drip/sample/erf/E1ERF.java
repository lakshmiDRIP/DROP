...
import org.drip.function.enerf.E1ErrorFunction;
...
/**
 * <i>E1ERF</i> illustrates the Estimation of E<sub>1</sub> erf. The References are:
 * 
 * <br><br>
 * 	<ul>
 * 		<li>
...
public class E1ERF
{
		...
		throws Exception
	{
		...
		E1ErrorFunction e1erfn = new E1ErrorFunction (null);

		System.out.println ("\t|----------------------------------------||");

		System.out.println ("\t|       E1 MacLaurin erf Estimate        ||");
		...
		for (double x : xArray)
		{
			System.out.println (
				...
				FormatUtil.FormatDouble (generalizedErrorFunction.evaluate (x), 2, 9, 1.) + " | " +
				FormatUtil.FormatDouble (e1erfn.evaluate (x), 2, 9, 1.) + " ||"
			);
		}
