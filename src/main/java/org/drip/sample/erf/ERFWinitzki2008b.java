...
/**
 * <i>ERFWinitzki2008b</i> illustrates the Error Function Estimation based on the Winitzki (2008b) Analytical
...
public class ERFWinitzki2008b
{
		...
		throws Exception
	{
		...
		System.out.println ("\t|                      erfWinitzki erf Estimate                      ||");
		...
		System.out.println ("\t|                - Winitzki Error Maximum                            ||");
		...
		for (Map.Entry<Double, BuiltInEntry> builtInTableEntry : builtInTable.entrySet())
		{
			...
			double erfEstimate = erfWinitzki.evaluate (x);
