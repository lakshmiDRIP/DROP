...
public class EnE2ERFMacLaurin
{
		...
		throws Exception
	{
		...
		GeneralizedErrorFunction erf1 = GeneralizedErrorFunction.MacLaurin (
			degree,
			termCount1
		);

		GeneralizedErrorFunction erf2 = GeneralizedErrorFunction.MacLaurin (
			degree,
			termCount2
		);

		GeneralizedErrorFunction erf3 = GeneralizedErrorFunction.MacLaurin (
			degree,
			termCount3
		);
		...
		System.out.println ("\t|                   E_2 MacLaurin erf Estimate                       ||");
