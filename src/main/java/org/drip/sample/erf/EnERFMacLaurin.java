...
/**
 * <i>EnERFMacLaurin</i> illustrates the MacLaurin Series Based Estimates for E<sub>n</sub> erf. The
 * References are:
 * 
 * <br><br>
 * 	<ul>
...
public class EnERFMacLaurin
{
		...
		throws Exception
	{
		...
		GeneralizedErrorFunction[] erfnArray = new GeneralizedErrorFunction[degreeArray.length];

		for (int degree : degreeArray)
		{
			erfnArray[degree] = GeneralizedErrorFunction.MacLaurin (
				degree,
				termCount
			);
		}
		...
		System.out.println ("\t|                - MacLaurin Estimate (Degree = 0)                                                                                                                ||");

		System.out.println ("\t|                - MacLaurin Estimate (Degree = 1)                                                                                                                ||");

		System.out.println ("\t|                - MacLaurin Estimate (Degree = 2)                                                                                                                ||");

		System.out.println ("\t|                - MacLaurin Estimate (Degree = 3)                                                                                                                ||");

		System.out.println ("\t|                - MacLaurin Estimate (Degree = 4)                                                                                                                ||");

		System.out.println ("\t|                - MacLaurin Estimate (Degree = 5)                                                                                                                ||");
		...
		for (double x : xArray)
		{
			System.out.println (
				...
				FormatUtil.FormatDouble (erfnArray[0].evaluate (x), 1, 2, 1.) + " | " +
				FormatUtil.FormatDouble (erfnArray[1].evaluate (x), 2, 2, 1.) + " | " +
				FormatUtil.FormatDouble (erfnArray[2].evaluate (x), 1, 2, 1.) + " | " +
				FormatUtil.FormatDouble (erfnArray[3].evaluate (x), 14, 0, 1.) + " | " +
				FormatUtil.FormatDouble (erfnArray[4].evaluate (x), 38, 0, 1.) + " | " +
				FormatUtil.FormatDouble (erfnArray[5].evaluate (x), 64, 0, 1.) + " ||"
			);
		}
