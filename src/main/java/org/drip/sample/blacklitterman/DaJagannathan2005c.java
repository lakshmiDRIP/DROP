...
/**
 * <i>DaJagannathan2005c</i> reconciles the Outputs of the Black-Litterman Model Process. The References are:
 *  
 * <br><br>
 *  <ul>
 *  	<li>
...
public class DaJagannathan2005c
{
		...
		throws Exception
	{
		...
		double[] excessExcessReturnsArray = new double[] {
			0.01,
			0.01,
			0.01
		};
		...
		double[] assetSpaceJointReturnsReconcilerMatrix = new double[] {
			0.0384,
			0.0188,
			0.0286
		};
		...
		for (int assetSpaceJointReturnsReconcilerIndex = 0;
			assetSpaceJointReturnsReconcilerIndex < assetSpaceJointReturnsReconcilerMatrix.length;
			++assetSpaceJointReturnsReconcilerIndex)
		{
			System.out.println (
				...
				FormatUtil.FormatDouble (
					...
					assetSpaceJointReturnsReconcilerMatrix[assetSpaceJointReturnsReconcilerIndex],
					1,
					2,
					100.
				) + "% ||"
