...
/**
 * <i>CreditMarketsDetail</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
...
public class CreditMarketsDetail
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Credit Markets";
		String[] regionArray =
		{
			"ASIA",
			"ASIA",
