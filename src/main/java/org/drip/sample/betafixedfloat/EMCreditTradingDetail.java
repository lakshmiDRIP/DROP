...
/**
 * <i>EMCreditTradingDetail</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 *  using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - EM Credit Trading
 * 
...
public class EMCreditTradingDetail
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "EM Credit Trading";
		String[] regionArray =
		{
			"ASIA",
			"ASIA",
