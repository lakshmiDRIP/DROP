...
/**
 * <i>IGPrmryLoansDetail</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 * 	using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - IG Primary Loans Detail
 * 
 *     HIGH   - Fixed    Beta
 *     LOW    - Floating Beta
 *     
...
public class IGPrmryLoansDetail
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "IG Prmry Loans";
		String[] regionArray =
		{
			"ASIA",
			"EMEA",
