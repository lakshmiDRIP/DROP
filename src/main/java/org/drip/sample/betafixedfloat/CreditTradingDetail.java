...
/**
 * <i>CreditTradingDetail</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 *  using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Credit Trading
 * 
...
public class CreditTradingDetail
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Credit Trading";
		String[] regionArray =
		{
			"ASIA",
			"ASIA",
