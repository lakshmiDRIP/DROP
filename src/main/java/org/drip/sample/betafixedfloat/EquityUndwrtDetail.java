...
/**
 * <i>EquityUndwrtDetail</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 * 	using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Equity Under-writing
 * 
...
public class EquityUndwrtDetail
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Equity Undwrt";
		String[] regionArray =
		{
			"ASIA",
			"EMEA",
