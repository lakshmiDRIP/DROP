...
/**
 * <i>RiskTreasuryDetail</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 * 	using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Risk Treasury
 * 
 *     HIGH   - Fixed    Beta
 *     LOW    - Floating Beta
 *     
...
public class RiskTreasuryDetail
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Risk Treasury";
		String[] regionArray =
		{
			"ASIA",
			"ASIA",
