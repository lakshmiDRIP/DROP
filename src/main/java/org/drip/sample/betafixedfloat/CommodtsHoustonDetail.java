...
/**
 * <i>CommodtsHoustonDetail</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 * 	using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Commodities Houston
 * 
...
public class CommodtsHoustonDetail
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Commodts Houston";
		String[] regionArray =
		{
			"ASIA",
			"ASIA",
