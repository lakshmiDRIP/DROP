...
/**
 * <i>OtherSpecialAssetPoolDetail</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed
 * 	Segment using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Other Special Asset Pool
 * 
 *     HIGH   - Fixed    Beta
 *     LOW    - Floating Beta
 *     
...
public class OtherSpecialAssetPoolDetail
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Other Special Asset Pool";
		String[] regionArray =
		{
			"NORTH AMERICA",
		};
