...
/**
 * <i>CorpCtrDetail</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment using
 * 	the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Corporate Center
 * 
...
public class CorpCtrDetail
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "CorpCtr";
		String[] regionArray =
		{
			"ASIA",
			"ASIA",
