...
/**
 * <i>PrimeFinanceDetail</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 * 	using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Prime Finance
 * 
 *     HIGH   - Fixed    Beta
 *     LOW    - Floating Beta
 *     
...
public class PrimeFinanceDetail
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Prime Finance";
		String[] regionArray =
		{
			"ASIA",
			"EMEA",
