...
/**
 * <i>OtherConsumerDetail</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 * 	using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Other Consumer
 * 
 *     HIGH   - Fixed    Beta
 *     LOW    - Floating Beta
 *     
...
public class OtherConsumerDetail
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Other_Consumer";
		String[] regionArray =
		{
			"LATIN AMERICA",
		};
