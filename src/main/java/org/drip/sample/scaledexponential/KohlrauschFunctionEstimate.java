...
/**
 * <i>KohlrauschFunctionEstimate</i> illustrates the Construction and Usage of the Kohlrausch Function. The
 * References are:
 * 
 * <br><br>
 * 	<ul>
...
public class KohlrauschFunctionEstimate
{
		...
		for (double beta : betaArray)
		{
			...
			for (double t : tArray)
			{
				display = display + " " + FormatUtil.FormatDouble (
					scaledExponentialEstimator.evaluate (t), 1, 8, 1., false
				) + " |";
			}
