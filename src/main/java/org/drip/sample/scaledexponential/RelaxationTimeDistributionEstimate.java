...
/**
 * <i>RelaxationTimeDistributionEstimate</i> illustrates the Series-based Estimate for the Relaxation Time
...
public class RelaxationTimeDistributionEstimate
{

	private static final void RelaxationTimeDensity (
		...
		throws Exception
	{
		...
		{
			RelaxationTimeDistributionEstimator relaxationTimeDistributionEstimator =
			...
			for (double t : tArray)
			{
				display = display + " " + FormatUtil.FormatDouble (
					relaxationTimeDistributionEstimator.relaxationTimeDensity (t), 1, 8, 1., false
				) + " |";
			}
		...
		throws Exception
	{
		...
		System.out.println ("\t|            - Density Estimate                                                                                                ||");
