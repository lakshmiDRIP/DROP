...
/**
 * <i>RatesCurrencyVegaMarginFlow24</i> illustrates the Steps in the Computation of the SIMM 2.4 IR Vega
...
public class RatesCurrencyVegaMarginFlow24
{
		...
		throws Exception
	{
		...
		BucketSensitivitySettingsIR bucketSensitivitySettingsIR = BucketVegaSettingsIR.ISDA_24 (currency);
