...
/**
 * <i>RatesCurrencyCurvatureMarginFlow20</i> illustrates the Steps in the Computation of the SIMM 2.0 IR
 * 	Curvature Margin for a Currency Bucket's IR Exposure Sensitivities. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
public class RatesCurrencyCurvatureMarginFlow20
{
		...
		throws Exception
	{
		...
		BucketCurvatureSettingsIR bucketCurvatureSettingsIR = BucketCurvatureSettingsIR.ISDA_20 (currency);
		...
		BucketAggregateIR bucketAggregateIR = bucketSensitivityIR.aggregate (bucketCurvatureSettingsIR);

		SensitivityAggregateIR irCurvatureAggregate =
			bucketAggregateIR.riskFactorAggregate().curvatureMargin (bucketCurvatureSettingsIR);

		CurvatureMarginCovarianceEntry (irCurvatureAggregate);
		...
		RiskMeasureAggregateIR riskMeasureAggregateIR = new RiskMeasureAggregateIR (
			...
			irCurvatureAggregate.cumulativeMarginCovariance(),
			0.
		);
