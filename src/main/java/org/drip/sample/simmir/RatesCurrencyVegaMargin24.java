...
/**
 * <i>RatesCurrencyVegaMargin24</i> illustrates the Computation of the SIMM 2.4 IR Vega Margin for a Currency
...
public class RatesCurrencyVegaMargin24
{
		...
		throws Exception
	{
		...
		RiskMeasureSensitivitySettingsIR riskMeasureSensitivitySettingsIR =
			RiskMeasureSensitivitySettingsIR.ISDA_VEGA_24 (currencyList);
