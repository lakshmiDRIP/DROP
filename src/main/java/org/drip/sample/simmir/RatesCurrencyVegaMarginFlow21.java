...
/**
 * <i>RatesCurrencyVegaMarginFlow21</i> illustrates the Steps in the Computation of the SIMM 2.1 IR Vega
...
public class RatesCurrencyVegaMarginFlow21
{
		...
		throws Exception
	{
		...
		BucketSensitivitySettingsIR bucketSensitivitySettingsIR = BucketVegaSettingsIR.ISDA_21 (currency);
