...
/**
 * <i>RatesCurrencyCurvatureMarginFlow21</i> illustrates the Steps in the Computation of the SIMM 2.1 IR
...
public class RatesCurrencyCurvatureMarginFlow21
{
		...
		throws Exception
	{
		...
		BucketCurvatureSettingsIR bucketCurvatureSettingsIR = BucketCurvatureSettingsIR.ISDA_21 (currency);
