...
/**
 * <i>ERFCChianiDardariSimon2012a</i> illustrates the Error Function Complement Estimation based on the
 * 	Chiani-Dardari-Simon (2012a) Bounded Analytical Error Function Complement Expression. The References are:
 * 
 * <br><br>
 * 	<ul>
 * 		<li>
...
public class ERFCChianiDardariSimon2012a
{
		...
		throws Exception
	{
		...
		System.out.println ("\t|                Chiani-Dardari-Simon (2012a) Bounded erfc Estimate                ||");
		...
		System.out.println ("\t|                - Chiani-Dardari-Simon Estimate                                   ||");

		System.out.println ("\t|                - Chiani-Dardari-Simon Lower Bound                                ||");

		System.out.println ("\t|                - Chiani-Dardari-Simon Upper Bound                                ||");

		System.out.println ("\t|                - Chiani-Dardari-Simon Error                                      ||");
		...
		for (Map.Entry<Double, BuiltInEntry> builtInTableEntry : builtInTable.entrySet())
		{
			...
			R1Estimate erfcEstimate = erfChianiDardariSimon2012a.boundedEstimate (x);

			double baseline = erfcEstimate.baseline();

			System.out.println (
				"\t| " + FormatUtil.FormatDouble (x, 1, 2, 1.) + " => " +
				FormatUtil.FormatDouble (erfcTable, 1, 9, 1.) + " | " +
				FormatUtil.FormatDouble (baseline, 1, 9, 1.) + " | [" +
				FormatUtil.FormatDouble (erfcEstimate.lowerBound(), 1, 9, 1.) + " -" +
				FormatUtil.FormatDouble (erfcEstimate.upperBound(), 1, 9, 1.) + " ]" +
				FormatUtil.FormatDouble (Math.abs (baseline - erfcTable), 1, 9, 1.) + " ||"
			);
		}
