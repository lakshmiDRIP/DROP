...
public class ERFCAsymptoticExpansion
{
		...
		throws Exception
	{
		...
		ErrorFunctionComplement erfAsymptoticExpansion =
			ErrorFunctionComplement.AsymptoticExpansion (termCount);

		System.out.println ("\t|-----------------------------------------------------||");

		System.out.println ("\t|          Asymptotic Expansion erfc Estimate         ||");
		...
		System.out.println ("\t|                - Asymptotic Expansion Estimate      ||");

		System.out.println ("\t|                - Asymptotic Expansion Error         ||");
		...
		for (Map.Entry<Double, BuiltInEntry> builtInTableEntry : builtInTable.entrySet())
		{
			...
			double erfcEstimate = erfAsymptoticExpansion.evaluate (x);
