...
public class GaussSecondSummationProperty
{

	private static final void Verifier (
		final double a,
		final double b,
		final R2ToR1Property gaussSecondSummationProperty)
		throws Exception
	{
		R1PropertyVerification propertyVerification = gaussSecondSummationProperty.verify (
			a,
			b
		);
		...
		throws Exception
	{
		...
		R2ToR1Property gaussSecondSummationProperty =
			HypergeometricEqualityLemma.GaussSecondSummationZPlusHalf();

		System.out.println ("\t|------------------------------------------------------||");

		System.out.println ("\t|       GAUSS SECOND SUMMATION PROPERTY VERIFIER       ||");
