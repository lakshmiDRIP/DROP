...
public class GaussDougallProperty
{
	...
	private static final void Verifier (
		...
		final double b,
		final double c,
		final R3ToR1Property gaussDougallProperty)
		throws Exception
	{
		R1PropertyVerification propertyVerification = gaussDougallProperty.verify (
			m,
			b,
			c
		);
		...
		System.out.println (
			"\t| {" + FormatUtil.FormatDouble (m, 1, 2, 1., false) + ", " +
		...
		throws Exception
	{
		...
		R3ToR1Property gaussDougallProperty = HypergeometricEqualityLemma.GaussDougallZPlusOne();

		System.out.println ("\t|------------------------------------------------------------||");

		System.out.println ("\t|              GAUSS DOUGALL PROPERTY VERIFIER               ||");
