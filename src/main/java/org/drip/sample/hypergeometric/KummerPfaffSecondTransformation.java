...
/**
 * <i>KummerPfaffSecondTransformation</i> reconciles the Hyper-geometric Function Estimates using the Euler
 * 	Integral Representation against Second Pfaff Transformation. The References are:
 * 
 * <br><br>
 * 	<ul>
 * 		<li>
...
public class KummerPfaffSecondTransformation
{
		...
		throws Exception
	{
		...
		RegularHypergeometricEstimator regularHypergeometricEstimatorPfaffSecondTransform =
		...
		for (double z : zArray)
		{
			System.out.println ("\t| {a=" +
				...
				FormatUtil.FormatDouble (regularHypergeometricEstimatorPfaffSecondTransform.evaluate (z), 2, 10, 1., false) + " ||"
			);
		}
	}
		...
		throws Exception
	{
		...
		System.out.println ("\t|       HYPER-GEOMETRIC KUMMER SECOND PFAFF TRANSFORM RECONCILE      ||");
