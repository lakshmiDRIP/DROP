...
public class InverseSineProperty
{

	private static final void Verifier (
		final double[] zArray,
		final R1ToR1Property inverseSineProperty)
		throws Exception
	{
		System.out.println ("\t|----------------------------------------------||");

		System.out.println ("\t| arcsin (z) = 2F1 (0.5, 0.5; 1.5; z * z) CASE ||");
		...
		for (double z : zArray)
		{
			R1PropertyVerification propertyVerification = inverseSineProperty.verify (z);
		...
		throws Exception
	{
		...
		Verifier (
			zArray,
			HypergeometricEqualityLemma.InverseSine()
		);
