...
public class GaussVanderMondeProperty
{
	...
	private static final void Verifier (
		...
		final double b,
		final double c,
		final R3ToR1Property gaussVanderMondeProperty)
		throws Exception
	{
		R1PropertyVerification propertyVerification = gaussVanderMondeProperty.verify (
			a,
			b,
			c
		);
		...
		throws Exception
	{
		...
		R3ToR1Property gaussVanderMondeProperty = HypergeometricEqualityLemma.GaussVanderMondeZPlusOne();

		System.out.println ("\t|------------------------------------------------------------||");

		System.out.println ("\t|           GAUSS VAN DER MONDE PROPERTY VERIFIER            ||");
