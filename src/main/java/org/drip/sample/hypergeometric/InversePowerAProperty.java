...
public class InversePowerAProperty
{
		...
		throws Exception
	{
		...
		System.out.println ("\t|   (1. - z) ^ a = 2F1 (a, 1.0; 1.0; z) CASE   ||");
		...
		for (double z : zArray)
		{
			R1PropertyVerification propertyVerification = inversePowerAProperty.verify (z);
		...
		throws Exception
	{
		...
		Verifier (
			zArray,
			HypergeometricEqualityLemma.InversePowerA (1.)
		);
