...
public class GesselStantonKoepfProperty1
{
		...
		throws Exception
	{
		...
		R2ToR1Property gesselStantonKoepfProperty = HypergeometricEqualityLemma.FirstGesselStantonKoepf();

		System.out.println ("\t|------------------------------------------------------||");

		System.out.println ("\t|     FIRST GESSEL STANTON KOEPF PROPERTY VERIFIER     ||");
