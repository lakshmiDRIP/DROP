...
/**
 * <i>IRCrossCurvePrincipal</i> demonstrates the Computation of the Cross IR Curve Principal Component
 * 	Co-variance using the IR Curve Tenor Principal Component. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
public class IRCrossCurvePrincipal
{

	private static final void PrintCurvePrincipalCovariance (
		...
		throws Exception
	{
		...
		System.out.println
			("\t||                                                   UNADJUSTED CURVE PRINCIPAL COVARIANCE                                                     |");
		...
		NumberUtil.PrintMatrix (
			"\t|| " + displayLabel,
			riskGroupPrincipalCovariance.unadjustedCovariance()
		);
		...
		throws Exception
	{
		...
		String currency3 = "CNY";

		PrintCurvePrincipalCovariance (
			"2.0",
			currency1 + "_" + currency2,
			IRSettingsContainer20.CurrencyPairPrincipalCovariance (
				currency1,
				currency2
			)
		);
		...
		PrintCurvePrincipalCovariance (
			"2.1",
			currency1 + "_" + currency2,
			IRSettingsContainer21.CurrencyPairPrincipalCovariance (
				currency1,
				currency2
			)
		);
