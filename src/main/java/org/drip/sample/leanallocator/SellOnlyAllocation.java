...
/**
 * <i>SellOnlyAllocation</i> generates an Optimal Sell-Only Portfolio from the Initial Holdings.
 *
 *	<br><br>
 *  <ul>
...
public class SellOnlyAllocation
{
		...
		throws Exception
	{
		...
		FullSequenceAllocator fullSequenceAllocator = new FullSequenceAllocator (
			...
			PostProcessorSettings.SellOnly(),
			true
		);
