...
/**
 * <i>BinomialHeapMinRandomExtract</i> illustrates the Extract Min Operation into a Min Binomial Heap. The
 * 	References are:
 * 
 * <br><br>
 *  <ul>
...
public class BinomialHeapMinRandomExtract
{
		...
		throws Exception
	{
		...
		System.out.println ("\t| After Inserting " + randomCount + " Items");
