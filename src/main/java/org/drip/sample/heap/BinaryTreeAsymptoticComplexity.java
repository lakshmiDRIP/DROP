...
import org.drip.graph.heap.BinaryTreeAsymptote;
...
/**
 * <i>BinaryTreeAsymptoticComplexity</i> illustrates the Asymptotics of the Priority Queue Time Complexity
 * 	for Binary Heap Based Implementations. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
public class BinaryTreeAsymptoticComplexity
{
		...
		throws Exception
	{
		...
		System.out.println (
			"\t|   BINARY TREE ASYMPTOTIC COMPLEXITY ESTIMATOR    ||"
		);
		...
		{
			BinaryTreeAsymptote binaryTreeAsymptote = new BinaryTreeAsymptote (
				number
			);
			...
			System.out.println (
				...
				FormatUtil.FormatDouble (
					binaryTreeAsymptote.averageCaseComplexity(), 2, 6, 1.
				) + " | " +
				FormatUtil.FormatDouble (
					binaryTreeAsymptote.worstCaseComplexity(), 2, 6, 1.
				) + " ||"
			);
		}
