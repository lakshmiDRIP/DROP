...
/**
 * <i>BinomialHeapMinSequentialDelete</i> illustrates the Sequential Deletion Operation into a Min Binomial
...
public class BinomialHeapMinSequentialDelete
{
		...
		throws Exception
	{
			...
			++sequenceIndex)
		{
			...
			System.out.println ("\t| After removing " + sequenceIndex);
