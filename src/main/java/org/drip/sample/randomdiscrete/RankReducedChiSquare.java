...
/**
 * <i>RankReducedChiSquare</i> demonstrates Generation of Rank-Reduced Chi-Squared R<sup>1</sup> Random 
...
public class RankReducedChiSquare
{
	...
	private static final void DisplayStream (
		...
		throws Exception
	{
		double[] randomArray = RandomSequenceGenerator.RankReducedChiSquare (
			200,
			covarianceMatrix
		);
		...
		throws Exception
	{
		...
		DisplayStream (covarianceMatrix);
