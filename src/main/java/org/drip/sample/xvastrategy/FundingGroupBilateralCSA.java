...
/**
 * <i>FundingGroupBilateralCSA</i> demonstrates the Simulation Run of the Funding Group Exposure using the
...
public class FundingGroupBilateralCSA {
		...
		throws Exception
	{
		...
		for (int i = 0; i <= iNumStep; ++i)
		{
			...
			if (0 != i) {
				aBKV1[i] = BurgardKjaerBuilder.GoldPlatedTwoWayCSA (
					adtVertex[i],
				...
				aBKV2[i] = BurgardKjaerBuilder.GoldPlatedTwoWayCSA (
					adtVertex[i],
