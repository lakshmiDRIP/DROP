...
/**
 * <i>FundingGroupSemiReplication</i> demonstrates the Simulation Run of the Funding Group Exposure using the
 * 	"Semi Replication" Funding Strategy laid out in Burgard and Kjaer (2013). The References are:
 *
 *  <br><br>
 *  <ul>
 *  	<li>
...
public class FundingGroupSemiReplication {
		...
		throws Exception
	{
		...
		for (int i = 0; i <= iNumStep; ++i)
		{
			...
			if (0 != i) {
				aBKV1[i] = BurgardKjaerBuilder.SemiReplicationDualBond (
					adtVertex[i],
				...
				aBKV2[i] = BurgardKjaerBuilder.SemiReplicationDualBond (
					adtVertex[i],
