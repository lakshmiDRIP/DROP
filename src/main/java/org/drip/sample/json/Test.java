...
public class Test {
    ...
    @SuppressWarnings ("rawtypes") private static final void testDecode() throws Exception{
    ...
    @SuppressWarnings ({"rawtypes", "unchecked"}) private static final void testEncode() throws Exception{
