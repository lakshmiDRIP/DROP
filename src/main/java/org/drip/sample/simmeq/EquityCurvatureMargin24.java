...
/**
 * <i>EquityCurvatureMargin24</i> illustrates the Computation of the SIMM 2.4 Curvature Margin for a Group of
...
public class EquityCurvatureMargin24
{
		...
		throws Exception
	{
		...
		RiskMeasureSensitivitySettings riskMeasureSensitivitySettings =
			RiskMeasureSensitivitySettings.ISDA_EQ_CURVATURE_24 (vegaDurationDays);
