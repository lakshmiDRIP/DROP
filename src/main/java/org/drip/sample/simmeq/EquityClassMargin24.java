...
/**
 * <i>EquityClassMargin24</i> illustrates the Computation of the ISDA 2.4 Aggregate Margin for across a Group
...
public class EquityClassMargin24
{
		...
		throws Exception
	{
		...
		RiskClassSensitivitySettings riskClassSensitivitySettings = RiskClassSensitivitySettings.ISDA_EQ_24
			(vegaDurationDays);
