...
/**
 * <i>RealEstateLendingBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed
 * 	Segment using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Real Estate Lending
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class RealEstateLendingBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Real Estate Lending";
		String[] regionArray =
		{
			"NORTH AMERICA",
		};
