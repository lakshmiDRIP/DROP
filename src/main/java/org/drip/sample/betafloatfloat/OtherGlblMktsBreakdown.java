...
/**
 * <i>OtherGlblMktsBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed
 * 	Segment using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Other Global Markets
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class OtherGlblMktsBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Other Glbl Mkts";
		String[] regionArray =
		{
			"EMEA",
			"EMEA",
