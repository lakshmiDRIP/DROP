...
/**
 * <i>LoanPortfolioManagementBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified
 * 	Managed Segment using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Loan Portfolio Management
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class LoanPortfolioManagementBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Loan Portfolio Management";
		String[] regionArray =
		{
			"EMEA",
			"NORTH AMERICA",
