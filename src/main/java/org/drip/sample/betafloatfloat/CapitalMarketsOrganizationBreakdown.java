...
/**
 * <i>CapitalMarketsOrganizationBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified
 * 	Managed Segment using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Capital Markets Organization
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class CapitalMarketsOrganizationBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Capital Markets Organization";
		String[] regionArray =
		{
			"NORTH AMERICA",
		};
