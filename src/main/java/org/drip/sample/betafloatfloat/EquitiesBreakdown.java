...
/**
 * <i>EquitiesBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 * 	using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Equities
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class EquitiesBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Equities";
		String[] regionArray =
		{
			"NORTH AMERICA",
		};
