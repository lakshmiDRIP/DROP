...
/**
 * <i>OtherFIUndwrtngBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed
 * 	Segment using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Other FI Under-writing
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class OtherFIUndwrtngBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Other FI Undwrtng";
		String[] regionArray =
		{
			"NORTH AMERICA",
		};
