...
/**
 * <i>MunisBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 * 	using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Munis
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class MunisBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Munis";
		String[] regionArray =
		{
			"EMEA",
			"NORTH AMERICA",
