...
/**
 * <i>LongTermAssetGroupBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed
 * 	Segment using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Long Term Asset Group
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class LongTermAssetGroupBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Long Term Asset Group";
		String[] regionArray =
		{
			"EMEA",
			"NORTH AMERICA",
