...
/**
 * <i>LocalMktsBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 * 	using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Local Markets
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class LocalMktsBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Local Mkts";
		String[] regionArray =
		{
			"ASIA",
			"ASIA",
