...
/**
 * <i>EquityDerivativeBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed
 * 	Segment using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Equity Derivative
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class EquityDerivativeBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Equity Derivative";
		String[] regionArray =
		{
			"ASIA",
			"ASIA",
