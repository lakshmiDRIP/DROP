...
/**
 * <i>PrimericaFinancialServicesBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified
 * 	Managed Segment using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Primerica Financial Services
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class PrimericaFinancialServicesBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Primerica Financial Services";
		String[] regionArray =
		{
			"NORTH AMERICA",
		};
