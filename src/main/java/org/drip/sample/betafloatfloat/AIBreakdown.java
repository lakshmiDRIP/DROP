...
/**
 * <i>AIBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment using
 * 	the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - AI
 * 
...
public class AIBreakdown
{
		...
		throws Exception
	{
		...
		double allocatedBetaCapital = entityComponentCapitalAssignment.allocatedBetaCapital();
		...
		System.out.println (
			...
			FormatUtil.FormatDouble (entityComponentCapitalAssignment.allocatedBetaCapital(), 10, 2, 1.) +
			" <= TOTAL"
		);
