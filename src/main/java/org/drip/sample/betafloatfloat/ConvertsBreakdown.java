...
/**
 * <i>ConvertsBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 * 	using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Converts
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class ConvertsBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Converts";
		String[] regionArray =
		{
			"ASIA",
			"EMEA",
