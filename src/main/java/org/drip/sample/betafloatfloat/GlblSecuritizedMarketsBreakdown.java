...
/**
 * <i>GlblSecuritizedMarketsBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified
 * 	Managed Segment using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Global Securitized Markets
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class GlblSecuritizedMarketsBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Glbl Securitized Markets";
		String[] regionArray =
		{
			"NORTH AMERICA",
			"NORTH AMERICA",
