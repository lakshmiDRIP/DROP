...
/**
 * <i>G10RatesBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 * 	using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - G10 Rates
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class G10RatesBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "G10 RATES";
		String[] regionArray =
		{
			"ASIA",
			"ASIA",
