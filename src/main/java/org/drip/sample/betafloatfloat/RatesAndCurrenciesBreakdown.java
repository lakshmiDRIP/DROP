...
/**
 * <i>RatesAndCurrenciesBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed
 * 	Segment using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Rates And Currencies
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class RatesAndCurrenciesBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Rates and Currencies";
		String[] regionArray =
		{
			"NORTH AMERICA",
		};
