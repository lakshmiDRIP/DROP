...
/**
 * <i>OtherBAMBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 * 	using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Other BAM
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class OtherBAMBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Other_BAM";
		String[] regionArray =
		{
			"NORTH AMERICA",
		};
