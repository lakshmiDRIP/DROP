...
/**
 * <i>IGBondsBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 * 	using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - IG Bonds
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class IGBondsBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "IG Bonds";
		String[] regionArray =
		{
			"EMEA",
			"NORTH AMERICA",
