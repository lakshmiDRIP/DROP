...
/**
 * <i>RetailBankingBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed
 * 	Segment using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Retail Banking
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class RetailBankingBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Retail Banking";
		String[] regionArray =
		{
			"ASIA",
			"ASIA",
