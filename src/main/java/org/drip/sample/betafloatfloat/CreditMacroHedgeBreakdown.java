...
/**
 * <i>CreditMacroHedgeBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed
 * 	Segment using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Credit Macro Hedge
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class CreditMacroHedgeBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Credit Macro Hedge";
		String[] regionArray =
		{
			"NORTH AMERICA",
		};
