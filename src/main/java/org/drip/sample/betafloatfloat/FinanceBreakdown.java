...
/**
 * <i>FinanceBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 * 	using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Finance
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class FinanceBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Finance";
		String[] regionArray =
		{
			"ASIA",
			"EMEA",
