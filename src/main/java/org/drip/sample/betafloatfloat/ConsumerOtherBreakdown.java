...
/**
 * <i>ConsumerOtherBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed
...
public class ConsumerOtherBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Consumer_Other";
		String[] regionArray =
		{
			"ASIA",
		};
