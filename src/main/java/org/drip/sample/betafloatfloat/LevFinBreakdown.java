...
/**
 * <i>LevFinBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 * 	using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Leveraged Finance
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class LevFinBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Lev Fin";
		String[] regionArray =
		{
			"EMEA",
			"LATIN AMERICA",
