...
/**
 * <i>DistressedBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 * 	using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Distressed
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class DistressedBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Distressed";
		String[] regionArray =
		{
			"NORTH AMERICA",
		};
