...
/**
 * <i>ProjectFinanceBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed
 * Segment using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Project Finance
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class ProjectFinanceBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Project Finance";
		String[] regionArray =
		{
			"NORTH AMERICA",
			"NORTH AMERICA",
