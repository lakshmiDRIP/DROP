...
/**
 * <i>ShortTermBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed Segment
 * 	using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - Short Term
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class ShortTermBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "Short Term";
		String[] regionArray =
		{
			"EMEA",
			"NORTH AMERICA",
