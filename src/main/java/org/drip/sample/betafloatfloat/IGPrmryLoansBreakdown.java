...
/**
 * <i>IGPrmryLoansBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified Managed
 * 	Segment using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - IG Primary Loans
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class IGPrmryLoansBreakdown
{
