...
/**
 * <i>InternationalRetailBankingBreakdown</i> zeds the Managed Sub-segment Level Allocation for the Specified
 * 	Managed Segment using the Two Beta Scheme.
 * 
 *     MANAGED SEGMENT  - International Retail Banking
 * 
 *     HIGH   - Floating Beta
 *     LOW    - Floating Beta
 *     
...
public class InternationalRetailBankingBreakdown
{
		...
		throws Exception
	{
		...
		String capitalSegmentFQN = "International Retail Banking";
		String[] regionArray =
		{
			"EMEA",
		};
