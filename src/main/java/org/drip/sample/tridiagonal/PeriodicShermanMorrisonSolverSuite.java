...
/**
 * <i>PeriodicShermanMorrisonSolverSuite</i> tests the Application of the Sherman-Morrison Solver for a
...
public class PeriodicShermanMorrisonSolverSuite
{
		...
		throws Exception
	{
		...
		double[] rhsArray = Matrix.Product (periodicTridiagonalMatrix, xArray);
