...
/**
 * <i>FixFloatClient</i> demonstrates the Invocation and Examination of the JSON-based Fix Float Valuation
 * 	Service Client.
 * 
 * <br><br>
 *  <ul>
...
public class FixFloatClient {
		...
		throws Exception
	{
		...
		jsonParameters.put ("FixFloatMaturity", "05Y");

		jsonParameters.put ("FixFloatCoupon", 0.0206);
