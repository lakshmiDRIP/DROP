...
/**
 * <i>DepositClient</i> demonstrates the Invocation and Examination of the JSON-based Deposit Valuation
 * 	Service Client.
 * 
 * <br><br>
 *  <ul>
...
public class DepositClient {
		...
		throws Exception
	{
		...
		jsonParameters.put ("DepositMaturity", "06Y");
		...
		jsonRequest.put ("API", "DEPOSIT::CURVEMETRICS");
