...
public class WindschitlTothGammaEstimate
{
		...
		throws Exception
	{
		...
		System.out.println ("\t|             WINDSCHITL-TOTH GAMMA APPROXIMATION            ||");
		...
		for (int factorialIndex = 1; factorialIndex <= factorialCount; ++factorialIndex)
		{
			System.out.println (
				...
				FormatUtil.FormatDouble (windschitlTothGamma.evaluate (factorialIndex), 1, 0, 1.) + " ||"
			);
		}
