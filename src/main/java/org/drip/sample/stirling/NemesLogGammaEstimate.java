...
import org.drip.gamma.log.NemesAnalyticEstimator;
...
/**
 * <i>NemesLogGammaEstimate</i> illustrates the Nemes Approximation of the Log Gamma Function. The References
 * are:
 * 
 * <br><br>
 * 	<ul>
...
public class NemesLogGammaEstimate
{
		...
		throws Exception
	{
		...
		NemesAnalyticEstimator nemesLogGamma = new NemesAnalyticEstimator (null);

		System.out.println ("\t|------------------------------------------------------------||");

		System.out.println ("\t|                NEMES LOG GAMMA APPROXIMATION               ||");
		...
		System.out.println ("\t|              - Nemes Estimate                              ||");
		...
		for (int factorialIndex = 1; factorialIndex <= factorialCount; ++factorialIndex)
		{
			System.out.println (
				...
				FormatUtil.FormatDouble (nemesLogGamma.evaluate (factorialIndex), 2, 6, 1.) + " ||"
			);
		}
