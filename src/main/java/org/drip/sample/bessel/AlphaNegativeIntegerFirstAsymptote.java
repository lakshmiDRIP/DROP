...
public class AlphaNegativeIntegerFirstAsymptote
{
		...
		throws Exception
	{
		...
		System.out.println ("\t|         BESSEL FIRST KIND NEGATIVE ALPHA INTEGER ASYMPTOTE         ||");
		...
		throws Exception
	{
		...
		BesselJ (
			BesselFirstKindEstimator.AlphaNegativeIntegerAsymptote (
