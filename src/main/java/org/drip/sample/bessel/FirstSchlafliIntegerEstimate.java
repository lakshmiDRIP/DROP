...
/**
 * <i>FirstSchlafliIntegerEstimate</i> illustrates the Schlafli Integral Based Estimation for the Cylindrical
 * Bessel Function of the First Kind for Integer Orders. The References are:
 * 
 * <br><br>
 * 	<ul>
 * 		<li>
...
public class FirstSchlafliIntegerEstimate
{
		...
		throws Exception
	{
		...
		System.out.println ("\t|           BESSEL FIRST KIND SCHLAFLI INTEGER FORM ESTIMATE           ||");
