...
/**
 * <i>SchlafliNonIntegerEstimate</i> illustrates the Schlafli Integral Based Estimation for the Cylindrical
 * Bessel Function of the First Kind for Non-Integer Orders. The References are:
 * 
 * <br><br>
 * 	<ul>
 * 		<li>
...
public class SchlafliNonIntegerEstimate
{
		...
		throws Exception
	{
		...
		System.out.println ("\t|         BESSEL FIRST KIND SCHLAFLI NON-INTEGER FORM ESTIMATE         ||");
		...
		throws Exception
	{
		...
		{
			BesselJ (
				FirstSchlafliIntegralEstimator.NonIntegerForm (quadratureCount),
				quadratureCount,
				zArray,
				alphaArray
			);
