...
/**
 * <i>ModifiedSecondTwoThirdOrder</i> implements the Integral Estimator for the 2. / 3. Order Modified Bessel
...
public class ModifiedSecondTwoThirdOrder
{
		...
		throws Exception
	{
		...
		System.out.println ("\t|      TWO-THIRD ORDER MODIFIED BESSEL SECOND KIND INTEGRAL ESTIMATE       ||");
		...
		throws Exception
	{
		...
		{
			BesselK (
				ModifiedSecondIntegralEstimator.TwoThirdOrder (quadratureCount),
				quadratureCount,
				zArray
			);
		}
