...
/**
 * <i>BesselSecondWatsonEstimate</i> illustrates the Watson Integral Based Estimation for the Cylindrical
 * Bessel Function of the Second Kind for Integer Orders. The References are:
 * 
 * <br><br>
 * 	<ul>
 * 		<li>
...
public class BesselSecondWatsonEstimate
{
		...
		throws Exception
	{
		...
		System.out.println ("\t|           BESSEL SECOND KIND WATSON INTEGER FORM ESTIMATE            ||");
