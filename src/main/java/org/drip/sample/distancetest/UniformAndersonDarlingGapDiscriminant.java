...
/**
 * <i>UniformAndersonDarlingGapDiscriminant</i> demonstrates the Generation of the Sample Distance
...
public class UniformAndersonDarlingGapDiscriminant
{
	...
	private static final double UnivariateRandom (
		...
		throws Exception
	{
		return new R1ContinuousUniform (
			leftSupport,
			rightSupport
		).random();
	}
