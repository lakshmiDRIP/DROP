...
/**
 * <i>CreditNonQualifyingBucketVegaMarginFlow21</i> illustrates the Steps in the Computation of the SIMM 2.1
 * 	Credit Non-Qualifying Vega Margin for a single CR Bucket's Exposure Sensitivities. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
public class CreditNonQualifyingBucketVegaMarginFlow21
{
		...
		throws Exception
	{
		...
		BucketSensitivitySettingsCR bucketSensitivitySettingsCR = BucketVegaSettingsCR.ISDA_CRNQ_21
			(bucketIndex);
