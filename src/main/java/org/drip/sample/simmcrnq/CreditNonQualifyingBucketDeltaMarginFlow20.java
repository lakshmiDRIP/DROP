...
/**
 * <i>CreditNonQualifyingBucketDeltaMarginFlow20</i> illustrates the Steps in the Computation of the SIMM 2.0
 * 	Credit Non-Qualifying Delta Margin for a single CR Bucket's Exposure Sensitivities. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
public class CreditNonQualifyingBucketDeltaMarginFlow20
{
		...
		throws Exception
	{
		...
		BucketSensitivitySettingsCR bucketSensitivitySettingsCR =
			BucketSensitivitySettingsCR.ISDA_CRNQ_DELTA_20 (bucketIndex);
