...
/**
 * <i>CreditNonQualifyingBucketVegaMarginFlow24</i> illustrates the Steps in the Computation of the SIMM 2.4
...
public class CreditNonQualifyingBucketVegaMarginFlow24
{
		...
		throws Exception
	{
		...
		BucketSensitivitySettingsCR bucketSensitivitySettingsCR = BucketVegaSettingsCR.ISDA_CRNQ_24
			(bucketIndex);
