...
/**
 * <i>CreditQualifyingBucketVegaMarginFlow24</i> illustrates the Steps in the Computation of the SIMM 2.4
...
public class CreditQualifyingBucketVegaMarginFlow24
{
		...
		throws Exception
	{
		...
		BucketSensitivitySettingsCR bucketSensitivitySettingsCR = BucketVegaSettingsCR.ISDA_CRQ_24
			(bucketIndex);
