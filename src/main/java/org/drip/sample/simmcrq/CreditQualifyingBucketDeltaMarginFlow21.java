...
/**
 * <i>CreditQualifyingBucketDeltaMarginFlow21</i> illustrates the Steps in the Computation of the SIMM 2.1
...
public class CreditQualifyingBucketDeltaMarginFlow21
{
		...
		throws Exception
	{
		...
		BucketSensitivitySettingsCR bucketSensitivitySettingsCR =
			BucketSensitivitySettingsCR.ISDA_CRQ_DELTA_21 (bucketIndex);
