...
/**
 * <i>CreditQualifyingBucketVegaMarginFlow20</i> illustrates the Steps in the Computation of the SIMM 2.0
 * 	Credit Qualifying Vega Margin for a single CR Bucket's Exposure Sensitivities. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
public class CreditQualifyingBucketVegaMarginFlow20
{
		...
		throws Exception
	{
		...
		BucketSensitivitySettingsCR bucketSensitivitySettingsCR = BucketVegaSettingsCR.ISDA_CRQ_20
			(bucketIndex);
