...
/**
 * <i>CreditQualifyingBucketVegaMarginFlow21</i> illustrates the Steps in the Computation of the SIMM 2.1
...
public class CreditQualifyingBucketVegaMarginFlow21
{
		...
		throws Exception
	{
		...
		BucketSensitivitySettingsCR bucketSensitivitySettingsCR = BucketVegaSettingsCR.ISDA_CRQ_21
			(bucketIndex);
