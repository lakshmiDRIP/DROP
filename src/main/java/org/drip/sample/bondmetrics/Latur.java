...
public class Latur {
		...
		throws Exception
	{
		...
		int iSettleLag = 3;
		int iCouponFreq = 2;
		String strName = "Latur";
		double dblCleanPrice = 1.09375;
		double dblIssuePrice = 1.0;
		String strCurrency = "USD";
		double dblSpreadBump = 20.;
		double dblCouponRate = 0.10000;
		...
		SetEOS (
			...
			EmbeddedOptionSchedule.FromAmerican (
				dtSpot.julian(),
				new int[] {
					DateUtil.CreateFromYMD (2018, 01, 15).julian(),
					DateUtil.CreateFromYMD (2019, 01, 15).julian(),
					DateUtil.CreateFromYMD (2020, 01, 15).julian(),
					DateUtil.CreateFromYMD (2021, 01, 15).julian(),
					DateUtil.CreateFromYMD (2022, 01, 15).julian(),
				},
				new double[] {
					1.07500,
					1.05000,
