		...
		throws Exception
	{
		...
		SetEOS (
			...
			EmbeddedOptionSchedule.FromAmerican (
				dtSpot.julian(),
				new int[] {
					DateUtil.CreateFromYMD (2016, 05, 15).julian(),
					DateUtil.CreateFromYMD (2017, 05, 15).julian(),
					DateUtil.CreateFromYMD (2018, 05, 15).julian(),
					DateUtil.CreateFromYMD (2019, 05, 15).julian(),
					DateUtil.CreateFromYMD (2020, 05, 15).julian(),
					DateUtil.CreateFromYMD (2021, 05, 15).julian(),
				},
				new double[] {
					1.03469,
					1.02313,
