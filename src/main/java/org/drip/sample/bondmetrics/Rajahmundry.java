...
public class Rajahmundry {
		...
		throws Exception
	{
		...
		int iSettleLag = 3;
		int iCouponFreq = 2;
		String strName = "Rajahmundry";
		double dblCleanPrice = 0.97;
		double dblIssuePrice = 1.0;
		String strCurrency = "USD";
		double dblSpreadBump = 20.;
		double dblCouponRate = 0.07750;
		...
		SetEOS (
			...
			new EmbeddedOptionSchedule (
				new int[] {
					DateUtil.CreateFromYMD (2020, 06, 15).julian(),
					DateUtil.CreateFromYMD (2021, 06, 15).julian(),
					DateUtil.CreateFromYMD (2022, 06, 15).julian(),
					DateUtil.CreateFromYMD (2023, 06, 15).julian(),
				},
				new double[] {
					1.03875,
					1.01938,
