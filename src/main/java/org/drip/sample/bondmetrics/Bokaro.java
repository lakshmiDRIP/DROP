...
public class Bokaro {
		...
		throws Exception
	{
		...
		int iSettleLag = 3;
		int iCouponFreq = 2;
		String strName = "Bokaro";
		double dblCleanPrice = 0.995;
		double dblIssuePrice = 1.0;
		String strCurrency = "USD";
		double dblSpreadBump = 20.;
		double dblCouponRate = 0.09000;
		...
		SetEOS (
			...
			new EmbeddedOptionSchedule (
				new int[] {
					DateUtil.CreateFromYMD (2019,  3, 31).julian(),
					DateUtil.CreateFromYMD (2019,  9, 30).julian(),
					DateUtil.CreateFromYMD (2020,  3, 31).julian(),
					DateUtil.CreateFromYMD (2020,  9, 30).julian(),
				},
				new double[] {
					1.0900,
					1.0450,
