...
/**
 * <i>QQTest2</i> compares the Order Statistics between 2 Similar Normal Distributions using the Filliben
...
public class QQTest2
{
		...
		throws Exception
	{
		...
		PlottingPositionGeneratorFilliben plottingPositionGenerator = new
			PlottingPositionGeneratorFilliben (orderStatisticCount);
