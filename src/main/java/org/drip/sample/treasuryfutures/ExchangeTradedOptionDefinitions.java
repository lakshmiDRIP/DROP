...
/**
 * <i>ExchangeTradedOptionDefinitions</i> contains all the pre-fixed Definitions of Exchange-traded Options
...
public class ExchangeTradedOptionDefinitions {
		...
		String strContractName)
	{
		...
		System.out.println (
			TreasuryFuturesOptionContainer.FromContract (
				strContractName
			)
		);
	}
