...
/**
 * <i>OTCPayerCSAClassicalPlus</i> displays the MPoR-related XVA Metrics Suite for the given OTC Payer Swap
 * 	on a Daily Grid using the "Classical+" CSA Timeline of Andersen, Pykhtin, and Sokol (2017). The
 * 	References are:
 *  
 * <br><br>
 *  <ul>
...
public class OTCPayerCSAClassicalPlus
{
