...
public class MultiCurveFRAStandardAnalysis {
		...
		throws Exception
	{
		...
		System.out.println ("\t[" +
			...
			org.drip.service.common.FormatUtil.FormatDouble (mapFRAOutput.get ("ParForward"), 1, 4, 100.) + "% |" +
			org.drip.service.common.FormatUtil.FormatDouble (mapFRAOutput.get ("QuantoAdjustedParForward"), 1, 4, 100.) + "% |" +
			org.drip.service.common.FormatUtil.FormatDouble (mapFRAOutput.get ("MultiplicativeQuantoAdjustment"), 1, 4, 1.) + " | " +
			org.drip.service.common.FormatUtil.FormatDouble (mapFRAOutput.get ("AdditiveQuantoAdjustment"), 1, 1, 10000.));
	}
