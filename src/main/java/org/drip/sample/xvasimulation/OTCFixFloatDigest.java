...
/**
 * OTCFixFloatDigest simulates for various Latent States and Exposures for an OTC Fix Float Swap and computes
 * 	the XVA Metrics. The References are:
 *  
...
public class OTCFixFloatDigest
{
		...
		throws Exception
	{
		...
		System.out.println (fixFloatGroupSettings + " | " + fixFloatEvolutionControl);
