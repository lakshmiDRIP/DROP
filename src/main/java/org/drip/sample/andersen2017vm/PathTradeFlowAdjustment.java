...
import org.drip.exposure.regressiontrade.PathCoordinator;
...
public class PathTradeFlowAdjustment
{
		...
		throws Exception
	{
		...
		PathCoordinator pathCoordinator = new PathCoordinator (
			fixFloatMPoR,
			marketPath
		);
			...
			variationMarginEstimateVertexTrajectory.entrySet())
		{
			...
			System.out.println ("\t|| " +
				...
				FormatUtil.FormatDouble (variationMarginEstimateVertex.unadjusted(), 5, 0, 1.) + " | " +
				FormatUtil.FormatDouble (variationMarginEstimateVertex.adjusted(), 5, 0, 1.) + " ||"
			);
		}
