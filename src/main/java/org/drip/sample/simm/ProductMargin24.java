...
/**
 * <i>ProductMargin24</i> illustrates the Computation of the ISDA SIMM 2.4 Product Margin for across a Group
...
public class ProductMargin24
{
		...
		throws Exception
	{
		...
		{
			String categoryIndexKey = "" + FXRiskThresholdContainer24.CurrencyCategory (
				currency
				);
