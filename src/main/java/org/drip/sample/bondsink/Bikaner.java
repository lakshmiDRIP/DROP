...
public class Bikaner {
		...
		throws Exception
	{
		...
		BondComponent bond = BondBuilder.CreateSimpleFixed (
			...
			Array2D.FromArray (
				new int[] {
					DateUtil.CreateFromYMD (2017,  3, 22).julian(),
					DateUtil.CreateFromYMD (2017,  9, 22).julian(),
					DateUtil.CreateFromYMD (2018,  3, 22).julian(),
					DateUtil.CreateFromYMD (2018,  9, 22).julian(),
					DateUtil.CreateFromYMD (2019,  3, 22).julian(),
					DateUtil.CreateFromYMD (2019,  9, 22).julian(),
					DateUtil.CreateFromYMD (2020,  3, 22).julian(),
					DateUtil.CreateFromYMD (2020,  9, 22).julian(),
					DateUtil.CreateFromYMD (2021,  3, 22).julian(),
					DateUtil.CreateFromYMD (2021,  9, 22).julian(),
					DateUtil.CreateFromYMD (2022,  3, 22).julian(),
					DateUtil.CreateFromYMD (2022,  9, 22).julian(),
				},
				new double[] {
					0.887144535,
					0.847083494,
