...
public class Cuttack {
		...
		throws Exception
	{
		...
		BondComponent bond = BondBuilder.CreateSimpleFixed (
			...
			Array2D.FromArray (
				new int[] {
					DateUtil.CreateFromYMD (2017,  4, 19).julian(),
					DateUtil.CreateFromYMD (2017, 10, 19).julian(),
					DateUtil.CreateFromYMD (2018,  4, 19).julian(),
					DateUtil.CreateFromYMD (2018, 10, 19).julian(),
					DateUtil.CreateFromYMD (2019,  5, 19).julian(),
					DateUtil.CreateFromYMD (2019, 10, 19).julian(),
					DateUtil.CreateFromYMD (2020,  4, 19).julian(),
					DateUtil.CreateFromYMD (2020, 10, 19).julian(),
					DateUtil.CreateFromYMD (2021,  4, 19).julian(),
					DateUtil.CreateFromYMD (2021, 10, 19).julian(),
				},
				new double[] {
					0.736643329,
					0.718945295,
