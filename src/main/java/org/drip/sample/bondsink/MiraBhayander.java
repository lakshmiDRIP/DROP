...
public class MiraBhayander {
		...
		throws Exception
	{
		...
		BondComponent bond = BondBuilder.CreateSimpleFixed (
			...
			Array2D.FromArray (
				new int[] {
					DateUtil.CreateFromYMD (2017,  7,  2).julian(),
					DateUtil.CreateFromYMD (2018,  1,  2).julian(),
					DateUtil.CreateFromYMD (2018,  7,  2).julian(),
					DateUtil.CreateFromYMD (2019,  1,  2).julian(),
					DateUtil.CreateFromYMD (2019,  7,  2).julian(),
					DateUtil.CreateFromYMD (2020,  1,  2).julian(),
					DateUtil.CreateFromYMD (2020,  7,  2).julian(),
