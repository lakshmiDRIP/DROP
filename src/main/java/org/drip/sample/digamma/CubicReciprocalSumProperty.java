...
/**
 * <i>CubicReciprocalSumProperty</i> demonstrates the Cubic Sum Property of the Digamma Saddle Points. The
 * References are:
 * 
 * <br><br>
 * 	<ul>
...
public class CubicReciprocalSumProperty
{
		...
		throws Exception
	{
		...
		R1ToR1Property cubicReciprocalSumProperty = DigammaSaddlePointEqualityLemma.CubicReciprocalSum
			(SaddlePoints.HermiteEnhancement());

		System.out.println ("\t|-------------------------------------------------||");

		System.out.println ("\t|          CUBIC RECIPROCAL SUM PROPERTY          ||");
