...
public class BernsteinBinetBoundProperty
{
	...
	private static final void Verifier (
		...
		throws Exception
	{
		R1PropertyVerification leftVerification = DigammaInequalityLemma.BernsteinBinetLeftBound().verify (z);

		R1PropertyVerification rightVerification = DigammaInequalityLemma.BernsteinBinetRightBound().verify (z);
