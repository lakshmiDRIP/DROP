...
/**
 * <i>BlagouchineSummationProperty4</i> demonstrates the Blagouchine (2014) Property Lemma for Digamma
...
public class BlagouchineSummationProperty4
{
		...
		throws Exception
	{
		R1PropertyVerification verification =
			DigammaEqualityLemma.SummationIdentity4 (k).verify (m);
