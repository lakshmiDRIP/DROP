...
/**
 * <i>BlagouchineSummationProperty5</i> demonstrates the Blagouchine (2014) Property Lemma for Digamma
...
public class BlagouchineSummationProperty5
{
		...
		throws Exception
	{
		R1ToR1PropertyVerification verification =
			DigammaEqualityLemma.SummationIdentity5 (k).verify (m);
