...
/**
 * <i>BlagouchineSummationProperty8</i> demonstrates the Blagouchine (2014) Property Lemma for Digamma
...
public class BlagouchineSummationProperty8
{
		...
		throws Exception
	{
		R1PropertyVerification verification =
			DigammaEqualityLemma.SummationIdentity8 (k).verify (m);
