...
/**
 * <i>AffineR2ToR1</i> illustrates the Estimation of Condition Number for Affine R<sup>2</sup> to
 *  R<sup>1</sup> Function. The References are:
 * 
 * <br><br>
 * 	<ul>
 * 		<li>
...
public class AffineR2ToR1
{
		...
		throws Exception
	{
		...
		System.out.println ("\t|         AFFINE R2 -> R1        ||");
