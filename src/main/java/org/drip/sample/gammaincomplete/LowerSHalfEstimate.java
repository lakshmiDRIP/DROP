...
public class LowerSHalfEstimate
{
		...
		throws Exception
	{
		...
		System.out.println ("\t|            - erf Estimate              ||");
		...
		for (double z : zArray)
		{
			...
			System.out.println (
				...
				FormatUtil.FormatDouble (lowerEulerIntegral.evaluate (0.5), 1, 10, 1.) + " | " +
				FormatUtil.FormatDouble (Math.sqrt (Math.PI) * erfWinitzki.evaluate (Math.sqrt (z)), 1, 10, 1.) + " ||"
			);
		}
