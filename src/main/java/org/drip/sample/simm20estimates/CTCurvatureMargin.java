...
/**
 * CTCurvatureMargin illustrates the Computation of the CT Curvature Margin for across a Group of Commodity
...
public class CTCurvatureMargin
{
		...
		throws Exception
	{
		...
		RiskMeasureSensitivitySettings riskMeasureSensitivitySettings =
			RiskMeasureSensitivitySettings.ISDA_CT_CURVATURE (vegaDurationDays);
