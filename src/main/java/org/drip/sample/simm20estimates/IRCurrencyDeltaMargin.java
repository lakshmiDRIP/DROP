...
import org.drip.simm20.parameters.RiskClassSensitivitySettingsIR;
...
public class IRCurrencyDeltaMargin
{
		...
		throws Exception
	{
		...
		RiskClassSensitivitySettingsIR riskClassSensitivitySettingsIR = RiskClassSensitivitySettingsIR.ISDA
			(currencyList);
		...
		Map<java.lang.String, org.drip.simm20.product.BucketSensitivityIR> bucketSensitivityMap = new
			HashMap<java.lang.String, org.drip.simm20.product.BucketSensitivityIR>();
