...
import org.drip.simm20.parameters.BucketCurvatureSettingsIR;
...
/**
 * IRCurrencyCurvatureMarginFlow illustrates the Steps in the Computation of the IR Curvature Margin for a
...
public class IRCurrencyCurvatureMarginFlow
{
		...
		throws Exception
	{
		...
		BucketCurvatureSettingsIR bucketCurvatureSettingsIR = BucketCurvatureSettingsIR.ISDA (currency);
		...
		IRSensitivityAggregate irCurvatureAggregate =
			bucketAggregateIR.riskFactorAggregateIR().curvatureMargin (bucketCurvatureSettingsIR);
