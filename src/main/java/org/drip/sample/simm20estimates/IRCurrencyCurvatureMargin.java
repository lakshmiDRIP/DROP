...
/**
 * IRCurrencyCurvatureMargin illustrates the Computation of the IR Curvature Margin for a Currency Bucket's
...
public class IRCurrencyCurvatureMargin
{
		...
		throws Exception
	{
		...
		RiskMeasureSensitivitySettingsIR riskMeasureSensitivitySettingsIR =
			RiskMeasureSensitivitySettingsIR.ISDA_CURVATURE (currencyList);
