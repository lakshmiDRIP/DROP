...
/**
 * OTCReceiverClassicalPlusXVA displays the MPoR-related XVA Metrics Suite for the given OTC Receiver Swap on
 *  a Daily Grid using the "Classical+" CSA Timeline of Andersen, Pykhtin, and Sokol (2017). The References
 *  are:
 *  
...
public class OTCReceiverClassicalPlusXVA
{
		...
		throws Exception
	{
		System.out.println (
			annotation + " => " +
			FormatUtil.FormatDouble (univariateDiscreteThin.minimum(), 2, 2, 1.) + " | " +
			FormatUtil.FormatDouble (univariateDiscreteThin.maximum(), 2, 2, 1.) + " | " +
			FormatUtil.FormatDouble (univariateDiscreteThin.average(), 2, 2, 1.) + " ||"
		);
	}
}
