...
public class NonCentralMeasureEstimate
{
		...
		throws Exception
	{
		...
		System.out.println ("\t|           NON-CENTRAL CHI-SQUARED DISTRIBUTION MEASURES ESTIMATE           ||");
		...
		for (double nonCentralityParameter : nonCentralityParameterArray)
		{
			for (int dof : dofArray)
			{
				...
				display = display + " " + FormatUtil.FormatDouble (
					r1UnivariateNonCentral.mean(), 2, 2, 1., false
				) + " | " + FormatUtil.FormatDouble (
					r1UnivariateNonCentral.median(), 2, 6, 1., false
				) + " | " + FormatUtil.FormatDouble (
					r1UnivariateNonCentral.variance(), 2, 2, 1., false
				) + " | " + FormatUtil.FormatDouble (
					r1UnivariateNonCentral.skewness(), 5, 1, 1., false
				) + " | " + FormatUtil.FormatDouble (
					r1UnivariateNonCentral.excessKurtosis(), 1, 6, 1., false
				) + " |";
