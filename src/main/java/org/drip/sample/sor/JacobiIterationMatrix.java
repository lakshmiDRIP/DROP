...
/**
 * <i>JacobiIterationMatrix</i> illustrates the Construction of the Jacobi Iteration Matrix for SOR
 * 	Convergence. The References are:
 * 
 * <br><br>
 * 	<ul>
 * 		<li>
...
public class JacobiIterationMatrix
{
		...
		throws Exception
	{
		...
		System.out.println ("\t|              SOR CONVERGENCE JACOBI ITERATION MATRIX ");
		...
		NumberUtil.Print2DArrayPair (
			...
			" JACOBI ITERATION",
			squareMatrix,
			SuccessiveOverRelaxationConvergenceAnalyzer.Standard (
				squareMatrix,
				0.85
