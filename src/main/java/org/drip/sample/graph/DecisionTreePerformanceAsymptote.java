...
import org.drip.graph.decisiontree.ComplexityEstimate;
 ...
 *		<li><b>Package</b> = <a href = "https://github.com/lakshmiDRIP/DROP/tree/master/src/main/java/org/drip/graph/mst/README.md">Property Estimates for MST Types</a></li>
 *  </ul>
 * <br><br>
 *
...
public class DecisionTreePerformanceAsymptote
{
		...
		throws Exception
	{
		...
		ComplexityEstimate decisionTreePerformance = new ComplexityEstimate (
			vertexCount
		);
		...
		System.out.println (
			"\t|              ASYMPTOTIC DECISION TREE PERFORMANCE ANALYSIS              ||"
		);
		...
		System.out.println (
			"\t|  Number of Vertexes                                              => " +
			decisionTreePerformance.vertexCount()
		);
		...
		System.out.println (
			...
			decisionTreePerformance.numberOfPossibleGraphs()
		);

		System.out.println (
			"\t|  Optimal Depth of the Decision Tree                              => " +
			decisionTreePerformance.optimalDepth()
		);

		System.out.println (
			"\t|  Upper Bound on the Number of Internal DT Nodes                  => " +
			decisionTreePerformance.internalNodesUpperBound()
		);

		System.out.println (
			"\t|  Upper Bound on the Number of Edges per Graph                    => " +
			decisionTreePerformance.graphEdgeUpperBound()
		);

		System.out.println (
			"\t|  Upper Bound on the Number of Decision Tree Comparisons          => " +
			decisionTreePerformance.comparisonUpperBound()
		);

		System.out.println (
			"\t|  Upper Bound on the Number of Generated Decision Trees           => " +
			decisionTreePerformance.generatedCountUpperBound()
		);

		System.out.println (
			"\t|  Upper Bound on the Number of Edge Weight Permutations           => " +
			decisionTreePerformance.edgeWeightPermutationsUpperBound()
		);

		System.out.println (
			"\t|  Upper Bound on the MST Algorithm Runtime                        => " +
			decisionTreePerformance.mstRuntimeUpperBound()
		);

		System.out.println (
			"\t|  Upper Bound on the Time required to check all Permutations      => " +
			decisionTreePerformance.permutationsCheckUpperBound()
		);

		System.out.println (
			"\t|  Upper Bound on the Time for finding the Optimal DT Finding Time => " +
			decisionTreePerformance.optimalDTFinderUpperBound()
		);
