...
/**
 * <i>R1JointDiffusion</i> demonstrates the Joint Evolution of R<sup>1</sup> Diffusion Variates - the
 * 	Continuous Asset, the Collateral, the Bank, and the Counter-Party Numeraires involved in the Dynamic XVA
 * 	Replication Portfolio of the Burgard and Kjaer (2011) Methodology. The References are:
 *  
 * <br><br>
 *  <ul>
 *  	<li>
