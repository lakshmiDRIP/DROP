...
/**
 * <i>Bilaspur</i> demonstrates the Analytics Calculation/Reconciliation for the Loan Bilaspur.
 *  
 * <br><br>
 *  <ul>
		...
		throws Exception
	{
		...
		SetEOS (
			...
			EmbeddedOptionSchedule.FromAmerican (
				dtSpot.julian(),
				new int[] {
					DateUtil.CreateFromYMD (2013,  6, 30).julian(),
					DateUtil.CreateFromYMD (2013, 12, 30).julian(),
					DateUtil.CreateFromYMD (2020,  5,  9).julian(),
				},
				new double[] {
					1.01,
					1.00,
