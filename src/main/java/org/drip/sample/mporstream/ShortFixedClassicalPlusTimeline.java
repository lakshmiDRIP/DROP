...
/**
 * <i>ShortFixedClassicalPlusTimeline</i> displays the MPoR-related Exposure Metrics Suite for the given
 * 	Short Fixed Coupon Stream on a Daily Grid using the "Classical+" CSA Timeline Scheme of Andersen,
 * 	Pykhtin, and Sokol (2017). The References are:
 *  
 * <br><br>
 *  <ul>
 *  	<li>
...
public class ShortFixedClassicalPlusTimeline
{
		...
		throws Exception
	{
		...
		OTCFixFloatLabel otcFixFloatLabel = OTCFixFloatLabel.Standard (currency + "-3M-1Y");
