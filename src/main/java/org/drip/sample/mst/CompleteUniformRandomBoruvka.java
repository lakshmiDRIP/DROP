...
/**
 * <i>CompleteUniformRandomBoruvka</i> demonstrates the Ensemble MST Length Analysis of a Complete Graph
 * 	built using Random Weights, and the Boruvka Minimum Spanning Forest Generator. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
public class CompleteUniformRandomBoruvka
{
		...
		throws Exception
	{
		...
		for (int pathIndex = 0;
			...
			++pathIndex)
		{
			mstLengthEnsemble[pathIndex] = CompleteRandomGraphEnsemble.Boruvka (
