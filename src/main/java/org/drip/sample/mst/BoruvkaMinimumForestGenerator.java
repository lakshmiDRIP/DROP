...
/**
 * <i>BoruvkaMinimumForestGenerator</i> illustrates the Execution of the Boruvka Algorithm for the Generation
 * 	of the Minimum Spanning Forest. The References are:
 *  
 * <br><br>
 *  <ul>
 *  	<li>
...
public class BoruvkaMinimumForestGenerator
{
		...
		throws Exception
	{
		...
		for (Tree minimumSpanningTree : minimumSpanningForest.values())
		{
			...
			System.out.println (
				"\t|                        BORUVKA MINIMUM SPANNING TREE PATH                         |"
			);
