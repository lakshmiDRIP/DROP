...
/**
 * <i>CompleteUniformRandomPrim</i> demonstrates the Ensemble MST Length Analysis of a Complete Graph built
 *  using Random Weights, and the Prim Minimum Spanning Forest Generator. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
public class CompleteUniformRandomPrim
{
		...
		throws Exception
	{
		...
		for (int pathIndex = 0;
			...
			++pathIndex)
		{
			mstLengthEnsemble[pathIndex] = CompleteRandomGraphEnsemble.Prim (
		...
		throws Exception
	{
		...
		System.out.println ("\t|       COMPLETE UNIFORM RANDOM PRIM MST LENGTH        ||");
