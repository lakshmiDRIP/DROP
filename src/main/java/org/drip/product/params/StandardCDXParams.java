...
/**
 * <i>StandardCDXParams</i> implements the parameters used to create the standard CDX - the coupon, the
...
public class StandardCDXParams {
		...
		throws java.lang.Exception
	{
		if (null == (_strCurrency = strCurrency) || _strCurrency.isEmpty() ||
			!org.drip.numerical.common.NumberUtil.IsValid (_dblCoupon = dblCoupon))
