...
public class OTCFixFloatLabel implements org.drip.state.identifier.LatentStateLabel
{
	...
	{
		return "OTCFixFloat-" + _forwardLabel.fullyQualifiedName();
	}

	@Override public boolean match (
		final org.drip.state.identifier.LatentStateLabel lslOther)
	{
		return _forwardLabel.match (lslOther);
	}
}
