 ...
 *  holds the Accrual Start Date, the Accrual End Date, the Fixed Coupon, the Basis Spread, the Coupon and
 *  the Accrual Day Counts, as well as the EOM Adjustment Flags.
 *
