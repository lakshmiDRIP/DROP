...
public class CubicRationalLeftRaw
	extends TensionBasisHat
{
	private LeftHatShapeControl _leftHatShapeControl = null;

	/**
	 * <i>CubicRationalLeftRaw</i> constructor
	 * 
		...
		throws Exception
	{
		...
		_leftHatShapeControl = new LeftHatShapeControl (
		...
		throws Exception
	{
		...
		double leftAdjustedOrdinate = predictorOrdinate - left();

		double cubicValue = leftAdjustedOrdinate * leftAdjustedOrdinate * leftAdjustedOrdinate;

		return 0. == tension() ? cubicValue / 6. :
			cubicValue * _leftHatShapeControl.evaluate (predictorOrdinate);
	}
	...
	{
		if (0 >= order) {
			throw new Exception ("CubicRationalLeftRaw::derivative => Invalid Inputs");
		}
		...
		double gap = predictorOrdinate - left();
		...
		throws Exception
	{
		...
		double endGap = boundedEnd - left;
		double beginGap = boundedBegin - left;
