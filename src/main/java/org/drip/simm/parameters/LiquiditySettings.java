...
/**
 * <i>LiquiditySettings</i> exposes the Concentration Thresholds for each Risk Factor. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
 ...
 *
 *  <ul>
 * 		<li>Retrieve the Concentration Threshold</li>
 *  </ul>
 *
 *	<br>
...
public abstract class LiquiditySettings
{
	...
	protected LiquiditySettings (
		...
		throws Exception
	{
		if (!NumberUtil.IsValid (_concentrationThreshold = concentrationThreshold)) {
			throw new Exception ("LiquiditySettings Constructor => Invalid Inputs");
		}
	}
	 ...
	 * 
	 * @return The Concentration Threshold
	 */

	public double concentrationThreshold()
	{
		return _concentrationThreshold;
	}
}
