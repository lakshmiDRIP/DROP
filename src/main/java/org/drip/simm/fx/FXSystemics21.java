...
/**
 * <i>FXSystemics21</i> contains the SIMM 2.1 Systemic Settings Common to FX Risk Factors. The References
 * 	are:
 * 
 * <br><br>
 *  <ul>
...
public class FXSystemics21
{
	...
	public static final double DELTA_RISK_WEIGHT = 8.1;

	/**
	 * FX Risk Class Historical Volatility Ratio (HVR)
	 */

	public static final double HISTORICAL_VOLATILITY_RATIO = 0.63;

	/**
	 * FX Risk Class Vega Risk Weight (VRW)
	 */

	public static final double VEGA_RISK_WEIGHT = 0.30;

	/**
	 * FX Risk Class Correlation
	 */

	public static final double CORRELATION = 0.50;
}
