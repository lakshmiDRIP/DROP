...
/**
 * <i>CRThresholdContainer24</i> holds the ISDA SIMM 2.4 Credit Risk Thresholds - the Credit Risk Buckets and
...
public class CRThresholdContainer24
{
	...
	{
		try {
			s_CRQThresholdMap.put (-1, new DeltaVegaThreshold (0.22, 310.));

			s_CRQThresholdMap.put (1, new DeltaVegaThreshold (0.49, 310.));

			s_CRQThresholdMap.put (3, new DeltaVegaThreshold (0.22, 310.));

			s_CRQThresholdMap.put (4, new DeltaVegaThreshold (0.22, 310.));

			s_CRQThresholdMap.put (5, new DeltaVegaThreshold (0.22, 310.));

			s_CRQThresholdMap.put (6, new DeltaVegaThreshold (0.22, 310.));

			s_CRQThresholdMap.put (7, new DeltaVegaThreshold (0.49, 310.));

			s_CRQThresholdMap.put (8, new DeltaVegaThreshold (0.22, 310.));

			s_CRQThresholdMap.put (9, new DeltaVegaThreshold (0.22, 310.));

			s_CRQThresholdMap.put (10, new DeltaVegaThreshold (0.22, 310.));

			s_CRQThresholdMap.put (11, new DeltaVegaThreshold (0.22, 310.));

			s_CRQThresholdMap.put (12, new DeltaVegaThreshold (0.22, 310.));

			s_CRQThresholdMap.put (-1, new DeltaVegaThreshold (0.50, 85.));

			s_CRQThresholdMap.put (1, new DeltaVegaThreshold (9.50, 85.));

			s_CRQThresholdMap.put (2, new DeltaVegaThreshold (0.50, 85.));
		} catch (Exception e) {
			e.printStackTrace();
