...
/**
 * <i>CRQSettingsContainer24</i> holds the ISDA SIMM 2.4 Credit Qualifying Buckets. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
public class CRQSettingsContainer24
{
	...
	private static final boolean SetUpCrossBucketCorrelation()
	{
		...
		try {
			s_CrossBucketCorrelation = new LabelledVertexCorrelation (
				bucketList,
				new double[][] {
					{1.00, 0.35, 0.37, 0.35, 0.37, 0.34, 0.38, 0.31, 0.34, 0.33, 0.30, 0.31}, // #01
					{0.35, 1.00, 0.44, 0.43, 0.45, 0.42, 0.32, 0.34, 0.38, 0.38, 0.35, 0.35}, // #02
					{0.37, 0.44, 1.00, 0.48, 0.49, 0.47, 0.34, 0.35, 0.42, 0.42, 0.40, 0.39}, // #03
					{0.35, 0.43, 0.48, 1.00, 0.48, 0.48, 0.32, 0.34, 0.40, 0.41, 0.39, 0.37}, // #04
					{0.37, 0.45, 0.49, 0.48, 1.00, 0.48, 0.34, 0.35, 0.41, 0.41, 0.40, 0.39}, // #05
					{0.34, 0.42, 0.47, 0.48, 0.48, 1.00, 0.31, 0.33, 0.37, 0.38, 0.38, 0.36}, // #06
					{0.38, 0.32, 0.34, 0.32, 0.34, 0.31, 1.00, 0.28, 0.32, 0.30, 0.27, 0.28}, // #07
					{0.31, 0.34, 0.35, 0.34, 0.35, 0.33, 0.28, 1.00, 0.32, 0.32, 0.29, 0.29}, // #08
					{0.34, 0.38, 0.42, 0.40, 0.41, 0.37, 0.32, 0.32, 1.00, 0.38, 0.35, 0.35}, // #09
					{0.33, 0.38, 0.42, 0.41, 0.41, 0.38, 0.30, 0.32, 0.38, 1.00, 0.35, 0.34}, // #10
					{0.30, 0.35, 0.40, 0.39, 0.40, 0.38, 0.27, 0.29, 0.35, 0.35, 1.00, 0.33}, // #11
					{0.31, 0.35, 0.39, 0.37, 0.39, 0.36, 0.28, 0.29, 0.35, 0.34, 0.33, 1.00}, // #12
				}
			);
	...
	public static final boolean Init()
	{
		try {
			s_BucketMap.put (
				-1,
				new CRBucket (-1, CRSystemics.CREDIT_QUALITY_UNSPECIFIED, SectorSystemics.RESIDUAL, 452.)
			);
			...
			s_BucketMap.put (
				8,
				new CRBucket (8, CRSystemics.CREDIT_QUALITY_HIGH_YIELD, SectorSystemics.FINANCIALS, 452.)
			);
			...
			s_BucketMap.put (
				10,
				new CRBucket (10, CRSystemics.CREDIT_QUALITY_HIGH_YIELD, SectorSystemics.CONSUMER, 261.)
			);

			s_BucketMap.put (
				11,
				new CRBucket (11, CRSystemics.CREDIT_QUALITY_HIGH_YIELD, SectorSystemics.TMT, 418.)
			);
