...
/**
 * <i>CRQSystemics24</i> contains the SIMM 2.4 Systemic Settings of the Credit Qualifying Risk Factors. The
 * 	References are:
 * 
 * <br><br>
 *  <ul>
 ...
 *
 *  <ul>
 * 		<li>Residual Bucket - Risk Weight</li>
 * 		<li>Credit Qualifying Vega Risk Weight</li>
 * 		<li>Base Correlation - Risk Weight</li>
 * 		<li>Base Correlation - Correlation across Index Families</li>
 *  </ul>
 *
 *	<br>
...
public class CRQSystemics24
{
	...
	public static final double RESIDUAL_BUCKET_RISK_WEIGHT = 452.;

	/**
	 * Credit Qualifying Vega Risk Weight
	 */

	public static final double VEGA_RISK_WEIGHT = 0.73;

	/**
	 * Base Correlation - Risk Weight
	 */

	public static final double BASE_CORRELATION_RISK_WEIGHT = 11.;

	/**
	 * Base Correlation - Correlation across Index Families
	 */

	public static final double BASE_CORRELATION_CORRELATION = 0.25;
}
