...
/**
 * <i>CRNQBucketCorrelation24</i> contains the SIMM 2.4 between the Same/Different Issuer/Seniority and
 * 	different Vertex/Currency for the Same Credit Non-Qualifying Buckets. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
 ...
 *
 *  <ul>
 * 		<li>Correlation between Sensitivities having Overlap of Greater Than 80% Names Non-Residual Same Bucket</li>
 * 		<li>Correlation between Sensitivities having Overlap of Less Than 80% Names Non-Residual Same Bucket</li>
 * 		<li>Correlation between Sensitivities having Overlap of Greater Than 80% Names Residual</li>
 * 		<li>Correlation between Sensitivities having Overlap of Less Than 80% Names Residual</li>
 * 		<li>Correlation between Sensitivities of Non-Residual to Non-Residual</li>
 *  </ul>
 *
 *	<br>
...
public class CRNQBucketCorrelation24
{
	...
	public static final double GT_80PC_OVERLAP_NON_RESIDUAL = 0.86;

	/**
	 * Correlation between Sensitivities having Overlap of Less Than 80% Names Non-Residual Same Bucket
	 */

	public static final double LT_80PC_OVERLAP_NON_RESIDUAL = 0.33;
	...
	public static final double NON_RESIDUAL_TO_NON_RESIDUAL = 0.36;
}
