 ...
 *
 *  <ul>
 * 		<li><i>BucketAggregateIR</i> Constructor</li>
 * 		<li>Retrieve the IR Risk Factor Aggregate</li>
 * 		<li>Retrieve the IR Sensitivity Aggregate</li>
...
public class BucketAggregateIR
{
	...
	/**
	 * <i>BucketAggregateIR</i> Constructor
	 * 
		...
		throws Exception
	{
		...
		{
			throw new Exception ("BucketAggregateIR Constructor => Invalid Inputs");
		}
	}
