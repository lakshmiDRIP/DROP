...
public class IRSystemics24
{
	...
	public static final double SINGLE_CURRENCY_CURVE_INFLATION_RISK_WEIGHT = 64.;
	...
	public static final double HISTORICAL_VOLATILITY_RATIO = 0.44;

	/**
	 * Interest Rate Vega Risk Weight
	 */

	public static final double VEGA_RISK_WEIGHT = 0.18;

	/**
	 * Single Currency Cross-Curve Correlation
	 */

	public static final double SINGLE_CURRENCY_CROSS_CURVE_CORRELATION = 0.986;

	/**
	 * Single Currency Curve Inflation Correlation
	 */

	public static final double SINGLE_CURRENCY_CURVE_INFLATION_CORRELATION = 0.41;

	/**
	 * Single Currency Curve Volatility Inflation Volatility Correlation
	 */

	public static final double SINGLE_CURRENCY_CURVE_VOLATILITY_INFLATION_VOLATILITY_CORRELATION = 0.41;

	/**
	 * Single Currency Curve Basis Swap Spread Correlation
	 */

	public static final double SINGLE_CURRENCY_CURVE_BASIS_SWAP_SPREAD_CORRELATION = 0.07;

	/**
	 * Single Currency Basis Swap Spread Inflation Correlation
	 */

	public static final double SINGLE_CURRENCY_BASIS_SWAP_SPREAD_INFLATION_CORRELATION = 0.07;

	/**
	 * Cross Currency Curve Correlation
	 */

	public static final double CROSS_CURRENCY_CORRELATION = 0.22;
}
