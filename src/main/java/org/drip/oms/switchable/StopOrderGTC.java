...
/**
 * <i>StopOrderGTC</i> holds the Details of a Good-Till-Close (GTC) Stop Order. The References are:
 *  
 * 	<br><br>
 *  <ul>
 * 		<li>
	...
	extends StopOrder
{
	...
	public static final StopOrderGTC Standard (
	...
	public static final StopOrderGTC Buy (
		final OrderIssuer issuer,
		final String ticker,
		final String parentID,
		final double size,
	...
	public static final StopOrderGTC StandardSell (
		final OrderIssuer issuer,
		final String ticker,
		final String parentID,
		final double size,
