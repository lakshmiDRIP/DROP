...
/**
 * <i>StopOrderDTC</i> holds the Details of a Day-Till-Close (DTC) Stop Order. The References are:
 *  
 * 	<br><br>
 *  <ul>
 * 		<li>
	...
	extends StopOrder
{
	 ...
	 * 
	 * @return Standard Instance of Day-Till-Close (DTC) Stop Order
	 */

	public static final StopOrderDTC Standard (
	 ...
	 * @param switchPrice Switch-to-Market Price
	 * 
	 * @return Standard Instance of Buy Day-Till-Close (DTC) Stop Order
	 */

	public static final StopOrderDTC Buy (
		final OrderIssuer issuer,
		final String ticker,
		final double size,
		final OrderFillWholeSettings fillWholeSettings,
	 ...
	 * @param switchPrice Switch-to-Market Price
	 * 
	 * @return Standard Instance of Sell Day-Till-Close (DTC) Stop Order
	 */

	public static final StopOrderDTC Sell (
		final OrderIssuer issuer,
		final String ticker,
		final double size,
		final OrderFillWholeSettings fillWholeSettings,
