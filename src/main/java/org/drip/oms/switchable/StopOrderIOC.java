...
/**
 * <i>StopOrderIOC</i> holds the Details of a Immediate-Or-Cancel (IOC) Stop Order. The References are:
 *  
 * 	<br><br>
 *  <ul>
 * 		<li>
	...
	extends StopOrder
{
	...
	public static final StopOrderIOC Standard (
	...
	public static final StopOrderIOC Buy (
		final OrderIssuer issuer,
		final String ticker,
		final double size,
		final OrderFillWholeSettings fillWholeSettings,
	...
	public static final StopOrderIOC Sell (
		final OrderIssuer issuer,
		final String ticker,
		final double size,
		final OrderFillWholeSettings fillWholeSettings,
