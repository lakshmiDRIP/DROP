...
/**
 * <i>OrderStatus</i> holds the Status of a FIX 4.2 Order. The References are:
 *  
 * 	<br><br>
 *  <ul>
 * 		<li>
...
public class OrderStatus
{
	...
	public static final int PENDING_NEW = 2;
	...
	public static final int DONE_FOR_DAY = 16;

	/**
	 * PENDING CANCEL
	 */

	public static final int PENDING_CANCEL = 32;

	/**
	 * PENDING REPLACE
	 */

	public static final int PENDING_REPLACE = 64;

	/**
	 * REPLACED
	 */

	public static final int REPLACED = 128;
	...
	public static final int REJECTED = 512;
