...
/**
 * <i>HoldingsVertex</i> holds the Vertex Values of Money Market, Underlier, and Claims Inventory. The
 *  References are:
 *  
 * 	<br><br>
 *  <ul>
...
public class InventoryVertex
{
	 ...
	 * 
	 * @return Number of Money Market Units
	 */

	public double moneyMarketUnits()
	{
		return _moneyMarketUnits;
	}

	/**
	 * Retrieve the Number of Underlier Units
	 * 
	 * @return Number of Underlier Units
	 */
