...
/**
 * <i>ComponentExtractor</i> Interface exposes the Methods that extract the Linear System Components using
...
public interface ComponentExtractor
{
	...
	public abstract org.drip.numerical.eigenization.EigenComponent principalComponent (
		final double[][] a);
	...
	public abstract org.drip.numerical.eigenization.EigenOutput eigenize (
		final double[][] a);
}
