...
public class ComplexNumber {
	...
	{
		if (null == cn || !org.drip.numerical.common.NumberUtil.IsValid (dblScale)) return null;
	...
	{
		if (!org.drip.numerical.common.NumberUtil.IsValid (_dblReal = dblReal) ||
			!org.drip.numerical.common.NumberUtil.IsValid (_dblImaginary = dblImaginary))
