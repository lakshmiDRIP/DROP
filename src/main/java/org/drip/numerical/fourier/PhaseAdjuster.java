...
public class PhaseAdjuster {
	...
	public static final org.drip.numerical.complex.C1Cartesian PowerLogPhaseTracker (
		final org.drip.numerical.complex.C1Cartesian cnGNumerator,
		final org.drip.numerical.complex.C1Cartesian cnGDenominator,
		final int iN,
		final int iM)
	{
		...
		try {
			return new org.drip.numerical.complex.C1Cartesian (java.lang.Math.log (cnGNumerator.abs() /
