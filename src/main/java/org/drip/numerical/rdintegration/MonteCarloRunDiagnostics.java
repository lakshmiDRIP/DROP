...
/**
 * <i>MonteCarloRunDiagnostics</i> holds the Results and Diagnostics of a R<sup>d</sup> To R<sup>1</sup>
 * 	Monte-Carlo Integration. The References are:
 * 
 * <br><br>
 * 	<ul>
 * 		<li>
...
public class MonteCarloRunDiagnostics
	extends MonteCarloRun
{
	private double[] _integrandSampleArray = null;

	/**
	 * Construct a Standard Instance of <i>MonteCarloRunDiagnostics</i>
	 * 
	 ...
	 * 
	 * return Standard Instance of <i>MonteCarloRunDiagnostics</i>
	 */

	public static MonteCarloRunDiagnostics Standard (
		final int samplingPointCount,
		final double integrandMean,
		final double integrandVolume,
		final double unbiasedIntegrandVariance)
	{
		MonteCarloRunDiagnostics monteCarloRunDiagnostics = new MonteCarloRunDiagnostics();

		return monteCarloRunDiagnostics.setSamplingPointCount (samplingPointCount) &&
			monteCarloRunDiagnostics.setIntegrandMean (integrandMean) &&
			monteCarloRunDiagnostics.setIntegrandVolume (integrandVolume) &&
			monteCarloRunDiagnostics.setUnbiasedIntegrandVariance (unbiasedIntegrandVariance) ?
			monteCarloRunDiagnostics : null;
	}

	protected MonteCarloRunDiagnostics()
	{
	}

	/**
	 * Retrieve the Array of Integrand Samples
	 * 
	 * @return Array of Integrand Samples
	 */

	public double[] integrandSampleArray()
	{
		return _integrandSampleArray;
	}
		...
		final double[] integrandSampleArray)
	{
		...
		_integrandSampleArray = integrandSampleArray;
		return true;
	}
}
