...
/**
 * <i>MonteCarloRunUniformDiagnostics</i> holds the Results and Diagnostics of a R<sup>d</sup> To
 * 	R<sup>1</sup> Uniform Monte-Carlo Integration. The References are:
 * 
 * <br><br>
 * 	<ul>
 * 		<li>
...
public class MonteCarloRunUniformDiagnostics
	extends MonteCarloRun
{
	private double[] _integrandSampleArray = null;

	/**
	 * Empty MonteCarloRunUniformDiagnostics Constructor
	 */

	public MonteCarloRunUniformDiagnostics()
	{
	}
