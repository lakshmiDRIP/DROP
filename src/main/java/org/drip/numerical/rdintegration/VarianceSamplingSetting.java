...
/**
 * <i>VarianceSamplingSetting</i> implements the Settings for Variance Sampling used in Monte-Carlo
...
public class VarianceSamplingSetting
{
	...
	/**
	 * Retrieve the Count of Variance Iteration Zones
	 * 
	 * @return Count of Variance Iteration Zones
	 */

	public int zoneIterationCount()
	{
		return _zoneIterationCount;
	}
