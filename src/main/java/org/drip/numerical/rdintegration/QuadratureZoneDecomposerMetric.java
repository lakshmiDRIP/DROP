...
/**
 * <i>QuadratureZoneDecomposerMetric</i> holds the Optimization Metric of a Quadrature Zone corresponding to
 * 	an Integration of R<sup>d</sup> To R<sup>1</sup> Objective Function. The References are:
 * 
 * <br><br>
 * 	<ul>
 * 		<li>
...
public class QuadratureZoneDecomposerMetric
{
	...
	{
		return _peakVarianceProxyDimension;
	}

	/**
	 * Retrieve the Peak Variance Proxy
	 * 
	 * @return Peak Variance Proxy
	 */

	public double peakVarianceProxy()
	{
		return _peakVarianceProxy;
	}
