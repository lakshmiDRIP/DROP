...
/**
 * <i>R3ToR1SeriesTerm</i> exposes the R<sup>3</sup> To R<sup>1</sup> Series Expansion Term in the Ordered
...
public abstract class R3ToR1SeriesTerm
{

	protected R3ToR1SeriesTerm()
	{
	}

	/**
	 * Compute the Value of the R<sup>3</sup> To R<sup>1</sup> Series Expansion Term
	 * 
	 * @param order Order of the R<sup>3</sup> To R<sup>1</sup> Series Expansion Term
	 * @param x X
	 * @param y Y
	 * @param z Z
	 * 
	 * @return The Value of the R<sup>3</sup> To R<sup>1</sup> Series Expansion Term
	 * 
