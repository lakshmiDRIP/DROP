...
public class GaussKronrodQuadratureGenerator
{
	...
	public static final org.drip.numerical.r1integration.QuadratureEstimator G7 (
	...
	public static final org.drip.numerical.r1integration.QuadratureEstimator K15 (
		final org.drip.numerical.r1integration.AbscissaTransform abscissaTransformer)
	{
		try
		{
	...
	public static final org.drip.numerical.r1integration.NestedQuadratureEstimator G7K15 (
		final double left,
		final double right)
	{
		try
		{
			return new org.drip.numerical.r1integration.NestedQuadratureEstimator (
				org.drip.numerical.r1integration.AbscissaTransform.DisplaceAndScaleMinusOne_PlusOne (
					left,
					right
				),
