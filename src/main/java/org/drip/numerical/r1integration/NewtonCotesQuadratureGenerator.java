...
public class NewtonCotesQuadratureGenerator
{
	...
	public static final org.drip.numerical.r1integration.QuadratureEstimator Zero_PlusOne (
	...
	public static final org.drip.numerical.r1integration.QuadratureEstimator MinusOne_PlusOne (
		final org.drip.numerical.r1integration.AbscissaTransform abscissaTransformer,
		final int intermediatePointCount)
	{
		if (0 >= intermediatePointCount)
	...
	{
		return Zero_PlusOne (
			org.drip.numerical.r1integration.AbscissaTransform.DisplaceAndScaleZero_PlusOne (
				left,
				right
			),
	...
	public static final org.drip.numerical.r1integration.QuadratureEstimator GaussLaguerreLeftDefinite (
		final double left,
		final int intermediatePointCount)
	{
		return Zero_PlusOne (
			org.drip.numerical.r1integration.AbscissaTransform.GaussLaguerreLeftDefinite (left),
			intermediatePointCount
		);
	}
	...
	public static final org.drip.numerical.r1integration.QuadratureEstimator GaussLaguerreRightDefinite (
		final double right,
		final int intermediatePointCount)
	{
		return Zero_PlusOne (
			org.drip.numerical.r1integration.AbscissaTransform.GaussLaguerreRightDefinite (right),
			intermediatePointCount
		);
	}
	...
	public static final org.drip.numerical.r1integration.QuadratureEstimator GaussHermite (
		final int intermediatePointCount)
	{
		return MinusOne_PlusOne (
			org.drip.numerical.r1integration.AbscissaTransform.GaussHermite(),
			intermediatePointCount
		);
	}
}
