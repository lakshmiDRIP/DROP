...
/**
 * <i>Integrator</i> implements the following routines for integrating the R<sup>1</sup> To
...
public class Integrator {
		...
		throws java.lang.Exception
	{
		...
		if (!org.drip.numerical.common.NumberUtil.IsValid (dblYMid))
			throw new java.lang.Exception ("Integrator::MidPoint => Cannot calculate Y at " + 0.5 *
				(dblLeft + dblRight));
		...
		throws java.lang.Exception
	{
		...
		if (!org.drip.numerical.common.NumberUtil.IsValid (dblYLeft))
			throw new java.lang.Exception ("Integrator::Trapezoidal => Cannot calculate Y at " +
				dblLeft);
		...
		throws java.lang.Exception
	{
		...
		if (!org.drip.numerical.common.NumberUtil.IsValid (dblY0))
			throw new java.lang.Exception ("Integrator::Simpson38 => Cannot calculate Y at " +
				dblLeft);
