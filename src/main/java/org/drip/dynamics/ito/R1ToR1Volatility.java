...
/**
 * <i>R1ToR1Volatility</i> implements the R<sup>1</sup> to R<sup>1</sup> Volatility Function. The References
 * 	are:
 *  
 * 	<br><br>
 *  <ul>
...
public abstract class R1ToR1Volatility
	implements org.drip.function.definition.R2ToR1
{

	/**
	 * Calculates the Volatility Value
	 * 
	 * @param r1TimeVertex The R<sup>1</sup> Property Variate/Time Coordinate Vertex
	 * 
