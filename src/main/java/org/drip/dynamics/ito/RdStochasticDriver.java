...
/**
 * <i>RdStochasticDriver</i> exposes the R<sup>d</sup> Random Background Emission Function. The References
 * 	are:
 *  
 * 	<br><br>
 *  <ul>
...
public abstract class RdStochasticDriver
{
	...
	/**
	 * Emit a Single Random R<sup>d</sup> Instance
	 * 
	 * @return Single Random R<sup>d</sup> Instance
	 */

	public abstract double[] emitSingle();
		...
		final int sequenceSize)
	{
		...
		double[][] emissionArray = new double[sequenceSize][];

		for (int sequenceIndex = 0;
			sequenceIndex < sequenceSize;
			++sequenceIndex)
		{
			emissionArray[sequenceIndex] = emitSingle();
		}
