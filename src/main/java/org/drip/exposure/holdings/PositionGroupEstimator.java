...
/**
 * PositionGroupEstimator evaluates the Value of the Position Group given the Realized Market Path. The
 *  References are:
 *  
...
public class PositionGroupEstimator implements org.drip.exposure.mpor.VariationMarginTradePaymentVertex
{
