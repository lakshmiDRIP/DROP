...
/**
 * FixFloatOption holds the JUnit Code Coverage Tests for the FixFloat IRS Option Product Module.
 *
 * @author Lakshmi Krishnamurthy
 */

public class FixFloatOption
{
	@Test public void codeCoverageTest() throws Exception
	{
		MultiCurvePayerReceiver.main (null);

		MultiCurvePayerReceiverAnalysis.main (null);
    }
}
