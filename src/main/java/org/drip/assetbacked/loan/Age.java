 ...
 *		<li><b>Package</b> = <a href = "https://github.com/lakshmiDRIP/DROP/tree/master/src/main/java/org/drip/assetbacked/loan/README.md">Loan</a></li>
 *  </ul>
 *
...
public class Age {
	private double _dblMonthsInBalance = java.lang.Double.NaN;

	/**
	 * Age Constructor
	 * 
	 * @param dblMonthsInBalance Outstanding Months in Balance
	 * 
	 * @throws java.lang.Exception Thrown if the Inputs are Invalid
	 */

	public Age (
		final double dblMonthsInBalance)
		throws java.lang.Exception
	{
		if (0 >= (_dblMonthsInBalance = dblMonthsInBalance))
			throw new java.lang.Exception ("Age Constructor => Invalid Inputs");
	}

	/**
	 * Retrieve the Loan Months in Balance
	 * 
	 * @return The Loan Months in Balance
	 */

	public double monthsInBalance()
	{
		return _dblMonthsInBalance;
	}
}
