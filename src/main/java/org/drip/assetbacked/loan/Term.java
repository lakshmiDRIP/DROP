...
public class Term {
	private double _dblMonths = java.lang.Double.NaN;

	/**
	 * Term Constructor
	 * 
	 * @param dblMonths Outstanding Months in Balance
	 * 
	 * @throws java.lang.Exception Thrown if the Inputs are Invalid
	 */

	public Term (
		final double dblMonths)
		throws java.lang.Exception
	{
		if (0 >= (_dblMonths = dblMonths))
			throw new java.lang.Exception ("Term Constructor => Invalid Inputs");
	}
