...
/**
 * <i>SteeleCompleteUniformRandomEntry</i> holds a single Entry from the Expected MST Length Computation for
 * 	Fully Connected Graphs with a small Number of Vertexes and Edge Weights that are i.i.d from U [0, 1]. The
 * 	References are:
 * 
 * <br><br>
 *  <ul>
...
{
	private long _mstLengthNumerator = java.lang.Long.MIN_VALUE;
	private long _mstLengthDenominator = java.lang.Long.MIN_VALUE;

	/**
	 * SteeleCompleteUniformRandomEntry Constructor
	 * 
	 * @param mstLengthNumerator Numerator of the MST Length
	 * @param mstLengthDenominator Denominator of the MST Length
	 * 
	 * @throws java.lang.Exception Thrown if the Inputs are Invalid
	 */

	public SteeleCompleteUniformRandomEntry (
		final long mstLengthNumerator,
		final long mstLengthDenominator)
		throws java.lang.Exception
	{
		if (0 >= (_mstLengthNumerator = mstLengthNumerator) ||
			0 >= (_mstLengthDenominator = mstLengthDenominator)
		)
		{
			throw new java.lang.Exception (
				"SteeleCompleteUniformRandomEntry Constructor => Invalid Inputs"
			);
		}
	}
	 ...
	 * 
	 * @return Numerator of the MST Length
	 */

	public long mstLengthNumerator()
	{
		return _mstLengthNumerator;
	}

	/**
	 * Retrieve the Denominator of the MST Length
	 * 
	 * @return Denominator of the MST Length
	 */

	public long mstLengthDenominator()
	{
		return _mstLengthDenominator;
	}

	/**
	 * Retrieve the Approximate Expected MST Length
	 * 
	 * @return Approximate Expected MST Length
	 */

	public double approximateExpectedMSTLength()
	{
		return ((double) _mstLengthNumerator) / ((double) _mstLengthDenominator);
	}
}
