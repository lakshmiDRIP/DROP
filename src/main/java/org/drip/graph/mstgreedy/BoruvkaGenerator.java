...
/**
 * <i>BoruvkaGenerator</i> implements the Boruvka Algorithm for generating a Minimum Spanning Tree. The
 * 	References are:
 * 
 * <br><br>
 *  <ul>
	...
	extends org.drip.graph.treebuilder.OptimalSpanningForestGenerator
{
	...
	@Override public org.drip.graph.core.Forest optimalSpanningForest()
	{
		...
		while (1 != forest.treeMap().size())
		{
			if (!forest.conditionalBoruvkaMerge (
				_graph,
				maximum
			))
			{
