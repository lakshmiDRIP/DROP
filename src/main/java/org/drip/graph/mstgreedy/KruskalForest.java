...
/**
 * <i>KruskalForest</i> implements the Extensions to a Forest required by the Kruskal MSF Generator. The
 * 	References are:
 * 
 * <br><br>
 *  <ul>
	...
	extends org.drip.graph.core.Forest
{
		...
		final org.drip.graph.core.Graph graph)
	{
		...
		java.util.Map<java.lang.String, org.drip.graph.core.Tree> treeMap = treeMap();

		java.util.Map<java.lang.String, java.lang.String> containingTreeNameMap = containingTreeNameMap();

		if (!containingTreeNameMap.containsKey (
				sourceVertexName
			) || !containingTreeNameMap.containsKey (
		...
		java.lang.String sourceTreeName = containingTreeNameMap.get (
			sourceVertexName
		);

		java.lang.String destinationTreeName = containingTreeNameMap.get (
			destinationVertexName
		);
		...
		org.drip.graph.core.Tree destinationTree = treeMap.get (
			destinationTreeName
		);
