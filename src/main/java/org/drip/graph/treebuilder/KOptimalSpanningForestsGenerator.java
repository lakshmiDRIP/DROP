...
/**
 * <i>KOptimalSpanningForestsGenerator</i> exposes the Functionality behind generating the k Smallest/Largest
...
public abstract class KOptimalSpanningForestsGenerator
{
	...
	protected org.drip.graph.core.Directed<?> _graph = null;
		...
		throws java.lang.Exception
	{
		if (null == (_graph = graph))
		{
			throw new java.lang.Exception (
				"KOptimalSpanningForestsGenerator Constructor => Invalid Inputs"
			);
		}
	 ...
	 * 
	 * @return TRUE - The Forest contains Maximum Spanning Forests
	 */
	 ...
	 * 
	 * @return List of the Smallest Spanning Forests
	 */

	public abstract java.util.List<org.drip.graph.core.Forest<?>> smallestSpanningForestList();
}
