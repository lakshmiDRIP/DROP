...
/**
 * <i>DegreeConstrainedMSTGenerator</i> exposes the Functionality behind the Degree-Constrained MST
 * 	Generation for a given Graph and Vertex Degree. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
public abstract class DegreeConstrainedMSTGenerator
	extends org.drip.graph.treebuilder.OptimalSpanningForestGenerator
{
		...
		throws java.lang.Exception
	{
		...
		if (0 >= (_d = d))
		{
			throw new java.lang.Exception (
				"DegreeConstrainedMSTGenerator Constructor => Invalid Inputs"
			);
		}
	}
	 ...
	 * 
	 * @return The Vertex Degree Constraint d
	 */
