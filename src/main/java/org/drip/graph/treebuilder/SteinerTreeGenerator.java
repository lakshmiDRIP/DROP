...
/**
 * <i>SteinerTreeGenerator</i> exposes the Functionality behind the Steiner-Tree Generation for a given Graph
 * 	and a Vertex Set. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
public abstract class SteinerTreeGenerator
	extends org.drip.graph.treebuilder.OptimalSpanningForestGenerator
{
		...
		throws java.lang.Exception
	{
		...
		if (null == (_vertexNameSet = vertexNameSet) || 0 == _vertexNameSet.size())
		{
			throw new java.lang.Exception (
				"SteinerTreeGenerator Constructor => Invalid Inputs"
			);
		}
		...
		{
			if (null == vertexNameSet ||
				!graphVertexNameSet.contains (
					vertexName
				)
			)
			{
