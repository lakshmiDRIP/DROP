...
/**
 * <i>OptimalSpanningForestGenerator</i> exposes the Algorithmic Implementation for the Generation of the
 * 	Minimum/Maximum Spanning Forest. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
public abstract class OptimalSpanningForestGenerator
{
		...
		throws java.lang.Exception
	{
		if (null == (_graph = graph))
		{
			throw new java.lang.Exception (
				"OptimalSpanningForestGenerator Constructor => Invalid Inputs"
			);
		}
	 ...
	 * 
	 * @return TRUE - The Forest contains Maximum Spanning Trees
	 */
	 ...
	 * 
	 * @return Optimal Spanning Forest
	 */

	public abstract org.drip.graph.core.Forest<?> optimalSpanningForest();
}
