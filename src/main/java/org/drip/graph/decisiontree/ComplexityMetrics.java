...
/**
 * <i>ComplexityMetrics</i> implements the Asymptotic Size Complexity O (n) for Decision Tree Validation. The
 * 	References are:
 * 
 * <br><br>
 *  <ul>
...
{
	private org.drip.graph.decisiontree.GenerationComplexity _generation = null;
	private org.drip.graph.decisiontree.ValidationComplexity _validation = null;

	/**
	 * ComplexityMetrics Constructor
	 * 
	 * @param generation Generation Complexity Metrics
	 * @param validation Validation Complexity Metrics
	 * 
	 * @throws java.lang.Exception Thrown if the Inputs are Invalid
	 */

	public ComplexityMetrics (
		final org.drip.graph.decisiontree.GenerationComplexity generation,
		final org.drip.graph.decisiontree.ValidationComplexity validation)
		throws java.lang.Exception
	{
		if (null == (_generation = generation) ||
			null == (_validation = validation)
		)
		{
			throw new java.lang.Exception (
				"ComplexityMetrics Constructor => Invalid Inputs"
			);
		}
	}
	 ...
	 * 
	 * @return Generation Complexity Metrics
	 */

	public org.drip.graph.decisiontree.GenerationComplexity generation()
	{
		return _generation;
	}
	 ...
	 * 
	 * @return Validation Complexity Metrics
	 */

	public org.drip.graph.decisiontree.ValidationComplexity validation()
	{
		return _validation;
	}
}
