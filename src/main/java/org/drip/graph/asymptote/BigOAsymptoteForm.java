...
/**
 * <i>BigOAsymptoteForm</i> captures the Asymptotic Form of a given Bounding Function. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
public class BigOAsymptoteForm
{
	...
	public static final java.lang.String CONSTANT = "O (1)        ";

	/**
	 *  Log Time Asymptotic Form
	 */

	public static final java.lang.String LOG_N = "O (log n)    ";

	/**
	 *  Linear Time Asymptotic Form
	 */

	public static final java.lang.String N = "O (n)        ";

	/**
	 *  Linear * Log Time Asymptotic Form
	 */

	public static final java.lang.String N_LOG_N = "O (n log n)  ";

	/**
	 *  Squared Time Asymptotic Form
	 */

	public static final java.lang.String N_SQUARED = "O (n * n)    ";

	/**
	 *  Log (Log) Time Asymptotic Form
	 */

	public static final java.lang.String LOG_LOG_N = "O (log log n)";

	/**
	 *  Exp (SQRT (Log (Log))) Time Asymptotic Form
	 */

	public static final java.lang.String EXP_SQRT_LOG_LOG_N = "O (exp^sqrt(log log n))";
