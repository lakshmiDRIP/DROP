...
/**
 * <i>AlgorithmTimeComplexity</i> maintains the Asymptotic Behavior Specifications of an Algorithm's
...
{
	private java.util.Map<java.lang.String, org.drip.graph.asymptote.OperationTimeComplexity>
		_operationTimeComplexityMap = null;

	protected static final org.drip.function.definition.R1ToR1 ConstantTime()
	{
	...
	protected static final org.drip.function.definition.R1ToR1 LogarithmicTime()
	{
		return new org.drip.function.definition.R1ToR1 (
			null
		)
	...
	protected static final org.drip.function.definition.R1ToR1 LinearTime()
	{
		return new org.drip.function.definition.R1ToR1 (
			null
		)
	...
	public AlgorithmTimeComplexity()
	{
		_operationTimeComplexityMap = new
			org.drip.analytics.support.CaseInsensitiveHashMap<org.drip.graph.asymptote.OperationTimeComplexity>();
	}

	/**
	 * Retrieve the Time Complexity Map of the Algorithm's Operations
	 * 
	 * @return The Time Complexity Map of the Algorithm's Operations
	 */

	public java.util.Map<java.lang.String, org.drip.graph.asymptote.OperationTimeComplexity>
		operationTimeComplexityMap()
	{
		return _operationTimeComplexityMap;
	}
	 ...
	 * @param operationTimeComplexity Operation Time Complexity
	 * 
	 * @return TRUE - The Named Operation Time Complexity
	 */

	public boolean addOperationTimeComplexity (
		final java.lang.String operationName,
		final org.drip.graph.asymptote.OperationTimeComplexity operationTimeComplexity)
	{
		...
		_operationTimeComplexityMap.put (
			operationName,
