...
/**
 * <i>OperationTimeComplexity</i> holds the Series of Asymptotic Behavior Specifications of the Algorithm's
...
{
	private org.drip.graph.asymptote.BigOAsymptoteSpec _bigOSpec = null;
	private org.drip.graph.asymptote.BigOAsymptoteSpec _smallOSpec = null;
	private org.drip.graph.asymptote.BigOAsymptoteSpec _bigOmegaSpec = null;
	private org.drip.graph.asymptote.BigOAsymptoteSpec _bigThetaSpec = null;

	/**
	 * OperationTimeComplexity Constructor
	 * 
	 * @param bigOSpec Big O Specification
	 * @param bigThetaSpec Big Theta Specification
	 * @param bigOmegaSpec Big Omega Specification
	 * @param smallOSpec Small O Specification
	 * 
	 * @throws java.lang.Exception Thrown if the Inputs are Invalid
	 */

	public OperationTimeComplexity (
		final org.drip.graph.asymptote.BigOAsymptoteSpec bigOSpec,
		final org.drip.graph.asymptote.BigOAsymptoteSpec bigThetaSpec,
		final org.drip.graph.asymptote.BigOAsymptoteSpec bigOmegaSpec,
		...
		throws java.lang.Exception
	{
		...
		)
		{
			throw new java.lang.Exception (
				"OperationTimeComplexity Constructor => Invalid Inputs"
			);
		}
	}
	 ...
	 * 
	 * @return The Big O Specification
	 */

	public org.drip.graph.asymptote.BigOAsymptoteSpec bigOSpec()
	{
		return _bigOSpec;
	}
	 ...
	 * 
	 * @return The Big Theta Specification
	 */

	public org.drip.graph.asymptote.BigOAsymptoteSpec bigThetaSpec()
	{
		return _bigThetaSpec;
	}

	/**
	 * Retrieve the Big Omega Specification
	 * 
	 * @return The Big Omega Specification
	 */

	public org.drip.graph.asymptote.BigOAsymptoteSpec bigOmegaSpec()
	{
		return _bigOmegaSpec;
	}

	/**
	 * Retrieve the Small O Specification
	 * 
	 * @return The Small O Specification
	 */

	public org.drip.graph.asymptote.BigOAsymptoteSpec smallOSpec()
	{
		return _smallOSpec;
	}
}
