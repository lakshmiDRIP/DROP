...
/**
 * <i>BinaryTreeAsymptote</i> implements the Asymptotics of a Binary Based Heap. The References are:
 * 
 * <br><br>
 *  <ul>
 *  	<li>
...
{
	private int _n = java.lang.Integer.MIN_VALUE;
	 ...
	 * @param n N
	 * 
	 * @throws java.lang.Exception Throwmn if the Inputs are Invalid
	 */

	public BinaryTreeAsymptote (
		final int n)
		throws java.lang.Exception
	{
		if (0 == (_n = java.lang.Math.abs (
			n
		)))
		{
			throw new java.lang.Exception (
				"BinaryTreeAsymptote Constructor => Invalid Inputs"
			);
		}
	}
	 ...
	 * 
	 * @return The Average Case Complexity to a Constant
	 */

	public double averageCaseComplexity()
	{
		return 1.8814 * _n - 2. * java.lang.Math.log (
			_n
		) / java.lang.Math.log (
			_n
		);
	...
	{
		try {
			return 2. * _n - 2. * org.drip.numerical.common.NumberUtil.PrimeFactorExponentTwo (
				_n
			) - org.drip.numerical.common.NumberUtil.BinaryDigitCount (
				_n
			);
		}
