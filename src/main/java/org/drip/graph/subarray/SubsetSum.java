...
/**
 * <i>SubsetSum</i> finds out is there is a non-empty Subset in the specified Array that adds up to the
...
public abstract class SubsetSum
{
		...
		throws java.lang.Exception
	{
		if (null == (_numberArray = numberArray) || 0 == _numberArray.length)
		{
			throw new java.lang.Exception (
				"SubsetSum Constructor => Invalid Inputs"
			);
		}
	 ...
	 * 
	 * @return TRUE - The Target Sum Match exists
	 */
