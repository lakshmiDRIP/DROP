		...
		try {
			s_aBuildRecord = new org.drip.service.env.BuildRecord[] {
				new org.drip.service.env.BuildRecord (
					"6.61.0",
					"15.0.1+9-18",
					"Mon Mar 31 21:33:29 EST 2025"
				),
				new org.drip.service.env.BuildRecord (
					"6.60.0",
					"15.0.1+9-18",
					"Sun Mar 30 13:09:21 EST 2025"
				),
				new org.drip.service.env.BuildRecord (
					"6.59.0",
					"15.0.1+9-18",
					"Wed Mar 26 13:55:25 EST 2025"
				),
				new org.drip.service.env.BuildRecord (
					"6.58.0",
					"15.0.1+9-18",
					"Sun Feb 16 16:20:51 EST 2025"
				),
				new org.drip.service.env.BuildRecord (
					"6.57.0",
					"15.0.1+9-18",
					"Sat Feb 1 19:31:18 EST 2025"
				),
				new org.drip.service.env.BuildRecord (
					"6.56.0",
					"15.0.1+9-18",
					"Sun Jan 19 16:46:43 EST 2025"
				),
				new org.drip.service.env.BuildRecord (
					"6.55.0",
					"15.0.1+9-18",
					"Sat Jan 18 18:51:24 EST 2025"
				),
				new org.drip.service.env.BuildRecord (
					"6.54.0",
					"15.0.1+9-18",
					"Sun Jan 12 02:21:21 EST 2025"
				),
				new org.drip.service.env.BuildRecord (
					"6.53.0",
					"15.0.1+9-18",
					"Wed Dec 25 19:28:30 EST 2024"
				),
				new org.drip.service.env.BuildRecord (
					"6.52.0",
					"15.0.1+9-18",
					"Sat Dec 21 23:22:26 EST 2024"
				),
				new org.drip.service.env.BuildRecord (
					"6.51.0",
					"15.0.1+9-18",
					"Sat Dec 14 00:04:32 EST 2024"
				),
				new org.drip.service.env.BuildRecord (
					"6.50.0",
					"15.0.1+9-18",
					"Fri Aug 30 22:41:45 EST 2024"
				),
				new org.drip.service.env.BuildRecord (
					"6.49.0",
					"15.0.1+9-18",
					"Tue Aug 20 22:42:18 EST 2024"
				),
				new org.drip.service.env.BuildRecord (
					"6.48.0",
					"15.0.1+9-18",
					"Sat Aug 17 10:15:26 EST 2024"
				),
				new org.drip.service.env.BuildRecord (
					"6.47.0",
					"15.0.1+9-18",
