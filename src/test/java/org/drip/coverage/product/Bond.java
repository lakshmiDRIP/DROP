...
import org.drip.sample.bond.BasketAggregateMeasuresGeneration;
import org.drip.sample.bond.CoreCashFlowMeasures;
...
/**
 * Bond holds the JUnit Code Coverage Tests for the Bond Product Module.
 *
...
public class Bond
{
	...
	{
		BasketAggregateMeasuresGeneration.main (null);

		CoreCashFlowMeasures.main (null);

		CorporateIssueMetrics.main (null);

		MultiCallExerciseMetrics.main (null);
