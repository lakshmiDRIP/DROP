...
public class DCNL_Act implements org.drip.analytics.daycount.DCFCalculator {
		...
		throws java.lang.Exception
	{
		...
		return 1. * (iEndDate - iStartDate + dm.posterior() - dm.anterior() -
			org.drip.analytics.date.DateUtil.NumFeb29 (iStartDate, iEndDate,
				org.drip.analytics.date.DateUtil.RIGHT_INCLUDE)) / actactParams.freq() / actactParams.days();
	}
