...
public class InAdvanceIMMSwap {
		...
		throws Exception
	{
		...
		for (int i = 0; i < astrMaturityTenor.length; ++i) {
			List<Integer> lsFixedStreamEdgeDate = !bIsIMM ? CompositePeriodBuilder.RegularEdgeDates (
				dtEffective,
				"6M",
				astrMaturityTenor[i],
				null
			...
			List<Integer> lsFloatingStreamEdgeDate = !bIsIMM ? CompositePeriodBuilder.RegularEdgeDates (
				dtEffective,
				"6M",
				astrMaturityTenor[i],
				null
