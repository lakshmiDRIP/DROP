...
/**
 * CUSIP_914119C42 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 914119C42.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_914119C42 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014, 12, 19);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2036,  6,  1);
		double dblCoupon = 0.05;
		double dblCleanPrice = 1.1341045;
		int iFreq = 2;
		String strCUSIP = "914119C42";
