...
/**
 * CUSIP_448055AJ2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 448055AJ2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_448055AJ2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2012,  3, 22);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2022,  4, 15);
		double dblCoupon = 0.03950;
		double dblCleanPrice = 1.0275000;
		int iFreq = 2;
		String strCUSIP = "448055AJ2";
