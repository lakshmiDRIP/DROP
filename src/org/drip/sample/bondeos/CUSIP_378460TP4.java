...
/**
 * CUSIP_378460TP4 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 378460TP4.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_378460TP4 {
		...
		throws Exception
	{
		...
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2033,  9,  1);
		double dblCoupon = 0.;
		double dblCleanPrice = 0.417859;
		int iFreq = 2;
		String strCUSIP = "378460TP4";
