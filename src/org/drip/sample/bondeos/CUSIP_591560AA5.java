...
/**
 * CUSIP_591560AA5 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 591560AA5.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_591560AA5 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2007, 12, 12);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2037, 12, 15);
		double dblCoupon = 0.07875;
		double dblCleanPrice = 1.2450280;
		int iFreq = 2;
		String strCUSIP = "591560AA5";
