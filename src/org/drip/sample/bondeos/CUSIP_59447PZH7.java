...
/**
 * CUSIP_59447PZH7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 59447PZH7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_59447PZH7 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  9,  1);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2026,  7,  1);
		double dblCoupon = 0.05000;
		double dblCleanPrice = 1.1279;
		int iFreq = 2;
		String strCUSIP = "59447PZH7";
