...
/**
 * CUSIP_76886PED1 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 76886PED1.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_76886PED1 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010, 11, 10);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2040,  8,  1);
		double dblCoupon = 0.07021;
		double dblCleanPrice = 1.1479500;
		int iFreq = 2;
		String strCUSIP = "76886PED1";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2020,  8,  1).julian(),
			DateUtil.CreateFromYMD (2021,  8,  1).julian(),
			DateUtil.CreateFromYMD (2022,  8,  1).julian(),
			DateUtil.CreateFromYMD (2023,  8,  1).julian(),
			DateUtil.CreateFromYMD (2024,  8,  1).julian(),
			DateUtil.CreateFromYMD (2025,  8,  1).julian(),
			DateUtil.CreateFromYMD (2026,  8,  1).julian(),
			DateUtil.CreateFromYMD (2027,  8,  1).julian(),
			DateUtil.CreateFromYMD (2028,  8,  1).julian(),
			DateUtil.CreateFromYMD (2029,  8,  1).julian(),
			DateUtil.CreateFromYMD (2030,  8,  1).julian(),
			DateUtil.CreateFromYMD (2031,  8,  1).julian(),
			DateUtil.CreateFromYMD (2032,  8,  1).julian(),
			DateUtil.CreateFromYMD (2033,  8,  1).julian(),
			DateUtil.CreateFromYMD (2034,  8,  1).julian(),
			DateUtil.CreateFromYMD (2035,  8,  1).julian(),
			DateUtil.CreateFromYMD (2036,  8,  1).julian(),
			DateUtil.CreateFromYMD (2037,  8,  1).julian(),
			DateUtil.CreateFromYMD (2038,  8,  1).julian(),
			DateUtil.CreateFromYMD (2039,  8,  1).julian(),
		};
