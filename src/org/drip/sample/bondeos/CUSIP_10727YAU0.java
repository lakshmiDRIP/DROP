...
/**
 * CUSIP_10727YAU0 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 10727YAU0.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_10727YAU0 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2009, 10, 27);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2039, 10,  1);
		double dblCoupon = 0.07647;
		double dblCleanPrice = 1.1138400;
		int iFreq = 2;
		String strCUSIP = "10727YAU0";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2019, 10, 1).julian(),
			DateUtil.CreateFromYMD (2020, 10, 1).julian(),
			DateUtil.CreateFromYMD (2021, 10, 1).julian(),
			DateUtil.CreateFromYMD (2022, 10, 1).julian(),
			DateUtil.CreateFromYMD (2023, 10, 1).julian(),
			DateUtil.CreateFromYMD (2024, 10, 1).julian(),
			DateUtil.CreateFromYMD (2025, 10, 1).julian(),
			DateUtil.CreateFromYMD (2026, 10, 1).julian(),
			DateUtil.CreateFromYMD (2027, 10, 1).julian(),
			DateUtil.CreateFromYMD (2028, 10, 1).julian(),
			DateUtil.CreateFromYMD (2029, 10, 1).julian(),
			DateUtil.CreateFromYMD (2030, 10, 1).julian(),
			DateUtil.CreateFromYMD (2031, 10, 1).julian(),
			DateUtil.CreateFromYMD (2032, 10, 1).julian(),
			DateUtil.CreateFromYMD (2033, 10, 1).julian(),
			DateUtil.CreateFromYMD (2034, 10, 1).julian(),
			DateUtil.CreateFromYMD (2035, 10, 1).julian(),
			DateUtil.CreateFromYMD (2036, 10, 1).julian(),
			DateUtil.CreateFromYMD (2037, 10, 1).julian(),
			DateUtil.CreateFromYMD (2038, 10, 1).julian(),
		};
