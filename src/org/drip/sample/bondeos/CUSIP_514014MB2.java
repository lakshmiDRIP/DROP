...
/**
 * CUSIP_514014MB2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 514014MB2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_514014MB2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010,  7,  7);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2028,  1, 15);
		double dblCoupon = 0.06000;
		double dblCleanPrice = 1.1134855;
		int iFreq = 2;
		String strCUSIP = "514014MB2";
