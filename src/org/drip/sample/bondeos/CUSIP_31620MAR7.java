...
/**
 * CUSIP_31620MAR7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 31620MAR7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_31620MAR7 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015, 10, 20);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2025, 10, 15);
		double dblCoupon = 0.05000;
		double dblCleanPrice = 1.0759400;
		int iFreq = 2;
		String strCUSIP = "31620MAR7";
