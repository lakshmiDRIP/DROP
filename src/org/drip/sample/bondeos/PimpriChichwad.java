...
/**
 * PimpriChichwad demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for PimpriChichwad.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class PimpriChichwad {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2012,  3, 27);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2032,  5,  1);
		double dblCoupon = 0.05000;
		double dblCleanPrice = 1.0668605;
		int iFreq = 2;
		String strCUSIP = "PimpriChichwad";
