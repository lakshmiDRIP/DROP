...
/**
 * CUSIP_440327AK0 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 440327AK0.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_440327AK0 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015, 11, 23);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2025, 12,  1);
		double dblCoupon = 0.04500;
		double dblCleanPrice = 1.0219070;
		int iFreq = 2;
		String strCUSIP = "440327AK0";
