...
/**
 * CUSIP_47102XAJ4 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 47102XAJ4.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_47102XAJ4 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  7, 31);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2025,  8,  1);
		double dblCoupon = 0.04875;
		double dblCleanPrice = 1.0517500;
		int iFreq = 2;
		String strCUSIP = "47102XAJ4";
