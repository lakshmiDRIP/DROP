...
/**
 * CUSIP_686430EX3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 686430EX3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_686430EX3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010,  4, 14);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2040,  9,  1);
		double dblCoupon = 0.07784;
		double dblCleanPrice = 1.1526;
		int iFreq = 2;
		String strCUSIP = "686430EX3";
