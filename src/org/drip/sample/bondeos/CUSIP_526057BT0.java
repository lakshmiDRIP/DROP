...
/**
 * CUSIP_526057BT0 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 526057BT0.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_526057BT0 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  2, 12);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2019,  6, 15);
		double dblCoupon = 0.04500;
		double dblCleanPrice = 1.0237500;
		int iFreq = 2;
		String strCUSIP = "526057BT0";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2019,  4, 16).julian(),
		};
