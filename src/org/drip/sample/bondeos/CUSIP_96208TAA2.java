...
/**
 * CUSIP_96208TAA2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 96208TAA2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_96208TAA2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2013,  1, 30);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2023,  2,  1);
		double dblCoupon = 0.047500;
		double dblCleanPrice = 0.9900000;
		int iFreq = 2;
		String strCUSIP = "96208TAA2";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2018,  2,  1).julian(),
