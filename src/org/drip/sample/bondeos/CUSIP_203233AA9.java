...
/**
 * CUSIP_203233AA9 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 203233AA9.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_203233AA9 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010,  9, 17);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2020,  9, 15);
		double dblCoupon = 0.05875;
		double dblCleanPrice = 1.0597700;
		int iFreq = 2;
		String strCUSIP = "203233AA9";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2020,  3, 15).julian(),
		};
