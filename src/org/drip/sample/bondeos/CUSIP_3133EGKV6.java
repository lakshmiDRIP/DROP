...
/**
 * CUSIP_3133EGKV6 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3133EGKV6.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3133EGKV6 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  7, 12);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2027,  7, 12);
		double dblCoupon = 0.0250;
		double dblCleanPrice = 0.9423200;
		int iFreq = 2;
		String strCUSIP = "3133EGKV6";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2017,  7, 12).julian(),
		};
