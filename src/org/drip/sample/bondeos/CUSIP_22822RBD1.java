...
/**
 * CUSIP_22822RBD1 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 22822RBD1.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_22822RBD1 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  5, 15);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2025,  5, 15);
		double dblCoupon = 0.03663;
		double dblCleanPrice = 0.9963781;
		int iFreq = 12;
		String strCUSIP = "22822RBD1";
