...
/**
 * CUSIP_19668QDZ5 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 19668QDZ5.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_19668QDZ5 {
		...
		throws Exception
	{
		...
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2031,  3, 15);
		double dblCoupon = 0.07017;
		double dblCleanPrice = 1.155;
		int iFreq = 2;
		String strCUSIP = "19668QDZ5";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2021,  3, 15).julian(),
			DateUtil.CreateFromYMD (2022,  3, 15).julian(),
			DateUtil.CreateFromYMD (2023,  3, 15).julian(),
			DateUtil.CreateFromYMD (2024,  3, 15).julian(),
			DateUtil.CreateFromYMD (2025,  3, 15).julian(),
			DateUtil.CreateFromYMD (2026,  3, 15).julian(),
			DateUtil.CreateFromYMD (2027,  3, 15).julian(),
			DateUtil.CreateFromYMD (2028,  3, 15).julian(),
			DateUtil.CreateFromYMD (2029,  3, 15).julian(),
			DateUtil.CreateFromYMD (2030,  3, 15).julian(),
		};
