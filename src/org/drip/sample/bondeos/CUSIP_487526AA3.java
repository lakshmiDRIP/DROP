...
/**
 * CUSIP_487526AA3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 487526AA3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_487526AA3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2013,  8,  6);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2021,  8, 15);
		double dblCoupon = 0.07625;
		double dblCleanPrice = 0.9993750;
		int iFreq = 2;
		String strCUSIP = "487526AA3";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2017,  8, 15).julian(),
			DateUtil.CreateFromYMD (2018,  8, 15).julian(),
			DateUtil.CreateFromYMD (2019,  8, 15).julian(),
		};
