...
/**
 * CUSIP_544525PR3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 544525PR3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_544525PR3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2011,  8, 24);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2036,  7,  1);
		double dblCoupon = 0.05000;
		double dblCleanPrice = 1.1094500;
		int iFreq = 2;
		String strCUSIP = "544525PR3";
