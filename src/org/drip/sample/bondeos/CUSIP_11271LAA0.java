...
/**
 * CUSIP_11271LAA0 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 11271LAA0.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_11271LAA0 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  6,  2);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2026,  6,  2);
		double dblCoupon = 0.04250;
		double dblCleanPrice = 0.9955232;
		int iFreq = 2;
		String strCUSIP = "11271LAA0";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2026,  3,  2).julian(),
		};
