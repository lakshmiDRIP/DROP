...
/**
 * KalyanDombivli demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  KalyanDombivli.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class KalyanDombivli {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2013,  6, 18);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2023,  7, 15);
		double dblCoupon = 0.05250;
		double dblCleanPrice = 1.0476400;
		int iFreq = 2;
		String strCUSIP = "KalyanDombivli";
