...
/**
 * CUSIP_02765UDB7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 02765UDB7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_02765UDB7 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2009, 12,  9);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2029,  2, 15);
		double dblCoupon = 0.06449;
		double dblCleanPrice = 1.098342;
		int iFreq = 2;
		String strCUSIP = "02765UDB7";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2020,  2, 15).julian(),
			DateUtil.CreateFromYMD (2021,  2, 15).julian(),
			DateUtil.CreateFromYMD (2022,  2, 15).julian(),
			DateUtil.CreateFromYMD (2023,  2, 15).julian(),
			DateUtil.CreateFromYMD (2024,  2, 15).julian(),
			DateUtil.CreateFromYMD (2025,  2, 15).julian(),
			DateUtil.CreateFromYMD (2026,  2, 15).julian(),
			DateUtil.CreateFromYMD (2027,  2, 15).julian(),
			DateUtil.CreateFromYMD (2028,  2, 15).julian(),
		};
