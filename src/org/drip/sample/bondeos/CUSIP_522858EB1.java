...
/**
 * CUSIP_522858EB1 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 522858EB1.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_522858EB1 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010, 12, 21);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2035, 12, 15);
		double dblCoupon = 0.07140;
		double dblCleanPrice = 1.1089370;
		int iFreq = 2;
		String strCUSIP = "522858EB1";
