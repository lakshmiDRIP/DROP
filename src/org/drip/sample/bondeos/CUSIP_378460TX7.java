...
/**
 * CUSIP_378460TX7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 378460TX7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_378460TX7 {
		...
		throws Exception
	{
		...
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2041,  9,  1);
		double dblCoupon = 0.;
		double dblCleanPrice = 0.234729;
		int iFreq = 2;
		String strCUSIP = "378460TX7";
		...
		int[] aiExerciseDate = new int[] {
			...
			DateUtil.CreateFromYMD (2040,  9,  1).julian(),
		};
