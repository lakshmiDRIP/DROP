...
/**
 * CUSIP_04015CAA6 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 04015CAA6.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_04015CAA6 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014, 10,  8);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024, 10,  8);
		double dblCoupon = 0.04000;
		double dblCleanPrice = 0.9202673;
		int iFreq = 2;
		String strCUSIP = "04015CAA6";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2024,  7,  8).julian(),
		};
