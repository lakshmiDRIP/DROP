...
/**
 * CUSIP_87165BAG8 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 87165BAG8.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_87165BAG8 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  7, 23);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2025,  7, 23);
		double dblCoupon = 0.04500;
		double dblCleanPrice = 1.0254100;
		int iFreq = 2;
		String strCUSIP = "87165BAG8";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2025,  4, 24).julian(),
		};
