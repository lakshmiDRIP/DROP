...
/**
 * CUSIP_406216BJ9 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 406216BJ9.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_406216BJ9 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015, 11, 13);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2035, 11, 15);
		double dblCoupon = 0.04850;
		double dblCleanPrice = 1.0474100;
		int iFreq = 2;
		String strCUSIP = "406216BJ9";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2035,  5, 15).julian(),
		};
