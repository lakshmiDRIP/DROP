...
/**
 * CUSIP_299620EW0 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 299620EW0.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_299620EW0 {
		...
		throws Exception
	{
		...
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2030,  1, 15);
		double dblCoupon = 0.06500;
		double dblCleanPrice = 1.1238020;
		int iFreq = 2;
		String strCUSIP = "299620EW0";
		...
		int[] aiExerciseDate = new int[] {
			...
			DateUtil.CreateFromYMD (2028,  7, 15).julian(),
			DateUtil.CreateFromYMD (2029,  7, 15).julian(),
		};
