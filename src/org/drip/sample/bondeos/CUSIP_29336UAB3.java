...
/**
 * CUSIP_29336UAB3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 29336UAB3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_29336UAB3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  3, 19);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024,  4,  1);
		double dblCoupon = 0.04400;
		double dblCleanPrice = 1.0061000;
		int iFreq = 2;
		String strCUSIP = "29336UAB3";
