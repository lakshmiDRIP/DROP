...
/**
 * CUSIP_3133EFUX3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3133EFUX3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3133EFUX3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  1, 12);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2026,  1, 12);
		double dblCoupon = 0.0302;
		double dblCleanPrice = 0.9880286;
		int iFreq = 2;
		String strCUSIP = "3133EFUX3";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2017,  1, 12).julian(),
		};
