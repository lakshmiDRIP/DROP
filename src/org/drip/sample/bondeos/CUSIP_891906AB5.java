...
/**
 * CUSIP_891906AB5 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 891906AB5.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_891906AB5 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2013,  5, 22);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2023,  6,  1);
		double dblCoupon = 0.03750;
		double dblCleanPrice = 0.9982333;
		int iFreq = 2;
		String strCUSIP = "891906AB5";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2023,  1,  3).julian(),
		};
