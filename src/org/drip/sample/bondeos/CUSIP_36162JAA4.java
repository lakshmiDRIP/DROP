...
/**
 * CUSIP_36162JAA4 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 36162JAA4.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_36162JAA4 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  9, 25);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024, 10, 15);
		double dblCoupon = 0.05875;
		double dblCleanPrice = 1.0350000;
		int iFreq = 2;
		String strCUSIP = "36162JAA4";
