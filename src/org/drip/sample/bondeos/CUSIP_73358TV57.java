...
/**
 * CUSIP_73358TV57 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 73358TV57.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_73358TV57 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2008,  3, 15);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2027,  3, 15);
		double dblCoupon = 0.06400;
		double dblCleanPrice = 1.0639000;
		int iFreq = 2;
		String strCUSIP = "73358TV57";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2018,  9, 15).julian(),
			DateUtil.CreateFromYMD (2019,  9, 15).julian(),
			DateUtil.CreateFromYMD (2020,  9, 15).julian(),
			DateUtil.CreateFromYMD (2021,  9, 15).julian(),
			DateUtil.CreateFromYMD (2022,  9, 15).julian(),
			DateUtil.CreateFromYMD (2023,  9, 15).julian(),
			DateUtil.CreateFromYMD (2024,  9, 15).julian(),
			DateUtil.CreateFromYMD (2025,  9, 15).julian(),
			DateUtil.CreateFromYMD (2026,  9, 15).julian(),
		};
