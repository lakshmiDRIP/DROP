...
/**
 * CUSIP_153527AL0 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 153527AL0.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_153527AL0 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015, 11,  9);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2023, 11, 15);
		double dblCoupon = 0.06125;
		double dblCleanPrice = 1.0643750;
		int iFreq = 2;
		String strCUSIP = "153527AL0";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2018, 11, 15).julian(),
			DateUtil.CreateFromYMD (2019, 11, 15).julian(),
