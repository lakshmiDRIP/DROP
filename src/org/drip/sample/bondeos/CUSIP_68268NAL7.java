...
/**
 * CUSIP_68268NAL7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 68268NAL7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_68268NAL7 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2013,  9, 12);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2023,  9, 15);
		double dblCoupon = 0.05000;
		double dblCleanPrice = 1.0663300;
		int iFreq = 2;
		String strCUSIP = "68268NAL7";
