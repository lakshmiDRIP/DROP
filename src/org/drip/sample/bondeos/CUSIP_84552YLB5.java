...
/**
 * CUSIP_84552YLB5 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 84552YLB5.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_84552YLB5 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010, 11, 23);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2035, 11, 15);
		double dblCoupon = 0.07230;
		double dblCleanPrice = 1.1105775;
		int iFreq = 2;
		String strCUSIP = "84552YLB5";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2020,  4, 15).julian(),
			DateUtil.CreateFromYMD (2021,  4, 15).julian(),
			DateUtil.CreateFromYMD (2022,  4, 15).julian(),
			DateUtil.CreateFromYMD (2023,  4, 15).julian(),
			DateUtil.CreateFromYMD (2024,  4, 15).julian(),
			DateUtil.CreateFromYMD (2025,  4, 15).julian(),
			DateUtil.CreateFromYMD (2026,  4, 15).julian(),
			DateUtil.CreateFromYMD (2027,  4, 15).julian(),
			DateUtil.CreateFromYMD (2028,  4, 15).julian(),
			DateUtil.CreateFromYMD (2029,  4, 15).julian(),
			DateUtil.CreateFromYMD (2030,  4, 15).julian(),
			DateUtil.CreateFromYMD (2031,  4, 15).julian(),
			DateUtil.CreateFromYMD (2032,  4, 15).julian(),
			DateUtil.CreateFromYMD (2033,  4, 15).julian(),
			DateUtil.CreateFromYMD (2034,  4, 15).julian(),
			DateUtil.CreateFromYMD (2035,  4, 15).julian(),
		};
