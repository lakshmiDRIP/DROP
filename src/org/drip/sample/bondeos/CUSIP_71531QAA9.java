...
/**
 * CUSIP_71531QAA9 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 71531QAA9.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_71531QAA9 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  6, 26);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2022,  7, 15);
		double dblCoupon = 0.05500;
		double dblCleanPrice = 1.0315700;
		int iFreq = 2;
		String strCUSIP = "71531QAA9";
