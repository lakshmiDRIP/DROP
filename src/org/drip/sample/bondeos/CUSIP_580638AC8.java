...
/**
 * CUSIP_580638AC8 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 580638AC8.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_580638AC8 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  5,  4);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024,  5, 15);
		double dblCoupon = 0.07875;
		double dblCleanPrice = 0.9725000;
		int iFreq = 2;
		String strCUSIP = "580638AC8";
