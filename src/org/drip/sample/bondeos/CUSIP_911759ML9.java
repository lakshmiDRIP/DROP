...
/**
 * CUSIP_911759ML9 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 911759ML9.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_911759ML9 {
		...
		throws Exception
	{
		...
		int iFreq = 2;
		double dblCoupon = 0.0335;
		double dblCleanPrice = 1.0008400;
		String strCUSIP = "911759ML9";
		String strDayCount = "30/360";
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  5, 28);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2029,  8,  1);
