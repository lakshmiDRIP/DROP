...
/**
 * CUSIP_3133EFKT3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3133EFKT3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3133EFKT3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015, 10, 22);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2035, 10, 22);
		double dblCoupon = 0.03625;
		double dblCleanPrice = 0.9796771;
		int iFreq = 2;
		String strCUSIP = "3133EFKT3";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2018, 10, 22).julian(),
		};
