...
/**
 * CUSIP_958638TQ1 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 958638TQ1.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_958638TQ1 {
		...
		throws Exception
	{
		...
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2027, 11, 15);
		double dblCoupon = 0.0525;
		double dblCleanPrice = 1.146158;
		int iFreq = 2;
		String strCUSIP = "958638TQ1";
