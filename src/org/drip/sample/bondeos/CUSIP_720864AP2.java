...
/**
 * CUSIP_720864AP2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 720864AP2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_720864AP2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010, 12, 30);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2040, 12, 15);
		double dblCoupon = 0.07500;
		double dblCleanPrice = 1.1064430;
		int iFreq = 2;
		String strCUSIP = "720864AP2";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2019, 12, 15).julian(),
			DateUtil.CreateFromYMD (2020, 12, 15).julian(),
			DateUtil.CreateFromYMD (2021, 12, 15).julian(),
			DateUtil.CreateFromYMD (2022, 12, 15).julian(),
			DateUtil.CreateFromYMD (2023, 12, 15).julian(),
			DateUtil.CreateFromYMD (2024, 12, 15).julian(),
			DateUtil.CreateFromYMD (2025, 12, 15).julian(),
			DateUtil.CreateFromYMD (2026, 12, 15).julian(),
			DateUtil.CreateFromYMD (2027, 12, 15).julian(),
			DateUtil.CreateFromYMD (2028, 12, 15).julian(),
			DateUtil.CreateFromYMD (2029, 12, 15).julian(),
			DateUtil.CreateFromYMD (2030, 12, 15).julian(),
			DateUtil.CreateFromYMD (2031, 12, 15).julian(),
			DateUtil.CreateFromYMD (2032, 12, 15).julian(),
			DateUtil.CreateFromYMD (2033, 12, 15).julian(),
			DateUtil.CreateFromYMD (2034, 12, 15).julian(),
			DateUtil.CreateFromYMD (2035, 12, 15).julian(),
			DateUtil.CreateFromYMD (2036, 12, 15).julian(),
			DateUtil.CreateFromYMD (2037, 12, 15).julian(),
			DateUtil.CreateFromYMD (2038, 12, 15).julian(),
			DateUtil.CreateFromYMD (2039, 12, 15).julian(),
		};
