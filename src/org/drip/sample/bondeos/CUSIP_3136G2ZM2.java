...
/**
 * CUSIP_3136G2ZM2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3136G2ZM2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3136G2ZM2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  3, 10);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2031,  3, 10);
		double dblCoupon = 0.0310;
		double dblCleanPrice = 0.9736465;
		int iFreq = 2;
		String strCUSIP = "3136G2ZM2";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2017,  3, 10).julian(),
