...
/**
 * CUSIP_899647LQ2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 899647LQ2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_899647LQ2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2009, 12, 10);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2031,  6,  1);
		double dblCoupon = 0.07759;
		double dblCleanPrice = 1.086;
		int iFreq = 2;
		String strCUSIP = "899647LQ2";
