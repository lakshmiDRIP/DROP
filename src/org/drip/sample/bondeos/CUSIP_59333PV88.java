...
/**
 * CUSIP_59333PV88 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 59333PV88.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_59333PV88 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  8, 25);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2035, 10,  1);
		double dblCoupon = 0.03706;
		double dblCleanPrice = 0.9227905;
		int iFreq = 2;
		String strCUSIP = "59333PV88";
