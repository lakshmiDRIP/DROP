...
/**
 * CUSIP_891381K61 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 891381K61.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_891381K61 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  2, 27);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2027,  8,  1);
		double dblCoupon = 0.00000;
		double dblCleanPrice = 0.68058;
		int iFreq = 2;
		String strCUSIP = "891381K61";
