...
/**
 * CUSIP_472682QU0 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 472682QU0.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_472682QU0 {
		...
		throws Exception
	{
		...
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2032, 10,  1);
		double dblCoupon = 0.00000;
		double dblCleanPrice = 0.4625;
		int iFreq = 2;
		String strCUSIP = "472682QU0";
