...
/**
 * CUSIP_038222AK1 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 038222AK1.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_038222AK1 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  9, 14);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2035, 10,  1);
		double dblCoupon = 0.05100;
		double dblCleanPrice = 1.1075500;
		int iFreq = 2;
		String strCUSIP = "038222AK1";
