...
/**
 * CUSIP_44106MAV4 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 44106MAV4.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_44106MAV4 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  2,  3);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2026,  2, 15);
		double dblCoupon = 0.05250;
		double dblCleanPrice = 1.0347500;
		int iFreq = 2;
		String strCUSIP = "44106MAV4";
