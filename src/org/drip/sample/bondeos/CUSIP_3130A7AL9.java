...
/**
 * CUSIP_3130A7AL9 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3130A7AL9.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3130A7AL9 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  2, 22);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2041,  2, 22);
		double dblCoupon = 0.0365;
		double dblCleanPrice = 0.9780581;
		int iFreq = 2;
		String strCUSIP = "3130A7AL9";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2017,  2, 22).julian(),
		};
