...
/**
 * CUSIP_44106MAR3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 44106MAR3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_44106MAR3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2013,  6,  6);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2023,  6, 15);
		double dblCoupon = 0.04500;
		double dblCleanPrice = 1.0222500;
		int iFreq = 2;
		String strCUSIP = "44106MAR3";
