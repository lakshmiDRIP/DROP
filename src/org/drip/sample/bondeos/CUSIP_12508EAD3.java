...
/**
 * CUSIP_12508EAD3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 12508EAD3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_12508EAD3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  6, 18);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024, 10, 15);
		double dblCoupon = 0.05000;
		double dblCleanPrice = 1.0050000;
		int iFreq = 2;
		String strCUSIP = "12508EAD3";
