...
/**
 * CUSIP_983130AV7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 983130AV7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_983130AV7 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  2, 18);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2025,  3,  1);
		double dblCoupon = 0.0550;
		double dblCleanPrice = 1.01;
		int iFreq = 2;
		String strCUSIP = "983130AV7";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2024,  1, 12).julian(),
		};
