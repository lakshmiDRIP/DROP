...
/**
 * CUSIP_18085PLL6 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 18085PLL6.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_18085PLL6 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2009,  9,  4);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2042,  7,  1);
		double dblCoupon = 0.06881;
		double dblCleanPrice = 1.1010000;
		int iFreq = 2;
		String strCUSIP = "18085PLL6";
		...
		int[] aiExerciseDate = new int[] {
			...
			DateUtil.CreateFromYMD (2034,  7,  1).julian(),
			DateUtil.CreateFromYMD (2035,  7,  1).julian(),
			DateUtil.CreateFromYMD (2036,  7,  1).julian(),
			DateUtil.CreateFromYMD (2037,  7,  1).julian(),
			DateUtil.CreateFromYMD (2038,  7,  1).julian(),
			DateUtil.CreateFromYMD (2039,  7,  1).julian(),
			DateUtil.CreateFromYMD (2040,  7,  1).julian(),
			DateUtil.CreateFromYMD (2041,  7,  1).julian(),
		};
