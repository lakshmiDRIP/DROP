...
/**
 * CUSIP_947890AH2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 947890AH2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_947890AH2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  2, 11);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024,  2, 15);
		double dblCoupon = 0.04375;
		double dblCleanPrice = 0.9589842;
		int iFreq = 2;
		String strCUSIP = "947890AH2";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2024,  1, 16).julian(),
		};
