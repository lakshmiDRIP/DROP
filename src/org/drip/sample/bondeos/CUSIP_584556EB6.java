...
/**
 * CUSIP_584556EB6 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 584556EB6.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_584556EB6 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010,  6, 22);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2035,  6,  1);
		double dblCoupon = 0.06842;
		double dblCleanPrice = 1.1410300;
		int iFreq = 2;
		String strCUSIP = "584556EB6";
