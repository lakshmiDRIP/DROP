...
/**
 * CUSIP_45672NAG6 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 45672NAG6.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_45672NAG6 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  3, 15);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2022,  5, 15);
		double dblCoupon = 0.06500;
		double dblCleanPrice = 1.0132000;
		int iFreq = 2;
		String strCUSIP = "45672NAG6";
