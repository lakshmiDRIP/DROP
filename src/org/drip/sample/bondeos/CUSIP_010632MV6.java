...
/**
 * CUSIP_010632MV6 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 010632MV6.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_010632MV6 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010, 12,  1);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2040,  9,  1);
		double dblCoupon = 0.0725;
		double dblCleanPrice = 1.0502185;
		int iFreq = 2;
		String strCUSIP = "010632MV6";
		...
		int[] aiExerciseDate = new int[] {
			...
			DateUtil.CreateFromYMD (2038,  9,  1).julian(),
			DateUtil.CreateFromYMD (2039,  9,  1).julian(),
		};
