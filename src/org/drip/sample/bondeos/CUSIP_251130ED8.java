...
/**
 * CUSIP_251130ED8 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 251130ED8.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_251130ED8 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010, 10, 28);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2040,  5,  1);
		double dblCoupon = 0.06845;
		double dblCleanPrice = 1.0496000;
		int iFreq = 2;
		String strCUSIP = "251130ED8";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2020,  5,  1).julian(),
			DateUtil.CreateFromYMD (2021,  5,  1).julian(),
			DateUtil.CreateFromYMD (2022,  5,  1).julian(),
			DateUtil.CreateFromYMD (2023,  5,  1).julian(),
			DateUtil.CreateFromYMD (2024,  5,  1).julian(),
			DateUtil.CreateFromYMD (2025,  5,  1).julian(),
			DateUtil.CreateFromYMD (2026,  5,  1).julian(),
			DateUtil.CreateFromYMD (2027,  5,  1).julian(),
			DateUtil.CreateFromYMD (2028,  5,  1).julian(),
			DateUtil.CreateFromYMD (2029,  5,  1).julian(),
			DateUtil.CreateFromYMD (2030,  5,  1).julian(),
			DateUtil.CreateFromYMD (2031,  5,  1).julian(),
			DateUtil.CreateFromYMD (2032,  5,  1).julian(),
			DateUtil.CreateFromYMD (2033,  5,  1).julian(),
			DateUtil.CreateFromYMD (2034,  5,  1).julian(),
			DateUtil.CreateFromYMD (2035,  5,  1).julian(),
			DateUtil.CreateFromYMD (2036,  5,  1).julian(),
			DateUtil.CreateFromYMD (2037,  5,  1).julian(),
			DateUtil.CreateFromYMD (2038,  5,  1).julian(),
			DateUtil.CreateFromYMD (2039,  5,  1).julian(),
		};
