...
/**
 * CUSIP_20030NBP5 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 20030NBP5.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_20030NBP5 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  5, 27);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2035,  8, 15);
		double dblCoupon = 0.04400;
		double dblCleanPrice = 1.0126200;
		int iFreq = 2;
		String strCUSIP = "20030NBP5";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2035,  2, 15).julian(),
		};
