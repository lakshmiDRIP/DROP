...
/**
 * CUSIP_413890ES9 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 413890ES9.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_413890ES9 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014, 12, 23);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2047, 11, 15);
		double dblCoupon = 0.0000;
		double dblCleanPrice = 0.23965;
		int iFreq = 2;
		String strCUSIP = "413890ES9";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2031, 11, 15).julian(),
			DateUtil.CreateFromYMD (2032, 11, 15).julian(),
			DateUtil.CreateFromYMD (2033, 11, 15).julian(),
			DateUtil.CreateFromYMD (2034, 11, 15).julian(),
			DateUtil.CreateFromYMD (2035, 11, 15).julian(),
			DateUtil.CreateFromYMD (2036, 11, 15).julian(),
			DateUtil.CreateFromYMD (2037, 11, 15).julian(),
			DateUtil.CreateFromYMD (2038, 11, 15).julian(),
			DateUtil.CreateFromYMD (2039, 11, 15).julian(),
			DateUtil.CreateFromYMD (2040, 11, 15).julian(),
			DateUtil.CreateFromYMD (2041, 11, 15).julian(),
			DateUtil.CreateFromYMD (2042, 11, 15).julian(),
			DateUtil.CreateFromYMD (2043, 11, 15).julian(),
			DateUtil.CreateFromYMD (2044, 11, 15).julian(),
			DateUtil.CreateFromYMD (2045, 11, 15).julian(),
			DateUtil.CreateFromYMD (2046, 11, 15).julian(),
		};
