...
/**
 * CUSIP_67054LAB3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 67054LAB3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_67054LAB3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  5,  8);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2022,  5, 15);
		double dblCoupon = 0.06000;
		double dblCleanPrice = 1.0287500;
		int iFreq = 2;
		String strCUSIP = "67054LAB3";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2017,  5, 15).julian(),
			DateUtil.CreateFromYMD (2018,  5, 15).julian(),
			DateUtil.CreateFromYMD (2019,  5, 15).julian(),
