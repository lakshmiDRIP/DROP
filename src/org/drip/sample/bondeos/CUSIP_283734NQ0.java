...
/**
 * CUSIP_283734NQ0 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 283734NQ0.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_283734NQ0 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010, 11,  1);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2039,  8, 15);
		double dblCoupon = 0.06700;
		double dblCleanPrice = 1.1256840;
		int iFreq = 2;
		String strCUSIP = "283734NQ0";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2020,  8, 15).julian(),
			DateUtil.CreateFromYMD (2021,  8, 15).julian(),
			DateUtil.CreateFromYMD (2022,  8, 15).julian(),
			DateUtil.CreateFromYMD (2023,  8, 15).julian(),
			DateUtil.CreateFromYMD (2024,  8, 15).julian(),
			DateUtil.CreateFromYMD (2025,  8, 15).julian(),
			DateUtil.CreateFromYMD (2026,  8, 15).julian(),
			DateUtil.CreateFromYMD (2027,  8, 15).julian(),
			DateUtil.CreateFromYMD (2028,  8, 15).julian(),
			DateUtil.CreateFromYMD (2029,  8, 15).julian(),
			DateUtil.CreateFromYMD (2030,  8, 15).julian(),
			DateUtil.CreateFromYMD (2031,  8, 15).julian(),
			DateUtil.CreateFromYMD (2032,  8, 15).julian(),
			DateUtil.CreateFromYMD (2033,  8, 15).julian(),
			DateUtil.CreateFromYMD (2034,  8, 15).julian(),
			DateUtil.CreateFromYMD (2035,  8, 15).julian(),
		};
