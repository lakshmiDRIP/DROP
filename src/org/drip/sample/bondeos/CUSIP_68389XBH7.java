...
/**
 * CUSIP_68389XBH7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 68389XBH7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_68389XBH7 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  7,  7);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2036,  7, 15);
		double dblCoupon = 0.03850;
		double dblCleanPrice = 0.96124;
		int iFreq = 2;
		String strCUSIP = "68389XBH7";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2036,  1, 15).julian(),
		};
