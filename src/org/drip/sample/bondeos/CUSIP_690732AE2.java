...
/**
 * CUSIP_690732AE2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 690732AE2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_690732AE2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  9, 16);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024, 12, 15);
		double dblCoupon = 0.04375;
		double dblCleanPrice = 1.00203125;
		int iFreq = 2;
		String strCUSIP = "690732AE2";
