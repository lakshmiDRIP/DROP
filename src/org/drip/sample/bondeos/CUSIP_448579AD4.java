...
/**
 * CUSIP_448579AD4 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 448579AD4.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_448579AD4 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2011,  8,  9);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2021,  8, 15);
		double dblCoupon = 0.05375;
		double dblCleanPrice = 1.088883;
		int iFreq = 2;
		String strCUSIP = "448579AD4";
