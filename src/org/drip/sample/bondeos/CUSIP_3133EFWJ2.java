...
/**
 * CUSIP_3133EFWJ2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3133EFWJ2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3133EFWJ2 {
		...
		throws Exception
	{
		...
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2031,  1, 27);
		double dblCoupon = 0.0339;
		double dblCleanPrice = 0.9837628;
		int iFreq = 2;
		String strCUSIP = "3133EFWJ2";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2011,  1, 27).julian(),
		};
