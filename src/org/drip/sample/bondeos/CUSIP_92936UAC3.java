...
/**
 * CUSIP_92936UAC3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 92936UAC3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_92936UAC3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  1, 26);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2025,  2,  1);
		double dblCoupon = 0.04000;
		double dblCleanPrice = 0.9769282;
		int iFreq = 2;
		String strCUSIP = "92936UAC3";
