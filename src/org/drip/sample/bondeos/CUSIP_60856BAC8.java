...
/**
 * CUSIP_60856BAC8 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 60856BAC8.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_60856BAC8 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  4,  7);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2025,  4, 15);
		double dblCoupon = 0.03900;
		double dblCleanPrice = 0.9831502;
		int iFreq = 2;
		String strCUSIP = "60856BAC8";
