...
/**
 * CUSIP_3133EF4M6 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3133EF4M6.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3133EF4M6 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  4, 21);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2033,  4, 21);
		double dblCoupon = 0.0300;
		double dblCleanPrice = 0.9356647;
		int iFreq = 2;
		String strCUSIP = "3133EF4M6";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2017,  4, 21).julian(),
		};
