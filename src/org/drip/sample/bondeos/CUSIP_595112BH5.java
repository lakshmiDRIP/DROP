...
/**
 * CUSIP_595112BH5 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 595112BH5.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_595112BH5 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  4, 26);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2023,  9, 15);
		double dblCoupon = 0.07500;
		double dblCleanPrice = 1.1094800;
		int iFreq = 2;
		String strCUSIP = "595112BH5";
