...
/**
 * CUSIP_76221TDG1 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 76221TDG1.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_76221TDG1 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014, 10, 30);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2034, 10,  1);
		double dblCoupon = 0.04433;
		double dblCleanPrice = 0.9618405;
		int iFreq = 2;
		String strCUSIP = "76221TDG1";
