...
/**
 * CUSIP_801495C59 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 801495C59.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_801495C59 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2011,  7,  1);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2034,  7,  1);
		double dblCoupon = 0.05000;
		double dblCleanPrice = 1.112;
		int iFreq = 2;
		String strCUSIP = "801495C59";
