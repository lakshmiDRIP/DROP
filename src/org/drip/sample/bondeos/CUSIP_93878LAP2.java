...
/**
 * CUSIP_93878LAP2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 93878LAP2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_93878LAP2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010, 10, 26);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2040, 10,  1);
		double dblCoupon = 0.07;
		double dblCleanPrice = 1.135498;
		int iFreq = 2;
		String strCUSIP = "93878LAP2";
		...
		int[] aiExerciseDate = new int[] {
			...
			DateUtil.CreateFromYMD (2039, 10,  1).julian(),
		};
