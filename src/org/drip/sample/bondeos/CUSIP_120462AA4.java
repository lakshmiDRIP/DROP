...
/**
 * CUSIP_120462AA4 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 120462AA4.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_120462AA4 {
		...
		throws Exception
	{
		...
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2017, 12, 15);
		double dblCoupon = 0.09000;
		double dblCleanPrice = 0.9775000;
		int iFreq = 2;
		String strCUSIP = "120462AA4";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2014, 12, 15).julian(),
			DateUtil.CreateFromYMD (2015, 12, 15).julian(),
			DateUtil.CreateFromYMD (2016, 12, 15).julian(),
		};
