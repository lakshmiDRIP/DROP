...
/**
 * CUSIP_36164YAA9 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 36164YAA9.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_36164YAA9 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  1, 27);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2023,  2,  1);
		double dblCoupon = 0.0950;
		double dblCleanPrice = 1.132500;
		int iFreq = 2;
		String strCUSIP = "36164YAA9";
