...
/**
 * CUSIP_3136G0W23 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3136G0W23.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3136G0W23 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2012, 10, 30);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2020,  4, 30);
		double dblCoupon = 0.0150;
		double dblCleanPrice = 0.9880542;
		int iFreq = 2;
		String strCUSIP = "3136G0W23";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2014, 10, 30).julian(),
		};
