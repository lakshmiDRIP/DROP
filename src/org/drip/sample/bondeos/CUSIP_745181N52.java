...
/**
 * CUSIP_745181N52 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 745181N52.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_745181N52 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2003,  4, 29);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2026,  7,  1);
		double dblCoupon = 0.0495;
		double dblCleanPrice = 1.03151;
		int iFreq = 2;
		String strCUSIP = "745181N52";
