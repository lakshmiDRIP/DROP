...
/**
 * CUSIP_48203RAJ3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 48203RAJ3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_48203RAJ3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  3, 14);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2025,  6, 15);
		double dblCoupon = 0.04350;
		double dblCleanPrice = 1.0080600;
		int iFreq = 2;
		String strCUSIP = "48203RAJ3";
