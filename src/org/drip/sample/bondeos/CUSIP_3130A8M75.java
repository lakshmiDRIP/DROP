...
/**
 * CUSIP_3130A8M75 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3130A8M75.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3130A8M75 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  7, 11);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2031,  7, 11);
		double dblCoupon = 0.0275;
		double dblCleanPrice = 0.9248600;
		int iFreq = 2;
		String strCUSIP = "3130A8M75";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2017,  7, 11).julian(),
		};
