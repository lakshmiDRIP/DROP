...
/**
 * CUSIP_40537QAH3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 40537QAH3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_40537QAH3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  5,  1);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2020,  2,  1);
		double dblCoupon = 0.08625;
		double dblCleanPrice = 1.043707;
		int iFreq = 2;
		String strCUSIP = "40537QAH3";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2017,  2,  1).julian(),
