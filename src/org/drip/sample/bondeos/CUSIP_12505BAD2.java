...
/**
 * CUSIP_12505BAD2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 12505BAD2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_12505BAD2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  8, 13);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2026,  3,  1);
		double dblCoupon = 0.04875;
		double dblCleanPrice = 1.03074;
		int iFreq = 2;
		String strCUSIP = "12505BAD2";
