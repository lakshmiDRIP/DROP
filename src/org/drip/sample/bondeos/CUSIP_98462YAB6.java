...
/**
 * CUSIP_98462YAB6 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 98462YAB6.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_98462YAB6 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014, 11, 20);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024,  7, 15);
		double dblCoupon = 0.04950;
		double dblCleanPrice = 1.0065800;
		int iFreq = 2;
		String strCUSIP = "98462YAB6";
