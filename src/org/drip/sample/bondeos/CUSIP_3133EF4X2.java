...
/**
 * CUSIP_3133EF4X2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3133EF4X2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3133EF4X2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  4, 29);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2036,  4, 29);
		double dblCoupon = 0.0300;
		double dblCleanPrice = 0.9187852;
		int iFreq = 2;
		String strCUSIP = "3133EF4X2";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2019,  4, 29).julian(),
		};
