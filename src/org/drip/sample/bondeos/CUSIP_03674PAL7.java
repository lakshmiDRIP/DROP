...
/**
 * CUSIP_03674PAL7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 03674PAL7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_03674PAL7 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  5, 23);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2021, 11,  1);
		double dblCoupon = 0.05375;
		double dblCleanPrice = 1.0150000;
		int iFreq = 2;
		String strCUSIP = "03674PAL7";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2016, 11,  1).julian(),
			DateUtil.CreateFromYMD (2017, 11,  1).julian(),
			DateUtil.CreateFromYMD (2018, 11,  1).julian(),
			DateUtil.CreateFromYMD (2019, 11,  1).julian(),
