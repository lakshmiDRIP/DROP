...
/**
 * CUSIP_87264AAQ8 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 87264AAQ8.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_87264AAQ8 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  4,  1);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024,  4, 15);
		double dblCoupon = 0.06000;
		double dblCleanPrice = 1.051568;
		int iFreq = 2;
		String strCUSIP = "87264AAQ8";
