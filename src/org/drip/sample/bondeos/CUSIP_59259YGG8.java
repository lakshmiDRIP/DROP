...
/**
 * CUSIP_59259YGG8 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 59259YGG8.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_59259YGG8 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010, 12, 29);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2030, 11, 15);
		double dblCoupon = 0.07134;
		double dblCleanPrice = 1.135;
		int iFreq = 2;
		String strCUSIP = "59259YGG8";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2020, 11, 15).julian(),
			DateUtil.CreateFromYMD (2021, 11, 15).julian(),
			DateUtil.CreateFromYMD (2022, 11, 15).julian(),
			DateUtil.CreateFromYMD (2023, 11, 15).julian(),
			DateUtil.CreateFromYMD (2024, 11, 15).julian(),
			DateUtil.CreateFromYMD (2025, 11, 15).julian(),
			DateUtil.CreateFromYMD (2026, 11, 15).julian(),
			DateUtil.CreateFromYMD (2027, 11, 15).julian(),
			DateUtil.CreateFromYMD (2028, 11, 15).julian(),
			DateUtil.CreateFromYMD (2029, 11, 15).julian(),
		};
