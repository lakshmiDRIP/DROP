...
/**
 * CUSIP_552697AQ7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 552697AQ7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_552697AQ7 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  3, 23);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024,  5,  1);
		double dblCoupon = 0.0650;
		double dblCleanPrice = 0.9550000;
		int iFreq = 2;
		String strCUSIP = "552697AQ7";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2019,  5,  1).julian(),
