...
/**
 * CUSIP_06652KAA1 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 06652KAA1.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_06652KAA1 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015, 11, 17);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2025, 11, 17);
		double dblCoupon = 0.04875;
		double dblCleanPrice = 0.9956155;
		int iFreq = 2;
		String strCUSIP = "06652KAA1";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2025,  8, 17).julian(),
		};
