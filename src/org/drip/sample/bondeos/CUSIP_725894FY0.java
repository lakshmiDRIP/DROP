...
/**
 * CUSIP_725894FY0 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 725894FY0.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_725894FY0 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2009, 10, 21);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2034,  8,  1);
		double dblCoupon = 0.06650;
		double dblCleanPrice = 1.0921045;
		int iFreq = 2;
		String strCUSIP = "725894FY0";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2019,  8,  1).julian(),
