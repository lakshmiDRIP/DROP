...
/**
 * CUSIP_40434JAD2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 40434JAD2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_40434JAD2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  1, 30);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2019,  7, 15);
		double dblCoupon = 0.07875;
		double dblCleanPrice = 1.0446000;
		int iFreq = 2;
		String strCUSIP = "40434JAD2";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2016,  1, 15).julian(),
			DateUtil.CreateFromYMD (2017,  1, 15).julian(),
