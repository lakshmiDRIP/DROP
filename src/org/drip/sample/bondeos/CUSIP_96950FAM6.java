...
/**
 * CUSIP_96950FAM6 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 96950FAM6.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_96950FAM6 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  3,  4);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024,  3,  4);
		double dblCoupon = 0.04300;
		double dblCleanPrice = 1.01614;
		int iFreq = 2;
		String strCUSIP = "96950FAM6";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2023, 12,  4).julian(),
		};
