...
/**
 * CUSIP_672325WR4 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 672325WR4.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_672325WR4 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2012,  3, 21);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2033,  8,  1);
		double dblCoupon = 0.06877;
		double dblCleanPrice = 1.12;
		int iFreq = 2;
		String strCUSIP = "672325WR4";
