...
/**
 * CUSIP_798755EP5 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 798755EP5.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_798755EP5 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  5, 15);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2036,  8,  1);
		double dblCoupon = 0.;
		double dblCleanPrice = 0.4019465;
		int iFreq = 2;
		String strCUSIP = "798755EP5";
