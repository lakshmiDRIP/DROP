...
/**
 * CUSIP_544495WB6 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 544495WB6.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_544495WB6 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010, 12, 14);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2041,  7,  1);
		double dblCoupon = 0.07003;
		double dblCleanPrice = 1.1439200;
		int iFreq = 2;
		String strCUSIP = "544495WB6";
