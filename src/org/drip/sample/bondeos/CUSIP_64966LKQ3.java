...
/**
 * CUSIP_64966LKQ3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 64966LKQ3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_64966LKQ3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  3, 25);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2026,  3,  1);
		double dblCoupon = 0.05000;
		double dblCleanPrice = 1.16088;
		int iFreq = 2;
		String strCUSIP = "64966LKQ3";
