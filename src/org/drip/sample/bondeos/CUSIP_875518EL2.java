...
/**
 * CUSIP_875518EL2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 875518EL2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_875518EL2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2009, 10,  8);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2042,  2,  1);
		double dblCoupon = 0.07200;
		double dblCleanPrice = 1.0750000;
		int iFreq = 2;
		String strCUSIP = "875518EL2";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2020,  2,  1).julian(),
			DateUtil.CreateFromYMD (2021,  2,  1).julian(),
			DateUtil.CreateFromYMD (2022,  2,  1).julian(),
			DateUtil.CreateFromYMD (2023,  2,  1).julian(),
			DateUtil.CreateFromYMD (2024,  2,  1).julian(),
			DateUtil.CreateFromYMD (2025,  2,  1).julian(),
			DateUtil.CreateFromYMD (2026,  2,  1).julian(),
			DateUtil.CreateFromYMD (2027,  2,  1).julian(),
			DateUtil.CreateFromYMD (2028,  2,  1).julian(),
			DateUtil.CreateFromYMD (2029,  2,  1).julian(),
			DateUtil.CreateFromYMD (2030,  2,  1).julian(),
			DateUtil.CreateFromYMD (2031,  2,  1).julian(),
			DateUtil.CreateFromYMD (2032,  2,  1).julian(),
			DateUtil.CreateFromYMD (2033,  2,  1).julian(),
			DateUtil.CreateFromYMD (2034,  2,  1).julian(),
			DateUtil.CreateFromYMD (2035,  2,  1).julian(),
			DateUtil.CreateFromYMD (2036,  2,  1).julian(),
			DateUtil.CreateFromYMD (2037,  2,  1).julian(),
			DateUtil.CreateFromYMD (2038,  2,  1).julian(),
			DateUtil.CreateFromYMD (2039,  2,  1).julian(),
			DateUtil.CreateFromYMD (2040,  2,  1).julian(),
			DateUtil.CreateFromYMD (2041,  2,  1).julian(),
		};
