...
/**
 * CUSIP_891279BF7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 891279BF7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_891279BF7 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010, 12, 28);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2028, 12,  1);
		double dblCoupon = 0.07000;
		double dblCleanPrice = 1.1288335;
		int iFreq = 2;
		String strCUSIP = "891279BF7";
