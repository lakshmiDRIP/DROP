...
/**
 * CUSIP_880812AB8 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 880812AB8.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_880812AB8 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (1944, 10, 28);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2019,  7,  1);
		double dblCoupon = 0.0400;
		double dblCleanPrice = 0.953125;
		int iFreq = 2;
		String strCUSIP = "880812AB8";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (1985,  7,  1).julian(),
		};
