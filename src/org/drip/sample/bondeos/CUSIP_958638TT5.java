...
/**
 * CUSIP_958638TT5 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 958638TT5.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_958638TT5 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2013, 10, 15);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2030, 11, 15);
		double dblCoupon = 0.0525;
		double dblCleanPrice = 1.1275555;
		int iFreq = 2;
		String strCUSIP = "958638TT5";
