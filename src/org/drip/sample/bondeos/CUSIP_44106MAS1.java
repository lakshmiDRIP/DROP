...
/**
 * CUSIP_44106MAS1 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 44106MAS1.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_44106MAS1 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  3, 12);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024,  3, 15);
		double dblCoupon = 0.04650;
		double dblCleanPrice = 1.0148880;
		int iFreq = 2;
		String strCUSIP = "44106MAS1";
