...
/**
 * CUSIP_037833BW9 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 037833BW9.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_037833BW9 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  2, 23);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2036,  2, 23);
		double dblCoupon = 0.04500;
		double dblCleanPrice = 1.0655100;
		int iFreq = 2;
		String strCUSIP = "037833BW9";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2035,  8, 23).julian(),
		};
