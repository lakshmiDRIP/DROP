...
/**
 * CUSIP_785592AE6 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 785592AE6.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_785592AE6 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  3, 17);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2021,  2,  1);
		double dblCoupon = 0.05625;
		double dblCleanPrice = 1.0750000;
		int iFreq = 2;
		String strCUSIP = "785592AE6";
