...
/**
 * CUSIP_494787DF8 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 494787DF8.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_494787DF8 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010,  6, 23);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2040,  6, 15);
		double dblCoupon = 0.08000;
		double dblCleanPrice = 1.1257020;
		int iFreq = 2;
		String strCUSIP = "494787DF8";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2019,  6, 15).julian(),
			DateUtil.CreateFromYMD (2020,  6, 15).julian(),
			DateUtil.CreateFromYMD (2021,  6, 15).julian(),
			DateUtil.CreateFromYMD (2022,  6, 15).julian(),
			DateUtil.CreateFromYMD (2023,  6, 15).julian(),
			DateUtil.CreateFromYMD (2024,  6, 15).julian(),
			DateUtil.CreateFromYMD (2025,  6, 15).julian(),
			DateUtil.CreateFromYMD (2026,  6, 15).julian(),
			DateUtil.CreateFromYMD (2027,  6, 15).julian(),
			DateUtil.CreateFromYMD (2028,  6, 15).julian(),
			DateUtil.CreateFromYMD (2029,  6, 15).julian(),
			DateUtil.CreateFromYMD (2030,  6, 15).julian(),
			DateUtil.CreateFromYMD (2031,  6, 15).julian(),
			DateUtil.CreateFromYMD (2032,  6, 15).julian(),
			DateUtil.CreateFromYMD (2033,  6, 15).julian(),
			DateUtil.CreateFromYMD (2034,  6, 15).julian(),
			DateUtil.CreateFromYMD (2035,  6, 15).julian(),
			DateUtil.CreateFromYMD (2036,  6, 15).julian(),
			DateUtil.CreateFromYMD (2037,  6, 15).julian(),
			DateUtil.CreateFromYMD (2038,  6, 15).julian(),
			DateUtil.CreateFromYMD (2039,  6, 15).julian(),
		};
