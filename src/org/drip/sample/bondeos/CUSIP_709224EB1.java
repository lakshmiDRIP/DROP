...
/**
 * CUSIP_709224EB1 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 709224EB1.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_709224EB1 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  5, 20);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2017, 12,  1);
		double dblCoupon = 0.01070;
		double dblCleanPrice = 1.0026265;
		int iFreq = 12;
		String strCUSIP = "709224EB1";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2017,  6,  1).julian(),
		};
