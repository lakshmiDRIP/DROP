...
/**
 * CUSIP_70870ECB3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 70870ECB3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_70870ECB3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2013, 12, 23);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2049,  1,  1);
		double dblCoupon = 0.000;
		double dblCleanPrice = 0.138762;
		int iFreq = 2;
		String strCUSIP = "70870ECB3";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2029,  1,  1).julian(),
			DateUtil.CreateFromYMD (2030,  1,  1).julian(),
			DateUtil.CreateFromYMD (2031,  1,  1).julian(),
			DateUtil.CreateFromYMD (2032,  1,  1).julian(),
			DateUtil.CreateFromYMD (2033,  1,  1).julian(),
			DateUtil.CreateFromYMD (2034,  1,  1).julian(),
			DateUtil.CreateFromYMD (2035,  1,  1).julian(),
			DateUtil.CreateFromYMD (2036,  1,  1).julian(),
			DateUtil.CreateFromYMD (2037,  1,  1).julian(),
			DateUtil.CreateFromYMD (2038,  1,  1).julian(),
			DateUtil.CreateFromYMD (2039,  1,  1).julian(),
			DateUtil.CreateFromYMD (2040,  1,  1).julian(),
			DateUtil.CreateFromYMD (2041,  1,  1).julian(),
			DateUtil.CreateFromYMD (2042,  1,  1).julian(),
			DateUtil.CreateFromYMD (2043,  1,  1).julian(),
			DateUtil.CreateFromYMD (2044,  1,  1).julian(),
			DateUtil.CreateFromYMD (2045,  1,  1).julian(),
			DateUtil.CreateFromYMD (2046,  1,  1).julian(),
			DateUtil.CreateFromYMD (2047,  1,  1).julian(),
			DateUtil.CreateFromYMD (2048,  1,  1).julian(),
		};
