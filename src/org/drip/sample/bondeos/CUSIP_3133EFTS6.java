...
/**
 * CUSIP_3133EFTS6 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3133EFTS6.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3133EFTS6 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015, 12, 23);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2030, 12, 23);
		double dblCoupon = 0.0353;
		double dblCleanPrice = 0.9965218;
		int iFreq = 2;
		String strCUSIP = "3133EFTS6";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2016, 12, 23).julian(),
		};
