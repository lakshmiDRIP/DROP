...
/**
 * CUSIP_23311VAB3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 23311VAB3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_23311VAB3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2012,  3, 13);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2022,  4,  1);
		double dblCoupon = 0.0495;
		double dblCleanPrice = 1.02375;
		int iFreq = 2;
		String strCUSIP = "23311VAB3";
