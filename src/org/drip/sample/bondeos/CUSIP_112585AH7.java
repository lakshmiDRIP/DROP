...
/**
 * CUSIP_112585AH7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 112585AH7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_112585AH7 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  1, 15);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2025,  1, 15);
		double dblCoupon = 0.0400;
		double dblCleanPrice = 0.9847170;
		int iFreq = 2;
		String strCUSIP = "112585AH7";
