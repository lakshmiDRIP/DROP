...
/**
 * Qinghuangdao demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation for
 *  Qinghuangdao.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class Qinghuangdao {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  2, 24);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2025,  2, 15);
		double dblCoupon = 0.04350;
		double dblCleanPrice = 1.0166100;
		int iFreq = 2;
		String strCUSIP = "Qinghuangdao";
