...
/**
 * CUSIP_3133EDUA8 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3133EDUA8.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3133EDUA8 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  9,  5);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2034,  9,  5);
		double dblCoupon = 0.0394;
		double dblCleanPrice = 0.9994046;
		int iFreq = 2;
		String strCUSIP = "3133EDUA8";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2017,  9,  5).julian(),
		};
