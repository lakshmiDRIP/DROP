...
/**
 * CUSIP_03834AAA1 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 03834AAA1.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_03834AAA1 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2013,  6, 11);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2021,  6, 15);
		double dblCoupon = 0.07000;
		double dblCleanPrice = 0.8681250;
		int iFreq = 2;
		String strCUSIP = "03834AAA1";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2016,  6, 15).julian(),
			DateUtil.CreateFromYMD (2017,  6, 15).julian(),
			DateUtil.CreateFromYMD (2018,  6, 15).julian(),
