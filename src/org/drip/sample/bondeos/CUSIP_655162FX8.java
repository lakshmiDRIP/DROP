...
/**
 * CUSIP_655162FX8 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 655162FX8.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_655162FX8 {
		...
		throws Exception
	{
		...
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2030,  7, 15);
		double dblCoupon = 0.06500;
		double dblCleanPrice = 1.1319190;
		int iFreq = 2;
		String strCUSIP = "655162FX8";
		...
		int[] aiExerciseDate = new int[] {
			...
			DateUtil.CreateFromYMD (2028,  1, 15).julian(),
			DateUtil.CreateFromYMD (2029,  1, 15).julian(),
			DateUtil.CreateFromYMD (2030,  1, 15).julian(),
		};
