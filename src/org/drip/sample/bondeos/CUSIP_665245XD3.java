...
/**
 * CUSIP_665245XD3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 665245XD3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_665245XD3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010, 12, 16);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2041,  4,  1);
		double dblCoupon = 0.08147;
		double dblCleanPrice = 1.1340000;
		int iFreq = 2;
		String strCUSIP = "665245XD3";
		...
		int[] aiExerciseDate = new int[] {
			...
			DateUtil.CreateFromYMD (2023,  4,  1).julian(),
			DateUtil.CreateFromYMD (2024,  4,  1).julian(),
			DateUtil.CreateFromYMD (2025,  4,  1).julian(),
			DateUtil.CreateFromYMD (2026,  4,  1).julian(),
			DateUtil.CreateFromYMD (2027,  4,  1).julian(),
			DateUtil.CreateFromYMD (2028,  4,  1).julian(),
			DateUtil.CreateFromYMD (2029,  4,  1).julian(),
			DateUtil.CreateFromYMD (2030,  4,  1).julian(),
			DateUtil.CreateFromYMD (2031,  4,  1).julian(),
			DateUtil.CreateFromYMD (2032,  4,  1).julian(),
			DateUtil.CreateFromYMD (2033,  4,  1).julian(),
			DateUtil.CreateFromYMD (2034,  4,  1).julian(),
			DateUtil.CreateFromYMD (2035,  4,  1).julian(),
			DateUtil.CreateFromYMD (2036,  4,  1).julian(),
			DateUtil.CreateFromYMD (2037,  4,  1).julian(),
			DateUtil.CreateFromYMD (2038,  4,  1).julian(),
			DateUtil.CreateFromYMD (2039,  4,  1).julian(),
			DateUtil.CreateFromYMD (2040,  4,  1).julian(),
		};
