...
/**
 * CUSIP_496902AJ6 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 496902AJ6.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_496902AJ6 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2012,  6, 18);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2021,  9,  1);
		double dblCoupon = 0.05125;
		double dblCleanPrice = 1.02875;
		int iFreq = 2;
		String strCUSIP = "496902AJ6";
