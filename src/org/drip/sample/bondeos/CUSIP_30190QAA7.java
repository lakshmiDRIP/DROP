...
/**
 * CUSIP_30190QAA7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 30190QAA7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_30190QAA7 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  8,  9);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2021,  8, 15);
		double dblCoupon = 0.0825;
		double dblCleanPrice = 1.0595;
		int iFreq = 2;
		String strCUSIP = "30190QAA7";
