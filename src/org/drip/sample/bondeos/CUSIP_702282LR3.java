...
/**
 * CUSIP_702282LR3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 702282LR3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_702282LR3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2009,  9, 17);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2034,  8,  1);
		double dblCoupon = 0.07193;
		double dblCleanPrice = 1.10355;
		int iFreq = 2;
		String strCUSIP = "702282LR3";
