...
/**
 * CUSIP_428291AM0 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 428291AM0.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_428291AM0 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  8,  3);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2025,  8, 15);
		double dblCoupon = 0.04700;
		double dblCleanPrice = 1.0496700;
		int iFreq = 2;
		String strCUSIP = "428291AM0";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2025,  5, 15).julian(),
		};
