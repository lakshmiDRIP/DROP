...
/**
 * CUSIP_605360RV0 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 605360RV0.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_605360RV0 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2010, 11, 17);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2040,  1,  1);
		double dblCoupon = 0.07390;
		double dblCleanPrice = 1.0652045;
		int iFreq = 2;
		String strCUSIP = "605360RV0";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2020,  1,  1).julian(),
			DateUtil.CreateFromYMD (2021,  1,  1).julian(),
			DateUtil.CreateFromYMD (2022,  1,  1).julian(),
			DateUtil.CreateFromYMD (2023,  1,  1).julian(),
			DateUtil.CreateFromYMD (2024,  1,  1).julian(),
			DateUtil.CreateFromYMD (2025,  1,  1).julian(),
			DateUtil.CreateFromYMD (2026,  1,  1).julian(),
			DateUtil.CreateFromYMD (2027,  1,  1).julian(),
			DateUtil.CreateFromYMD (2028,  1,  1).julian(),
