...
/**
 * CUSIP_92933BAH7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 92933BAH7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_92933BAH7 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  4,  9);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2022,  4, 15);
		double dblCoupon = 0.0675;
		double dblCleanPrice = 1.051250;
		int iFreq = 2;
		String strCUSIP = "92933BAH7";
