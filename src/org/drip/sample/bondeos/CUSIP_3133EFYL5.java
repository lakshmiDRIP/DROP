...
/**
 * CUSIP_3133EFYL5 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3133EFYL5.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3133EFYL5 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  2, 11);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2031,  2, 11);
		double dblCoupon = 0.0304;
		double dblCleanPrice = 0.9544551;
		int iFreq = 2;
		String strCUSIP = "3133EFYL5";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2019,  2, 11).julian(),
		};
