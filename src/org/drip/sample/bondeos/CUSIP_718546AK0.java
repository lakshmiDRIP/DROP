...
/**
 * CUSIP_718546AK0 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 718546AK0.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_718546AK0 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014, 11, 17);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2034, 11, 15);
		double dblCoupon = 0.04650;
		double dblCleanPrice = 1.0092700;
		int iFreq = 2;
		String strCUSIP = "718546AK0";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2034,  5, 15).julian(),
		};
