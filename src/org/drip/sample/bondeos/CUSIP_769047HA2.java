...
/**
 * CUSIP_769047HA2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 769047HA2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_769047HA2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2009,  8, 20);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2029,  8,  1);
		double dblCoupon = 0.07000;
		double dblCleanPrice = 1.0968200;
		int iFreq = 2;
		String strCUSIP = "769047HA2";
