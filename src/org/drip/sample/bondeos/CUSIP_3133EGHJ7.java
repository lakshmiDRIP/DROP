...
/**
 * CUSIP_3133EGHJ7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3133EGHJ7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3133EGHJ7 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  6, 28);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2032,  6, 28);
		double dblCoupon = 0.0290;
		double dblCleanPrice = 0.9337558;
		int iFreq = 2;
		String strCUSIP = "3133EGHJ7";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2017,  6, 28).julian(),
		};
