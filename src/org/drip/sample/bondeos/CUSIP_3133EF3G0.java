...
/**
 * CUSIP_3133EF3G0 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3133EF3G0.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3133EF3G0 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  4, 18);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2036,  4, 18);
		double dblCoupon = 0.0314;
		double dblCleanPrice = 0.9346243;
		int iFreq = 2;
		String strCUSIP = "3133EF3G0";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2017,  4, 18).julian(),
		};
