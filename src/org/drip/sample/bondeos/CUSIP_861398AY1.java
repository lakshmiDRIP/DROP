...
/**
 * CUSIP_861398AY1 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 861398AY1.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_861398AY1 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2009,  8, 27);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2038, 10,  1);
		double dblCoupon = 0.07942;
		double dblCleanPrice = 1.1138450;
		int iFreq = 2;
		String strCUSIP = "861398AY1";
