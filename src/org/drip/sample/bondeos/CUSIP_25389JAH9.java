...
/**
 * CUSIP_25389JAH9 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 25389JAH9.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_25389JAH9 {
		...
		throws Exception
	{
		...
		double dblCleanPrice = 1.0840710;
		int iFreq = 2;
		String strCUSIP = "25389JAH9";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2019, 11,  3).julian(),
		};
