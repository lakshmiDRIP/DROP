...
/**
 * CUSIP_86765BAN9 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 86765BAN9.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_86765BAN9 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  4,  3);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024,  4,  1);
		double dblCoupon = 0.04250;
		double dblCleanPrice = 1.0068900;
		int iFreq = 2;
		String strCUSIP = "86765BAN9";
