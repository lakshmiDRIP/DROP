...
/**
 * CUSIP_95332RAQ2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 95332RAQ2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_95332RAQ2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2009,  7, 15);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2039,  2,  1);
		double dblCoupon = 0.08250;
		double dblCleanPrice = 1.098816;
		int iFreq = 2;
		String strCUSIP = "95332RAQ2";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2019,  2,  1).julian(),
