...
/**
 * CUSIP_251256CB7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 251256CB7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_251256CB7 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2011, 12, 22);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2041,  7,  1);
		double dblCoupon = 0.05000;
		double dblCleanPrice = 1.0489660;
		int iFreq = 2;
		String strCUSIP = "251256CB7";
