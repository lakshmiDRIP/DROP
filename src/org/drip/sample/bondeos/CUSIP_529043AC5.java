...
/**
 * CUSIP_529043AC5 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 529043AC5.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_529043AC5 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  3, 14);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2023,  6, 15);
		double dblCoupon = 0.04250;
		double dblCleanPrice = 0.9787289;
		int iFreq = 2;
		String strCUSIP = "529043AC5";
