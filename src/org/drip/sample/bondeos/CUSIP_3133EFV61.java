...
/**
 * CUSIP_3133EFV61 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3133EFV61.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3133EFV61 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  3, 29);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2030,  3, 29);
		double dblCoupon = 0.0299;
		double dblCleanPrice = 0.9542820;
		int iFreq = 2;
		String strCUSIP = "3133EFV61";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2017,  3, 29).julian(),
		};
