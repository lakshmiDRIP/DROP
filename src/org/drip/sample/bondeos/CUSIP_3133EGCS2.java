...
/**
 * CUSIP_3133EGCS2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3133EGCS2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3133EGCS2 {
		...
		throws Exception
	{
		...
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2036,  6,  2);
		double dblCoupon = 0.0313;
		double dblCleanPrice = 0.9326180;
		int iFreq = 2;
		String strCUSIP = "3133EGCS2";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2017,  6,  2).julian(),
		};
