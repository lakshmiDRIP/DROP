...
/**
 * Zhangjiagang demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation for
 *  Zhangjiagang.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class Zhangjiagang {
		...
		throws Exception
	{
		...
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2030,  7,  1);
		double dblCoupon = 0.07600;
		double dblCleanPrice = 1.1628560;
		int iFreq = 2;
		String strCUSIP = "Zhangjiagang";
