...
/**
 * CUSIP_690742AE1 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 690742AE1.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_690742AE1 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014, 11, 12);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024, 12,  1);
		double dblCoupon = 0.04200;
		double dblCleanPrice = 1.0216160;
		int iFreq = 2;
		String strCUSIP = "690742AE1";
