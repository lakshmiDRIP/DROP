...
/**
 * CUSIP_205759GX5 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 205759GX5.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_205759GX5 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2011,  5, 18);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2026,  5,  1);
		double dblCoupon = 0.06300;
		double dblCleanPrice = 1.1203755;
		int iFreq = 2;
		String strCUSIP = "205759GX5";
