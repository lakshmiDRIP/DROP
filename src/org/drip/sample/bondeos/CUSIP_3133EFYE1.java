...
/**
 * CUSIP_3133EFYE1 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3133EFYE1.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3133EFYE1 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  2,  8);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2030,  2,  8);
		double dblCoupon = 0.0328;
		double dblCleanPrice = 0.9770663;
		int iFreq = 2;
		String strCUSIP = "3133EFYE1";
