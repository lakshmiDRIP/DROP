...
/**
 * CUSIP_015271AC3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 015271AC3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_015271AC3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2012,  2, 29);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2022,  4,  1);
		double dblCoupon = 0.04600;
		double dblCleanPrice = 1.0563140;
		int iFreq = 2;
		String strCUSIP = "015271AC3";
