...
/**
 * CUSIP_542403AC4 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 542403AC4.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_542403AC4 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2009, 12,  8);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2039,  6,  1);
		double dblCoupon = 0.07765;
		double dblCleanPrice = 1.1280785;
		int iFreq = 2;
		String strCUSIP = "542403AC4";
