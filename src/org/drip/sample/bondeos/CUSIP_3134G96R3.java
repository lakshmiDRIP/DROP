...
/**
 * CUSIP_3134G96R3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3134G96R3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3134G96R3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  8, 22);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2036,  8, 22);
		double dblCoupon = 0.0270;
		double dblCleanPrice = 0.8885426;
		int iFreq = 2;
		String strCUSIP = "3134G96R3";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2017,  8, 22).julian(),
			DateUtil.CreateFromYMD (2018,  2, 22).julian(),
			DateUtil.CreateFromYMD (2018,  8, 22).julian(),
			DateUtil.CreateFromYMD (2019,  2, 22).julian(),
			DateUtil.CreateFromYMD (2019,  8, 22).julian(),
			DateUtil.CreateFromYMD (2020,  2, 22).julian(),
			DateUtil.CreateFromYMD (2020,  8, 22).julian(),
			DateUtil.CreateFromYMD (2021,  2, 22).julian(),
			DateUtil.CreateFromYMD (2021,  8, 22).julian(),
			DateUtil.CreateFromYMD (2022,  2, 22).julian(),
			DateUtil.CreateFromYMD (2022,  8, 22).julian(),
			DateUtil.CreateFromYMD (2023,  2, 22).julian(),
			DateUtil.CreateFromYMD (2023,  8, 22).julian(),
			DateUtil.CreateFromYMD (2024,  2, 22).julian(),
			DateUtil.CreateFromYMD (2024,  8, 22).julian(),
			DateUtil.CreateFromYMD (2025,  2, 22).julian(),
			DateUtil.CreateFromYMD (2025,  8, 22).julian(),
			DateUtil.CreateFromYMD (2026,  2, 22).julian(),
			DateUtil.CreateFromYMD (2026,  8, 22).julian(),
			DateUtil.CreateFromYMD (2027,  2, 22).julian(),
			DateUtil.CreateFromYMD (2028,  8, 22).julian(),
			DateUtil.CreateFromYMD (2029,  2, 22).julian(),
			DateUtil.CreateFromYMD (2029,  8, 22).julian(),
			DateUtil.CreateFromYMD (2030,  2, 22).julian(),
			DateUtil.CreateFromYMD (2030,  8, 22).julian(),
			DateUtil.CreateFromYMD (2031,  2, 22).julian(),
			DateUtil.CreateFromYMD (2031,  8, 22).julian(),
			DateUtil.CreateFromYMD (2032,  2, 22).julian(),
			DateUtil.CreateFromYMD (2032,  8, 22).julian(),
			DateUtil.CreateFromYMD (2033,  2, 22).julian(),
			DateUtil.CreateFromYMD (2033,  8, 22).julian(),
			DateUtil.CreateFromYMD (2034,  2, 22).julian(),
			DateUtil.CreateFromYMD (2034,  8, 22).julian(),
			DateUtil.CreateFromYMD (2035,  2, 22).julian(),
			DateUtil.CreateFromYMD (2035,  8, 22).julian(),
			DateUtil.CreateFromYMD (2036,  2, 22).julian(),
			DateUtil.CreateFromYMD (2036,  8, 22).julian(),
			DateUtil.CreateFromYMD (2037,  2, 22).julian(),
		};
