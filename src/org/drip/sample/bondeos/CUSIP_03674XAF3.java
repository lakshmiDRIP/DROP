...
/**
 * CUSIP_03674XAF3 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 03674XAF3.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_03674XAF3 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  3,  4);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2023,  6,  1);
		double dblCoupon = 0.05625;
		double dblCleanPrice = 0.9975000;
		int iFreq = 2;
		String strCUSIP = "03674XAF3";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2018,  6,  1).julian(),
