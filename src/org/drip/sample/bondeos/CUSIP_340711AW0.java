...
/**
 * CUSIP_340711AW0 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 340711AW0.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_340711AW0 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  7, 15);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2025,  7, 15);
		double dblCoupon = 0.04350;
		double dblCleanPrice = 1.0274840;
		int iFreq = 2;
		String strCUSIP = "340711AW0";
