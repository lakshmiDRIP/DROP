...
/**
 * CUSIP_45656TCK2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 45656TCK2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_45656TCK2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015,  7,  1);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2027,  1,  1);
		double dblCoupon = 0.05044;
		double dblCleanPrice = 1.0355400;
		int iFreq = 2;
		String strCUSIP = "45656TCK2";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2018,  1,  1).julian(),
			DateUtil.CreateFromYMD (2018,  7,  1).julian(),
			DateUtil.CreateFromYMD (2019,  1,  1).julian(),
			DateUtil.CreateFromYMD (2019,  7,  1).julian(),
