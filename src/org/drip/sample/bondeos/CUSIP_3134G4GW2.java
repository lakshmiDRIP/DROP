...
/**
 * CUSIP_3134G4GW2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3134G4GW2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3134G4GW2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2013, 10, 11);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2033, 10, 11);
		double dblCoupon = 0.04125;
		double dblCleanPrice = 1.0223740;
		int iFreq = 2;
		String strCUSIP = "3134G4GW2";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2018, 10, 11).julian(),
			DateUtil.CreateFromYMD (2019,  1, 11).julian(),
			DateUtil.CreateFromYMD (2019,  4, 11).julian(),
			DateUtil.CreateFromYMD (2019,  7, 11).julian(),
			DateUtil.CreateFromYMD (2019, 10, 11).julian(),
			DateUtil.CreateFromYMD (2020,  1, 11).julian(),
			DateUtil.CreateFromYMD (2020,  4, 11).julian(),
			DateUtil.CreateFromYMD (2020,  7, 11).julian(),
			DateUtil.CreateFromYMD (2020, 10, 11).julian(),
			DateUtil.CreateFromYMD (2021,  1, 11).julian(),
			DateUtil.CreateFromYMD (2021,  4, 11).julian(),
			DateUtil.CreateFromYMD (2021,  7, 11).julian(),
			DateUtil.CreateFromYMD (2021, 10, 11).julian(),
			DateUtil.CreateFromYMD (2022,  1, 11).julian(),
			DateUtil.CreateFromYMD (2022,  4, 11).julian(),
			DateUtil.CreateFromYMD (2022,  7, 11).julian(),
			DateUtil.CreateFromYMD (2022, 10, 11).julian(),
			DateUtil.CreateFromYMD (2023,  1, 11).julian(),
			DateUtil.CreateFromYMD (2023,  4, 11).julian(),
			DateUtil.CreateFromYMD (2023,  7, 11).julian(),
			DateUtil.CreateFromYMD (2023, 10, 11).julian(),
			DateUtil.CreateFromYMD (2024,  1, 11).julian(),
			DateUtil.CreateFromYMD (2024,  4, 11).julian(),
			DateUtil.CreateFromYMD (2024,  7, 11).julian(),
			DateUtil.CreateFromYMD (2024, 10, 11).julian(),
			DateUtil.CreateFromYMD (2025,  1, 11).julian(),
			DateUtil.CreateFromYMD (2025,  4, 11).julian(),
			DateUtil.CreateFromYMD (2025,  7, 11).julian(),
			DateUtil.CreateFromYMD (2025, 10, 11).julian(),
			DateUtil.CreateFromYMD (2026,  1, 11).julian(),
			DateUtil.CreateFromYMD (2026,  4, 11).julian(),
			DateUtil.CreateFromYMD (2026,  7, 11).julian(),
			DateUtil.CreateFromYMD (2026, 10, 11).julian(),
			DateUtil.CreateFromYMD (2027,  1, 11).julian(),
			DateUtil.CreateFromYMD (2027,  4, 11).julian(),
			DateUtil.CreateFromYMD (2027,  7, 11).julian(),
			DateUtil.CreateFromYMD (2027, 10, 11).julian(),
			DateUtil.CreateFromYMD (2028,  1, 11).julian(),
			DateUtil.CreateFromYMD (2028,  4, 11).julian(),
			DateUtil.CreateFromYMD (2028,  7, 11).julian(),
			DateUtil.CreateFromYMD (2028, 10, 11).julian(),
			DateUtil.CreateFromYMD (2029,  1, 11).julian(),
			DateUtil.CreateFromYMD (2029,  4, 11).julian(),
			DateUtil.CreateFromYMD (2029,  7, 11).julian(),
			DateUtil.CreateFromYMD (2029, 10, 11).julian(),
			DateUtil.CreateFromYMD (2030,  1, 11).julian(),
			DateUtil.CreateFromYMD (2030,  4, 11).julian(),
			DateUtil.CreateFromYMD (2030,  7, 11).julian(),
			DateUtil.CreateFromYMD (2030, 10, 11).julian(),
			DateUtil.CreateFromYMD (2031,  1, 11).julian(),
			DateUtil.CreateFromYMD (2031,  4, 11).julian(),
			DateUtil.CreateFromYMD (2031,  7, 11).julian(),
			DateUtil.CreateFromYMD (2031, 10, 11).julian(),
			DateUtil.CreateFromYMD (2032,  1, 11).julian(),
			DateUtil.CreateFromYMD (2032,  4, 11).julian(),
			DateUtil.CreateFromYMD (2032,  7, 11).julian(),
			DateUtil.CreateFromYMD (2032, 10, 11).julian(),
			DateUtil.CreateFromYMD (2033,  1, 11).julian(),
			DateUtil.CreateFromYMD (2033,  4, 11).julian(),
			DateUtil.CreateFromYMD (2033,  7, 11).julian(),
		};
