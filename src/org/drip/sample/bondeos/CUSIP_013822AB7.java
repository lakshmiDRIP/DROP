...
/**
 * CUSIP_013822AB7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 013822AB7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_013822AB7 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  9, 27);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2026,  9, 30);
		double dblCoupon = 0.07000;
		double dblCleanPrice = 1.074400;
		int iFreq = 2;
		String strCUSIP = "013822AB7";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2021,  9, 30).julian(),
			DateUtil.CreateFromYMD (2022,  9, 30).julian(),
			DateUtil.CreateFromYMD (2023,  9, 30).julian(),
			DateUtil.CreateFromYMD (2024,  9, 30).julian(),
		};
