...
/**
 * CUSIP_3133EFUY1 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3133EFUY1.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3133EFUY1 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  1, 14);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2031,  1, 14);
		double dblCoupon = 0.0334;
		double dblCleanPrice = 0.9775545;
		int iFreq = 2;
		String strCUSIP = "3133EFUY1";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2019,  1, 14).julian(),
		};
