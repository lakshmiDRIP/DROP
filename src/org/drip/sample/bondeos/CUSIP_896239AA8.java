...
/**
 * CUSIP_896239AA8 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 896239AA8.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_896239AA8 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014, 11, 24);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024, 12,  1);
		double dblCoupon = 0.04750;
		double dblCleanPrice = 1.0336520;
		int iFreq = 2;
		String strCUSIP = "896239AA8";
