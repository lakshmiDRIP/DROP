...
/**
 * CUSIP_594918BK9 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 594918BK9.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_594918BK9 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015, 11,  3);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2035, 11,  3);
		double dblCoupon = 0.04200;
		double dblCleanPrice = 1.0233000;
		int iFreq = 2;
		String strCUSIP = "594918BK9";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2035,  5,  3).julian(),
		};
