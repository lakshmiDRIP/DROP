...
/**
 * CUSIP_3133EGAK1 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3133EGAK1.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3133EGAK1 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  5, 16);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2036,  5, 16);
		double dblCoupon = 0.0300;
		double dblCleanPrice = 0.9181512;
		int iFreq = 2;
		String strCUSIP = "3133EGAK1";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2019,  5, 16).julian(),
		};
