...
/**
 * CUSIP_00206RCP5 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 00206RCP5.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_00206RCP5 {
		...
		throws Exception
	{
		...
		double dblDurationOASTW = Double.NaN;
		...
		try {
			...
			dblDurationOASTW = (dblCleanPrice -
				bond.priceFromOAS (
					valParams,
					csqc,
					null,
		...
		System.out.println ("\t Bond Duration From OAS TW => " + FormatUtil.FormatDouble (dblDurationOASTW, 1, 4, 10000.));
		...
		throws Exception
	{
		...
		double dblCleanPrice = 0.9291000;
		int iFreq = 2;
