...
/**
 * CUSIP_3130A6VH7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3130A6VH7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3130A6VH7 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015, 12, 28);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2035, 12, 28);
		double dblCoupon = 0.0367;
		double dblCleanPrice = 0.9863401;
		int iFreq = 2;
		String strCUSIP = "3130A6VH7";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2016, 12, 28).julian(),
		};
