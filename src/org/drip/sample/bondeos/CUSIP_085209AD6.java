...
/**
 * CUSIP_085209AD6 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 085209AD6.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_085209AD6 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016, 10, 19);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2027,  1, 25);
		double dblCoupon = 0.03717;
		double dblCleanPrice = 0.9618167;
		int iFreq = 2;
		String strCUSIP = "085209AD6";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2026, 10, 25).julian(),
		};
