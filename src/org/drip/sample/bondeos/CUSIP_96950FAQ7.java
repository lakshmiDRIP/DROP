...
/**
 * CUSIP_96950FAQ7 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 96950FAQ7.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_96950FAQ7 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2014,  6, 27);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2025,  1, 15);
		double dblCoupon = 0.03900;
		double dblCleanPrice = 0.9849900;
		int iFreq = 2;
		String strCUSIP = "96950FAQ7";
