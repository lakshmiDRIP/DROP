...
/**
 * CUSIP_47232MAA0 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 47232MAA0.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_47232MAA0 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2013,  3, 26);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2020,  4,  1);
		double dblCoupon = 0.07375;
		double dblCleanPrice = 1.0200000;
		int iFreq = 2;
		String strCUSIP = "47232MAA0";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2016,  4,  1).julian(),
			DateUtil.CreateFromYMD (2017,  4,  1).julian(),
			DateUtil.CreateFromYMD (2018,  4,  1).julian(),
