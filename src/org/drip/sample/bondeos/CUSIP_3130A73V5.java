...
/**
 * CUSIP_3130A73V5 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3130A73V5.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3130A73V5 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  2,  1);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2036,  2,  1);
		double dblCoupon = 0.0356;
		double dblCleanPrice = 0.9780646;
		int iFreq = 2;
		String strCUSIP = "3130A73V5";
