...
/**
 * CUSIP_13063BJB9 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 13063BJB9.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_13063BJB9 {
		...
		throws Exception
	{
		...
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2030, 11,  1);
		double dblCoupon = 0.077;
		double dblCleanPrice = 1.16223;
		int iFreq = 2;
		String strCUSIP = "13063BJB9";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2020, 11,  1).julian(),
			DateUtil.CreateFromYMD (2021, 11,  1).julian(),
			DateUtil.CreateFromYMD (2022, 11,  1).julian(),
			DateUtil.CreateFromYMD (2023, 11,  1).julian(),
			DateUtil.CreateFromYMD (2024, 11,  1).julian(),
			DateUtil.CreateFromYMD (2025, 11,  1).julian(),
			DateUtil.CreateFromYMD (2026, 11,  1).julian(),
			DateUtil.CreateFromYMD (2027, 11,  1).julian(),
			DateUtil.CreateFromYMD (2028, 11,  1).julian(),
			DateUtil.CreateFromYMD (2029, 11,  1).julian(),
		};
