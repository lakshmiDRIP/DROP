...
/**
 * CUSIP_42217KBC9 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 42217KBC9.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_42217KBC9 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2013, 10,  7);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024,  1, 15);
		double dblCoupon = 0.04500;
		double dblCleanPrice = 1.0487800;
		int iFreq = 2;
		String strCUSIP = "42217KBC9";
