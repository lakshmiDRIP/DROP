...
/**
 * CUSIP_05565QDF2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 05565QDF2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_05565QDF2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2016,  9, 16);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2027,  1, 27);
		double dblCoupon = 0.03017;
		double dblCleanPrice = 0.9451100;
		int iFreq = 2;
		String strCUSIP = "05565QDF2";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2026, 10, 16).julian(),
		};
