...
/**
 * CUSIP_3133EFQM2 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 3133EFQM2.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_3133EFQM2 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2015, 11, 27);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2030, 11, 27);
		double dblCoupon = 0.0333;
		double dblCleanPrice = 0.9826487;
		int iFreq = 2;
		String strCUSIP = "3133EFQM2";
		String strDayCount = "30/360";
		int[] aiExerciseDate = new int[] {
			DateUtil.CreateFromYMD (2018, 11, 27).julian(),
		};
