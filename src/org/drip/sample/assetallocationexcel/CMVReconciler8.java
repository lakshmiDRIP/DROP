...
public class CMVReconciler8 {
		...
		throws Exception
	{
		...
		double dblPortfolioDesignReturn = 0.07500;
		...
		System.out.println ("\t| Optimal Portfolio Expected Return    : " + FormatUtil.FormatDouble (pfOptimal.optimalMetrics().excessReturnsStandardDeviation(), 2, 2, 100.) + "% ||");
