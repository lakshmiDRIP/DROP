...
/**
 * CUSIP_88031QAA8 demonstrates Sink Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 88031QAA8.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_88031QAA8 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2004,  5,  4);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024,  3, 30);
		double dblCoupon = 0.06119;
		double dblCleanPrice = 1.102304;
		int iFreq = 4;
		String strCUSIP = "88031QAA8";
