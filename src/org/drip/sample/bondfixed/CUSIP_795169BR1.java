...
/**
 * CUSIP_795169BR1 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 795169BR1.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_795169BR1 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2009, 11,  4);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2024, 11,  4);
		double dblCoupon = 0.0135;
		double dblCleanPrice = 1.06062;
		int iFreq = 2;
		String strCUSIP = "795169BR1";
