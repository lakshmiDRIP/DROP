...
/**
 * CUSIP_91913YAN0 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 91913YAN0.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_91913YAN0 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2009,  3, 17);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2019,  3, 15);
		double dblCoupon = 0.09375;
		double dblCleanPrice = 1.139028;
		int iFreq = 2;
		String strCUSIP = "91913YAN0";
