...
/**
 * CUSIP_796720GG9 demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for CUSIP 796720GG9.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class CUSIP_796720GG9 {
		...
		throws Exception
	{
		...
		JulianDate dtEffective = DateUtil.CreateFromYMD (2009,  6, 18);
		JulianDate dtMaturity  = DateUtil.CreateFromYMD (2044,  8,  1);
		double dblCoupon = 0.;
		double dblCleanPrice = 0.27283;
		int iFreq = 2;
		String strCUSIP = "796720GG9";
