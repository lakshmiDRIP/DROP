...
/**
 * HubbaliDharwad demonstrates EOS Fixed Coupon Multi-flavor Pricing and Relative Value Measure Generation
 *  for HubbaliDharwad.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class HubbaliDharwad {
		...
		throws Exception
	{
		...
		int iFreq = 2;
		String strCUSIP = "HubbaliDharwad";
