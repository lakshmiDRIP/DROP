 ...
 *  where the Counter Party Hazard is Medium (2.5%). The References are:
 *  
...
public class CounterPartyHazardMedium {
		...
		throws Exception
	{
		...
		System.out.println ("\t||      CVA UNDER MEDIUM COUNTER PARTY HAZARD     ||");
