...
/**
 * MZ_GOGYEE generates the Full Suite of Replication Metrics for Bond GOGYEE.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class MZ_GOGYEE {
		...
		throws Exception
	{
		...
		int iSettleLag = 12;
		int iCouponFreq = 2;
		String strName = "GOGYEE";
		double dblCleanPrice = 1.;
		double dblIssuePrice = 1.;
		String strCurrency = "USD";
		double dblZSpreadBump = 20.;
		double dblCouponRate = 0.0000;
		String strTreasuryCode = "UST";
		double dblIssueAmount = 1.448e9;
