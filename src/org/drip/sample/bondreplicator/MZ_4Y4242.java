...
/**
 * MZ_4Y4242 generates the Full Suite of Replication Metrics for Bond 4Y4242.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class MZ_4Y4242 {
		...
		throws Exception
	{
		...
		int iSettleLag = 3;
		int iCouponFreq = 4;
		String strName = "4Y4242";
		double dblCleanPrice = 1.;
		double dblIssuePrice = 1.;
		String strCurrency = "USD";
		double dblZSpreadBump = 20.;
		double dblCouponRate = 0.05500;
		double dblIssueAmount = 1.21913313e8;
