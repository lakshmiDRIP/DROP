...
/**
 * MZ_OE2662 generates the Full Suite of Replication Metrics for Bond OE2662.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class MZ_OE2662 {
		...
		throws Exception
	{
		...
		int iSettleLag = 12;
		int iCouponFreq = 1;
		String strName = "OE2662";
		double dblCleanPrice = 1.;
		double dblIssuePrice = 1.;
		String strCurrency = "USD";
		double dblZSpreadBump = 20.;
		double dblCouponRate = 0.0355;
		double dblIssueAmount = 8.00e7;
