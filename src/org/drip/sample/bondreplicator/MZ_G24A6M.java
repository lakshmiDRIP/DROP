...
/**
 * MZ_G24A6M generates the Full Suite of Replication Metrics for Bond G24A6M.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class MZ_G24A6M {
		...
		throws Exception
	{
		...
		int iSettleLag = 3;
		int iCouponFreq = 2;
		String strName = "G24A6M";
		double dblCleanPrice = 1.;
		double dblIssuePrice = 1.;
		String strCurrency = "USD";
		double dblZSpreadBump = 20.;
		double dblCouponRate = 0.08500;
		double dblIssueAmount = 7.0e08;
