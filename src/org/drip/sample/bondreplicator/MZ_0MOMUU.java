...
package org.drip.sample.bondreplicator;
...
/**
 * MZ_0MOMUU generates the Full Suite of Replication Metrics for Bond 0MOMUU.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class MZ_0MOMUU {
		...
		throws Exception
	{
		...
		SetEOS (
			...
			new EmbeddedOptionSchedule (
				new int[] {
					DateUtil.CreateFromYMD (2019, 02, 01).julian(),
					DateUtil.CreateFromYMD (2020, 02, 01).julian(),
					DateUtil.CreateFromYMD (2021, 02, 01).julian(),
				},
				new double[] {
					1.04750,
					1.02375,
