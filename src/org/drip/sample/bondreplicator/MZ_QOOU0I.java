...
/**
 * MZ_QOOU0I generates the Full Suite of Replication Metrics for Bond QOOU0I.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class MZ_QOOU0I {
		...
		throws Exception
	{
		...
		int iSettleLag = 12;
		int iCouponFreq = 2;
		String strName = "QOOU0I";
		double dblCleanPrice = 1.;
		double dblIssuePrice = 1.;
		String strCurrency = "USD";
		double dblZSpreadBump = 20.;
		double dblCouponRate = 0.0137;
		double dblIssueAmount = 1.00e0;
