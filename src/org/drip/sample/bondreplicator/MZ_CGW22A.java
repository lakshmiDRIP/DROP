...
/**
 * MZ_CGW22A generates the Full Suite of Replication Metrics for Bond CGW22A.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class MZ_CGW22A {
		...
		throws Exception
	{
		...
		int iSettleLag = 3;
		int iCouponFreq = 2;
		String strName = "CGW22A";
		double dblCleanPrice = 0.9;
		double dblIssuePrice = 0.9;
		String strCurrency = "USD";
		double dblZSpreadBump = 20.;
		double dblCouponRate = 0.00000;
		double dblIssueAmount = 5.0e08;
