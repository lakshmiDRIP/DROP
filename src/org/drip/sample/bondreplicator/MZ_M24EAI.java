...
/**
 * MZ_M24EAI generates the Full Suite of Replication Metrics for Bond M24EAI.
 * 
 * @author Lakshmi Krishnamurthy
 */

public class MZ_M24EAI {
		...
		throws Exception
	{
		...
		int iSettleLag = 3;
		int iCouponFreq = 12;
		String strName = "M24EAI";
		double dblCleanPrice = 1.;
		double dblIssuePrice = 1.;
		String strCurrency = "USD";
		double dblZSpreadBump = 20.;
		double dblCouponRate = 0.0443;
		double dblIssueAmount = 3.67e7;
