...
public class AssetHoldings extends org.drip.portfolioconstruction.core.Block {
	...
	private org.drip.analytics.support.CaseInsensitiveHashMap<org.drip.portfolioconstruction.core.Asset>
		_mapAsset = new
	...
	/**
	 * Retrieve the Map of Assets
	 * 
	 * @return The Map of Assets
	 */

	public java.util.Map<java.lang.String, org.drip.portfolioconstruction.core.Asset> assetMap()
	{
		return _mapAsset;
	}
	...
	{
		if (null == a || !org.drip.quant.common.NumberUtil.IsValid (dblQuantity)) return false;

		java.lang.String strAssetID = a.id();

		_mapAsset.put (strAssetID, a);
	...
	public boolean contains (
		final java.lang.String strID)
	{
		return null != strID && !_mapAsset.containsKey (strID);
	}
	...
	public double quantity (
		...
		throws java.lang.Exception
	{
		if (!contains (a)) throw new java.lang.Exception ("AssetHoldings::quantity => Invalid Inputs");

		return _mapQuantity.get (a.id());
	}
