...
public class ContinuousHighUrgencyAsymptote extends
	 ...
	 * 
	 * @return The ContinuousHighUrgencyAsymptote Instance
	 */

	public static final ContinuousHighUrgencyAsymptote Standard (
	...
	{
		try {
			return new ContinuousHighUrgencyAsymptote (new org.drip.execution.strategy.OrderSpecification
	...
	private ContinuousHighUrgencyAsymptote (
	...
	@Override public org.drip.execution.optimum.EfficientTradingTrajectory generate()
	{
		...
		final org.drip.function.definition.R1ToR1 r1ToR1Holdings = new org.drip.function.definition.R1ToR1
				...
				throws java.lang.Exception
			{
				...
				return dblX * java.lang.Math.exp (-1. * dblKappa * dblTime);
			}
		};
		...
		org.drip.function.definition.R1ToR1 r1ToR1TradeRate = new org.drip.function.definition.R1ToR1 (null)
		{
				...
				throws java.lang.Exception
			{
				...
				return dblKappa * r1ToR1Holdings.evaluate (dblTime);
			}
		};
		...
		org.drip.function.definition.R1ToR1 r1ToR1TransactionCostExpectation = new
				...
				throws java.lang.Exception
			{
				...
				return dblEta * dblKappa * dblHoldings * dblHoldings;
			}
		};
